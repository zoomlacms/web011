<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_BidManage_Bidpaul, App_Web_sjd2x5yq" clientidmode="Static" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div style="width: 100%; border: 1px #ddd solid;padding:10px 15px;" id="nocont" runat="server">
        您还没有保价购买的商品!
    </div>
