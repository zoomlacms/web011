<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_BidManage_Default, App_Web_sjd2x5yq" clientidmode="Static" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div style="width: 100%; border: 1px #DDD solid;padding:10px 15px;" id="nocont" runat="server">暂时无参与的竞拍，快去选择你喜欢的商品吧! </div>
