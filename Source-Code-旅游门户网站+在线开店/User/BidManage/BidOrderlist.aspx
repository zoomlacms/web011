<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_BidManage_BidOrderlist, App_Web_sjd2x5yq" clientidmode="Static" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td colspan="2" class="text-center">
                    第二步：确认订单<img src="/user/images/regl2.gif" width="242" height="14" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="Receiver" CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="dddizhi" CssClass="form-control" runat="server" OnSelectedIndexChanged="dddizhi_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                    <br />
                    <asp:TextBox ID="Jiedao" runat="server" CssClass="form-control"></asp:TextBox><asp:CheckBox ID="ckdizhi" runat="server" />保存到地址薄
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="Payment" CssClass="form-control" runat="server"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="Invoice" CssClass="form-control" runat="server"  Rows="10"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="Delivery" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Delivery_SelectedIndexChanged1"></asp:DropDownList>
