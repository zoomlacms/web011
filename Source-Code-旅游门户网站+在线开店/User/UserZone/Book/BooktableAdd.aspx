<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="BooktableAdd, App_Web_eiqpzzbo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div style="margin-top:10px;">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="antxt" CssClass="form-control" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="isbntxt" CssClass="form-control" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="concermtxt" CssClass="form-control" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="yeartxt" runat="server" CssClass="form-control" MaxLength="4"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <input type="file" name="FileUpload1" class="form-control" id="FileUpload1" runat="server" />
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="contenttxt" class="form-control" runat="server" rows="10" style="max-width: 330px"></textarea>
