<%@ page language="C#" autoeventwireup="true" inherits="MusicList, App_Web_ze2costj" title="音乐" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx") %>' target="_parent"> 会员中心</a>音乐
</div>
<div>
    ...
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="82%" height="26" valign="top"><table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td style="padding-left: 20px" class="catebar" height="26"><span class="M"><font class="textlink">音乐</font></span></td>
            </tr>
          </table></td>
        ...
        <td valign="top"><table width="100%">
            <tr>
              <td align="center" style="border-right: #9d9d9d 1px solid; border-left: #9d9d9d 1px solid;
                                background: #ffffff; border-bottom: #9d9d9d 1px solid; border-top: #9d9d9d 1px solid"> 搜索你要找的音乐：
                        ...
                        <td width="754" height="55" valign="top"><table border="0" cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <tr>
                              <td width="23%" class="lh13" id="bookdetail1" style="padding-bottom: 3px; padding-left: 0px;
                                                                padding-right: 0px; display: block; padding-top: 3px">&nbsp; &nbsp; <a href="MusicShow.aspx?bID=<%#DataBinder.Eval(Container.DataItem,"ID") %>">
