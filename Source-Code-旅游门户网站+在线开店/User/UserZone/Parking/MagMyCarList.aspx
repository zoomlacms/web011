<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="MagMyCarList, App_Web_ldefbbrk" viewStateEncryptionMode="Never" %>
...
您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt;<a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx") %>' target="_parent">会员中心</a>&gt;&gt;抢车位
</div>
