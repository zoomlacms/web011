<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_SetCenter_SC_Picture, App_Web_mw2pdmjh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_pynews">
您现在的位置：<a title="网站首页" href="/" target="_top"><asp:Label ID="LblSiteName" runat="server" Text=""></asp:Label></a>&gt;&gt;<a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_parent">会员中心</a>&gt;&gt;设置中心&gt;&gt;照片公开模式
</div>
</div>
