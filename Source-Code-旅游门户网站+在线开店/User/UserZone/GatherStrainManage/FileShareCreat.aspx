<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.GatherStrainManage.FileShareCreat, App_Web_yfelv1wh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_topinfo" style="margin-top: 10px;">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    <asp:FileUpload CssClass="form-control" style="max-width:530px;" ID="FileUpload1" runat="server" /></td>
            </tr>
            <tr>
