<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.GatherStrainManage.GSBuid, App_Web_yfelv1wh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <div style="height: 30px; text-align: center;">
                                共<asp:Label ID="Allnum" runat="server"
                                    Text=""></asp:Label>&nbsp;
