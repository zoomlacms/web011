<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.GatherStrainManage.GSManage, App_Web_yfelv1wh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        <td valign="top" align="center">
                            <asp:GridView ID="gvMu" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="ID">
                                <Columns>
                    ...
                    <tr>
                        <td valign="top" align="center">
                            <asp:GridView ID="GV_Intive" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="ID">
                                <Columns>
                                    <asp:BoundField DataField="GSName" HeaderText="群族名称">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
