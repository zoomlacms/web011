<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserZone.Pic.ShowPic, App_Web_s1t2tbfh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label  ID="LblSiteName" runat="server" Text="Label"></asp:Label></a> &gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_blank">会员中心</a> &gt;&gt;><a title="我的相册" href='<%=ResolveUrl("~/User/UserZone/Pic/CategList.aspx")%>'>我的相册</a>&gt;&gt;<%=CategName %> 
</div>
  ...
  <div>
    <table width="760px" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="False">
            <Columns>
            <asp:TemplateField>
              <ItemTemplate>
      ...
      <tr>
        <td align="center"><li style="height: 30px; text-align: center">共
            ...
            个/页 转到第
            <asp:DropDownList
                                ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"> </asp:DropDownList>
            页</li></td>
      </tr>
      <tr>
