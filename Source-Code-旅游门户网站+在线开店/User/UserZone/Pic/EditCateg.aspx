<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserZone.Pic.EditCateg, App_Web_s1t2tbfh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_blank">会员中心</a> &gt;&gt; <a title="我的相册" href='<%=ResolveUrl("~/User/UserZone/Pic/CategList.aspx")%>'>我的相册</a>&gt;&gt;修改<%=type %>相册
</div>
  ...
  <table width="760px" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><table width="760px" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr style="height: 80px">
            <td colspan="2" align="center"><asp:Button ID="butEnter" runat="server" Text="修  改" OnClick="butEnter_Click" />
              &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
