<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserInfo_UserReg_Move1, App_Web_gm5ftkm2" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_topinfo" style="overflow: hidden;">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr valign="top">
                ...
                <td width="41%">
                    <asp:TextBox ID="lblhoney" CssClass="form-control" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td align="right" style="height: 26px">真实姓名： </td>
                <td style="height: 26px">
                    <asp:TextBox ID="txtrealname" CssClass="form-control" runat="server"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtbir" runat="server" CssClass="form-control" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd' });" ></asp:TextBox>
                    <br />如：2008-08-08
                    生肖：
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:DropDownList ID="ddlProvince" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlProvince_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                <td style="height: 22px">
                    市： 
