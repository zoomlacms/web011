<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="UserReg_Move2, App_Web_gm5ftkm2" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_topinfo" style="overflow: hidden;">
        <table class="table table-striped table-bordered table-hover">
                ...
                <td valign="top">
                    <table>
                        ...
                        <tr>
                            <td>市： </td>
                            <td>
                                <asp:DropDownList ID="DropDownList4" CssClass="form-control" runat="server" Visible="false"></asp:DropDownList>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="marryDropDownList" CssClass="form-control" runat="server"></asp:DropDownList></td>
                <td></td>
            </tr>
            <tr>
                <td align="right">身高： </td>
                <td>
                    <asp:TextBox ID="Staturetxt" runat="server" CssClass="form-control" Style="max-width: 50px;" Text="不限"></asp:TextBox>Cm
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="Avoirtxt" runat="server" CssClass="form-control" Style="max-width: 50px;" Text="不限"></asp:TextBox>Kg</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="BachelorDropDownList" CssClass="form-control" runat="server"></asp:DropDownList></td>
                <td></td>
            </tr>
            <tr>
                <td align="right">月收入： </td>
                <td>
                    <asp:DropDownList ID="monthDropDownList" CssClass="form-control" runat="server"></asp:DropDownList></td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea id="TextArea1" class="form-control" style="max-width: 236px; height: 64px" runat="server"></textarea>
                </td>
                <td></td>
            </tr>
            <tr>
