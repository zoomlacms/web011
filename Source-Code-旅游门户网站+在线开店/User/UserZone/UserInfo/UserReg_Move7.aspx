<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserInfo_UserReg_Move7, App_Web_gm5ftkm2" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <table class="table table-bordered table-striped table-hover">
            <tr>
                ...
                <td colspan="2" valign="top">
                    <asp:DropDownList ID="LiveSamep" CssClass="form-control" runat="server">
            ...
            <tr>
                ...
                <td colspan="2" valign="top">
                    <asp:DropDownList ID="DuanL" CssClass="form-control" runat="server">
            ...
            <tr>
                ...
                <td colspan="2" valign="top">
                    <asp:DropDownList ID="Zuoxi" CssClass="form-control" runat="server">
