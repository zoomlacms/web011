<%@ page language="C#" autoeventwireup="true" inherits="DraughtLog, App_Web_kawn1bzs" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt;<a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_parent"> 会员中心</a>&gt;&gt;<a title="我的日志" href='<%=ResolveUrl("~/User/UserZone/LogManage/SelfLogManage.aspx")%>'> 我的日志</a>&gt;&gt;我的草稿箱
</div>
...
<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="212,208,200">
  <tr>
	<td style="width: 80%" bgcolor="#FFFFFF" valign="top"><asp:GridView ID="gvLog" runat="server" AutoGenerateColumns="False" Width="100%" GridLines="None" CellPadding="4" DataKeyNames="ID" ShowHeader="False">
		<Columns>
		<asp:TemplateField>
		  <ItemTemplate>
