<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="SelfLogManage, App_Web_kawn1bzs" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-bordered table-striped">
        <tr>
            <td rowspan="2" class="text-center" style="width: 110px; vertical-align:middle;">
                <span class="glyphicon glyphicon-book" style="font-size:2em;color:#66CCFF;"></span>
            </td>
            <td>&nbsp;我的日志 </td>
        </tr>
        <tr>
    ...
    <table class="table table-striped table-bordered">
        <tr>
            <td style="width: 80%" bgcolor="#FFFFFF" valign="top">
                <asp:GridView ID="gvLog" runat="server" AutoGenerateColumns="false" Width="100%" OnRowDataBound="gvLog_RowDataBound" GridLines="None" CellPadding="4" PageSize="2" DataKeyNames="ID" AllowPaging="True" OnPageIndexChanging="gvLog_PageIndexChanging">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                    ...
                                    <tr>
                                        <td>
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    <td>   
                                                        <a href="LogReadCriticism.aspx?LogID=<%#DataBinder.Eval(Container.DataItem,"ID")%>">阅读</a>(
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td class="text-center">
                                    ...
                                    页
                                    <asp:LinkButton ID="btnFirst" runat="server" CausesValidation="False" CommandArgument="First" CommandName="Page" Text="首页" Enabled=" <%# ((GridView)Container.Parent.Parent).PageIndex!=0 %>" />
                                    <asp:LinkButton ID="btnPrev" runat="server" CausesValidation="False" CommandArgument="Prev" CommandName="Page" Text="上一页" Enabled=" <%# ((GridView)Container.Parent.Parent).PageIndex!=0 %>" />
                                    <asp:LinkButton ID="btnNext" runat="server" CausesValidation="False" CommandArgument="Next" CommandName="Page" Text="下一页" Enabled=" <%# ((GridView)Container.Parent.Parent).PageIndex!=((GridView)Container.Parent.Parent).PageCount-1 %>" />
                                    <asp:LinkButton ID="btnLast" runat="server" CausesValidation="False" CommandArgument="Last"  CommandName="Page" Text="尾页" Enabled=" <%# ((GridView)Container.Parent.Parent).PageIndex!=((GridView)Container.Parent.Parent).PageCount-1 %>" />
            ...
            <td valign="top" bgcolor="Silver">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvLogType" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvdateLog" runat="server" AutoGenerateColumns="False" Width="100%"
