<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserZone_LogManage_CreatLog, App_Web_kawn1bzs" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-bordered" style="margin-top:10px;">
        <tr>
            <td colspan="2" class=" text-center">
                <span class="glyphicon glyphicon-edit" style="margin-right:5px;"></span>发表新日志
            </td>
        </tr>
        <tr>
            <td>
                <table class="table table-striped table-bordered table-hover">
                    <tr>
                        <td align="left">标题：
                                <asp:TextBox ID="txtTitle" CssClass="form-control" runat="server" Width="379px"></asp:TextBox>
                    ...
                    <tr>
                        <td align="left">分类：
                                <asp:DropDownList ID="dropLogType" runat="server" CssClass="form-control"></asp:DropDownList>
                    ...
                    <tr>
                        <td align="left" style="height: 300px">
                            ...
                            <textarea cols="80" id="infoeditor" style="max-width: 600px; height: 300px;" class="form-control" height="200px" name="infoeditor" srows="10" runat="server"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">日志中提到的好友：
                            <asp:TextBox ID="txtFrd" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td class="text-center">
                <asp:Button ID="btnPut" CssClass="btn btn-primary" runat="server" Text="发布" OnClick="btnPut_Click" />
                <asp:Button ID="btnSave" CssClass="btn btn-primary" runat="server" Text="保存为草稿" OnClick="btnSave_Click" />
            </td>
        </tr>
    </table>
