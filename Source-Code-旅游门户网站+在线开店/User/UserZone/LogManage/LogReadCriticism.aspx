<%@ page language="C#" autoeventwireup="true" inherits="LogReadCriticism, App_Web_kawn1bzs" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt;<a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_parent"> 会员中心</a>&gt;&gt;<a title="我的日志" href='<%=ResolveUrl("~/User/UserZone/LogManage/SelfLogManage.aspx")%>'>我的日志</a>&gt;&gt;日志详细
</div>
  ...
  <table border="0" cellpadding="4" cellspacing="0" width="100%">
    ...
    <tr>
      <td colspan="2" align="center"><asp:GridView ID="gvCriticism" runat="server" AutoGenerateColumns="False" CellPadding="4" Width="90%" DataKeyNames="ID">
          <Columns>
          <asp:TemplateField>
            <ItemTemplate>
