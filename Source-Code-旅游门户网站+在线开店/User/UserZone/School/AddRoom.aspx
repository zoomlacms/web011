<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_School_AddRoom, App_Web_p255iqmd" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_topinfo">您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt;<a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx") %>' target="_parent">会员中心</a>&gt;&gt;<a href="mySchoolList.aspx"> 我的班级 </a>&gt;&gt;<%=labe %>
</div>
