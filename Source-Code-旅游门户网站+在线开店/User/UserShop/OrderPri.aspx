<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_OrderPri, App_Web_vkx1tc11" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <td colspan="2">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:FileUpload ID="FileUpload1" runat="server" onkeydown="event.returnValue=false;" onpaste="return false" /><span id="lblMessage" runat="server" style="color: Red"></span>
                        </td>
                    </tr>
