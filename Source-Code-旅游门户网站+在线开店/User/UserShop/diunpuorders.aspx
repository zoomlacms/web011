<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="manage_Shop_diunpuorders, App_Web_vkx1tc11" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody id="Tbody1">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Label ID="dingdanID" runat="server" Text=""></asp:Label></td>
                <td align="center">收货人姓名:</td>
                <td width="20%" align="center">
                    <asp:Label ID="Reuser" runat="server" Text=""></asp:Label>&nbsp;</td>
                <td align="center">要求配送日期:</td>
            ...
            <tr>
                <td align="center" class="style16">其它要求:</td>
                <td colspan="5">
                    <br />
                    <br />
                    <br />
            ...
            <tr>
                <td align="center" class="style16">留言:<br />
                    <br />
                </td>
                <td colspan="5">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody id="Tbody2">
            <tr>
                <td colspan="2" class="text-center">请配送员沿此线剪下，此线以上部分交给客户，以下部分留存。</td>
            </tr>
            <tr>
                <td align="center" class="style13">收货人对货品反馈意见：</td>
                <td align="left">
            ...
            <tr>
                <td align="center" class="style14" colspan="2">
                    <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="打印签收单" OnClientClick="preview();return false;" />
                </td>
            </tr>
        </tbody>
    </table>
    <div style="width: 100%;">
        ...
        服务电话：0722-3812976                    手机：13597832028
    请各分店、配送店注意如下内容：<br />
