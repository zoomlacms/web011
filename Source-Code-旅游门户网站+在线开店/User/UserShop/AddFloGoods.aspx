<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_AddFloGoods, App_Web_vkx1tc11" clientidmode="Static" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td width="67%">
                    <asp:TextBox ID="paname" CssClass="form-control" runat="server" Width="332px"></asp:TextBox>
            ...
            <tr>
                ...
                <td width="67%">
                    <asp:TextBox ID="remark" runat="server" CssClass="form-control" style="max-width:334px;" Height="119px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
