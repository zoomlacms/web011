<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_UserShopOrder, App_Web_ldgzaw0x" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr class="">
                        ...
                        <td align="center"><%#Eval("LastLoginIP")%></td>
                        <td align="center"><%#Getordernum(Eval("Username","{0}"))%></td>
                        <td align="center"><%#Getordernums(Eval("Username","{0}"))%></td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
            <tr>
