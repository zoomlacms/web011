<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Profile_Accountinfo, App_Web_h0t5nwk3" clientidmode="Static" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table  class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td width="25%" >支付平台:</td>
            <td>
                <asp:DropDownList ID="ddpay" CssClass="form-control" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td >开户人真实姓名:</td>
            <td >
                <asp:TextBox ID="txtOfName" CssClass="form-control" runat="server"></asp:TextBox>此开户人必须是您本人；
