<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_SetSecondPwd, App_Web_wp4exovk" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_seta" style="margin-top: 5px; width: 100%;" runat="server" id="DV_Set" visible="false">
            ...
            <table align="center" border="0" class="table table-striped table-bordered table-hover">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox1" runat="server" TextMode="Password" CssClass="form-control" />
