<%@ page language="C#" autoeventwireup="true" inherits="User_PromotUnion_Userunionprolink, App_Web_otzxjz32" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>网赚推广商品链接</title>
...
<script language="javascript" type="text/javascript">
    ...
    function createprolink(id1) {
        ...
        if (!chkurl(url)) { alert('请输入正确的商品网址！'); document.getElementById(id1).focus(); return false; }
        else {return true;}
    }
...
<form id="form1" runat="server">
 <div id="container">
	<div style="background:#EAF5FE; margin-top:12px;">
		<div style="font-size:14px; font-weight:bold; color:#535353; height:16px; padding:23px 0 0 23px; ">获取某商品您自己的推广链接：</div>
		<div style="height:22px; overflow:hidden; font-size:14px; margin-top:30px; margin-left:23px;">输入商品网址：
		<asp:TextBox ID="prolink" runat="server" style="width:425px; border:1px solid #C9C9C9;"></asp:TextBox>
		<asp:Button ID="btn" runat="server" style="vertical-align:top; margin-left:16px;" 
				Text="生成推广链接" OnClientClick="return createprolink('prolink')" onclick="btn_Click"/>
	</div>
