<%@ page language="C#" autoeventwireup="true" inherits="User_Content_Recyle, App_Web_pa2vy3y0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="us_seta">
                <asp:GridView ID="Egv" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="GeneralID" PageSize="10" OnPageIndexChanging="Egv_PageIndexChanging" OnRowCommand="Lnk_Click" CellPadding="4" GridLines="None" CssClass="table table-striped table-bordered table-hover">
                    <Columns>
                ...
                <div>
                    ...
                    <input type="text" runat="server" id="TxtSearchTitle" class="form-control" style="color: #666;" value="请输入标题" onclick="if (this.value == '请输入标题') { this.value = ''; this.style.color = 'black'; }" onblur="if(this.value==''){this.value='请输入标题';this.style.color='#666';}">
