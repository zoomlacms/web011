<%@ page language="C#" autoeventwireup="true" inherits="User_PrintServer_TripOrder, App_Web_wp4exovk" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="us_seta" style="margin-top: 10px;">
		<h1 style="text-align: center">
			...
			<ZL:ExGridView id="EGV1" runat="server" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" EmptyDataText="无相关数据" AutoGenerateColumns="false">
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
