<%@ page language="C#" autoeventwireup="true" inherits="User_RegPlat, App_Web_alwjrles" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
<title>用户注册</title>
<%Call.Label("{ZL:Boot()/}"); %>
<link href="/App_Themes/ICMS/User_V3.css" rel="stylesheet">
<style>
...
<h1 class="">连接世界的力量</h1>
    ...
    <asp:Button runat="server" ID="Step1_Btn" Text="下一步" OnClientClick="disBtn(this,3000);" OnClick="Step1_Btn_Click" CssClass="btn btn-primary" ValidationGroup="sg1" />
    <button type="button" class="btn btn-default" onclick="location='/User/Login.aspx';">登录</button><br />
    ...
    <div runat="server" id="Step3_Div" visible="false"> 
        <ul class="detail_ul">
            <li class="descli" style="color:white;"><span class="glyphicon glyphicon-user"></span><span style="padding:0 5px 0 5px;">|</span><asp:Label runat="server" ID="UserName_L" /></li>
            ...
            <li style="padding-bottom:10px;"></li>
            <li style="padding-bottom:10px;"><span><input type="checkbox" style="margin-right:5px;height:auto;width:auto;" checked="checked" />阅读并同意<a href="#" title="使用条款">《使用条款》</a></span></li>
            <li><asp:Button runat="server" ID="Sub_Btn" Text="加入能力中心" OnClientClick="disBtn(this,2000);" OnClick="Sub_Btn_Click" CssClass="btn btn-primary" style="width:300px;" ValidationGroup="reg"/></li>
        </ul> 
    </div>
</div>
</div>
