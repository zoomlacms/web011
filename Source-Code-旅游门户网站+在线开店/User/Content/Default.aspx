<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.Default, App_Web_lvsrob24" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>内容管理</title>
...
<div runat="server" id="DV_show">
    <div class="s_body" style="width:100%">
        <div class="s_bleft" style=" width:20%; float: left;">
            <iframe frameborder="0" width="100%" height="800px" src="NodeTree.aspx" scrolling="auto" id="I1" name="I1"></iframe>
        </div>
