<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" validaterequest="false" inherits="Zoomla.Website.User.Shop.AddProduct, App_Web_lvsrob24" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="ProUnit" Text="件" runat="server" Width="155px" CssClass="form-control" />
                            <span class="STYLE1">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="TG" runat="server" visible="false">
