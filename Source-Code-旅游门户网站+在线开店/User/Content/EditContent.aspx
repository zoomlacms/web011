<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.EditContentpage, App_Web_lvsrob24" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ol class="breadcrumb">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtTitle" CssClass="form-control" runat="server" Text=''></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtTagKey" CssClass="form-control" runat="server" Text=''></asp:TextBox>
