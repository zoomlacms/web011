<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Content_MyFavite_UserShop, App_Web_lvsrob24" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div>
        ...
        <div id="cont" runat="server">
            <asp:GridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="FavoriteID" OnRowCommand="Lnk_Click" Width="100%"
                CellPadding="4" GridLines="None" CssClass="table table-striped table-bordered table-hover">
                <Columns>
            ...
            <asp:TextBox ID="txtPage" runat="server" AutoPostBack="true" class="l_input"
                Width="24px" Height="24px" OnTextChanged="txtPage_TextChanged"></asp:TextBox>
            ...
            <div style="padding-top: 5px;">
                <div class="us_seta" style="height: auto;">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;搜索标题：<asp:TextBox ID="TxtSearchTitle" runat="server"></asp:TextBox><asp:Button ID="Button1" runat="server" Text="搜索" CssClass="btn btn-primary" OnClick="Button1_Click" />
                </div>
            </div>
        </div>
    </div>
