<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_OrderForm_ColonelList, App_Web_wrg5io4x" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <asp:Repeater ID="cartinfo" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 12.5%; text-align: center;"><a href="ColonelList.aspx?menu=del&cid=<%#Eval("id")%>"
                                onclick="return confirm('退出团购将不会返还你的押金！你确定要退出团购吗？');">退出团购</a></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
                <tr>
