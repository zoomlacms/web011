<%@ page language="C#" autoeventwireup="true" inherits="User_PrintServer_FeightOrder, App_Web_wp4exovk" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
		...
		<h1 style="text-align: center">
			<asp:Label ID="Label1" runat="server" Text=""></asp:Label></h1>
			 <asp:Panel ID="Panel1" runat="server" Width="100%">
                 <ZL:ExGridView ID="EGV1" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="无相关数据" AllowPaging="true" AutoGenerateColumns="false" PageSize="10">
                     <Columns>
                         <asp:TemplateField>
                             <ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="订单编号">
                             <ItemTemplate>
                                 <a href="?menu=ViewOrderlist&id=<%#Eval("id") %>">
								<%#Eval("OrderNo")%></a>
                             </ItemTemplate>
                         </asp:TemplateField>
