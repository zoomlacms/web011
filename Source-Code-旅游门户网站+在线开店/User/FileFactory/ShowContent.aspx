<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ShowContent, App_Web_avrz10fn" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <table style="height: 500px; width: 30%; float: left;" border="0" cellpadding="5" cellspacing="1" class="border" id="left">
            <tr class="tdbg">
                <td valign="top" style="margin-top: 0px; margin-left: 0px;">
                    ...
                    <br />
                    <center>
              <asp:Button ID="EditDoc" CssClass="i_bottom" runat="server" Text="修改文件" OnClick="EditDoc_Click" />
              <asp:Button ID="SaveDoc" CssClass="i_bottom" runat="server" Text="保存文件" OnClick="SaveDoc_Click" Visible="false"/>
              <asp:Button ID="ReBuildDoc" CssClass="i_bottom" runat="server" Text="生成文档" OnClientClick="return generate3('docTitle','docParamValue','preview');" OnClick="ReBuildDoc_Click"/>
              <asp:Button ID="DeleDoc" CssClass="i_bottom" runat="server" Text="删除文件" OnClientClick="return confirm('你确定将该数据删除到回收站吗？')"
					OnClick="Delete_Click" />
              <asp:Button ID="BakList" CssClass="i_bottom" runat="server" Text="返回列表" OnClick="BakList_Click"/>
            </center>
                </td>
            </tr>
        </table>
