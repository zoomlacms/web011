<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="Friendsearch_quick, App_Web_10ilz2hm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <asp:Panel ID="quickPanel" runat="server">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" Width="50px"></asp:TextBox>~
                            ...
                            <tr id="trSearchFriendMarry" runat="server">
                                ...
                                <td align="left">
                                    <asp:DropDownList CssClass="form-control" ID="marryDropDownList" runat="server"></asp:DropDownList></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
