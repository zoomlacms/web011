<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserFriend_FriendMyAttend, App_Web_33uwcppu" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="us_topinfo" style="margin-top: 10px;">
        <table class="table table-bordered table-striped table-hover">
            <tr>
                <td>
                    <asp:GridView ID="gvGroup" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataKeyNames="ID" CellPadding="4" GridLines="Horizontal">
                        <Columns>
                ...
                <td>
                    ...
                    <div style="margin-bottom:10px;">
                        好友搜索：<asp:TextBox ID="FriendName" CssClass="form-control" runat="server"></asp:TextBox>
