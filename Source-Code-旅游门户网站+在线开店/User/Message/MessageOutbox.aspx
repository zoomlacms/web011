<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Message_MessageOutbox, App_Web_mqugmdc1" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div style="margin-top: 10px;">
        <div class="us_pynews">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowEditing="GridView1_RowEditing" Width="100%" AllowPaging="True" DataKeyNames="MsgID" OnRowCommand="Row_Command" OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="table table-bordered table-hover table-striped">
                <Columns>
            ...
            <asp:Button ID="mobiletext" runat="server" Font-Size="9pt" Text="手机短信" class="btn btn-primary" OnClick="mobiletext_Click" />
