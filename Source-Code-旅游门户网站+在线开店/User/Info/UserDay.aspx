<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_UserDay, App_Web_k5dq03lr" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_seta" style="margin-top: 5px;">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td>节日标题： </td>
                    <td>
                        <asp:TextBox ID="D_title" runat="server" class="form-control" />
                ...
                <tr>
                    <td>节日日期： </td>
                    <td>
                        <asp:TextBox ID="D_date" runat="server" class="form-control" Text="" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })"></asp:TextBox>
                        <span id="Span2">
                ...
                <tr>
                    <td>节日说明： </td>
                    <td>
                        <asp:TextBox ID="D_Content" runat="server" Height="80px" CssClass="form-control" TextMode="MultiLine" Width="425px"></asp:TextBox></td>
                </tr>
                <tr>
