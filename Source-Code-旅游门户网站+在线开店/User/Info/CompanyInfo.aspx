<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_CompanyInfo, App_Web_k5dq03lr" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_seta">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td>公司介绍： </td>
                    <td>
                        <asp:TextBox ID="txtCompanyDescribe" runat="server" TextMode="MultiLine" Height="60px" class="form-control" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>公司Logo： </td>
