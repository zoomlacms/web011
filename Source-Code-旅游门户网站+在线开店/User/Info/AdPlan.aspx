<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_AdPlan, App_Web_k5dq03lr" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<li class="active">广告计划<a href="AdPlanAdd.aspx">[申请广告]</a></li>
    ...
    <div class="adplan">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ZoneID" Width="100%" AllowPaging="True" OnRowCommand="Lnk_Click" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="GridView1_RowDataBound" EnableModelValidation="True" EmptyDataTex="无相关信息！">
            <Columns>
