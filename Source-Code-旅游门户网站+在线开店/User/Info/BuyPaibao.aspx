<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_BuyPaibao, App_Web_k5dq03lr" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_seta" id="manageinfo" runat="server">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td style="width: 70%; line-height: 30px">
                    <asp:TextBox ID="Bnum" CssClass="form-control" runat="server">1</asp:TextBox>个
                </td>
            </tr>
            ...
            <tr class="tdbgbottom">
                <td colspan="2" align="center">
                    ...
                    &nbsp;&nbsp;
				<input id="Button1" class="btn btn-primary" type="button" value="返回" onclick="javascript: location.href = 'MyPaibao.aspx'" />
                </td>
            </tr>
        </table>
    </div>
