<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_PostPointP, App_Web_k5dq03lr" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="manageinfo" class="us_seta" style="margin-top: 10px;">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="UserName2" AutoPostBack="True" OnTextChanged="TextBox2_TextChanged" CssClass="form-control" runat="server" ></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TrueName" CssClass="form-control" runat="server"  Style="float: left;" Width="140"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtScore" CssClass="form-control" runat="server" AutoPostBack="True" OnTextChanged="TextBox4_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="Txtpurse" CssClass="form-control" runat="server" ReadOnly="True"></asp:TextBox></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="Second" CssClass="form-control" runat="server" Value="" TextMode="Password"></asp:TextBox>
                </td>
            </tr>
            <tr>
