<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_AdPlanAdd, App_Web_k5dq03lr" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_seta" id="AddMain" runat="server">
        <table class="ad_info table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="Scale" CssClass=" form-control" Width="100" runat="server">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="ShowTime" class=" form-control" runat="server" Text="广告投放时间数（单位：天）" onclick="setEmpty(this)" onblur="settxt(this)"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="Content" runat="server" Class="form-control" Height="100px" Width="300px" TextMode="MultiLine"></asp:TextBox>
            ...
            <tr>
                <td colspan="2" align="center" style="text-align: center;">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="提交申请" OnClientClick="javascript:if(check()) return true;else return false;" OnClick="Button1_Click" class="btn btn-primary" />
