<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_UserDeci_Modify, App_Web_k5dq03lr" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td align="right" style="line-height:32px;" width="45%">收货人姓名：
            </td>
            <td>
                <asp:HiddenField ID="hfid" runat="server" />
                <asp:TextBox ID="txtName" runat="server" CssClass="form-control pull-left"></asp:TextBox>
        ...
        <tr>
            <td align="right" width="45%">所在省市：
            </td>
            <td>
                <asp:DropDownList ID="ddlProvince" CssClass="form-control pull-left" Width="90px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlProvince_SelectedIndexChanged">
                </asp:DropDownList>
                <span class="tips pull-left" style="margin-right:5px;">省</span>
            <asp:DropDownList ID="ddlCity" CssClass="form-control pull-left" Width="150px" runat="server"></asp:DropDownList>
                <span class="tips pull-left">市</span>
            </td>
        </tr>
        <tr>
            <td align="right" width="45%">具体地址：
            </td>
            <td>
                <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" CssClass="form-control pull-left"  Height="108px"></asp:TextBox>
        ...
        <tr>
            <td align="right" width="45%" class="style3">E-Mail：
            </td>
            <td class="style3">
                <asp:TextBox ID="txtmail" runat="server" CssClass="form-control pull-left"></asp:TextBox>
        ...
        <tr>
            <td align="right" width="45%" class="style3">邮政编码：
            </td>
            <td class="style3">
                <asp:TextBox ID="txtZipCode" runat="server" CssClass="form-control pull-left"></asp:TextBox>
        ...
        <tr>
            <td align="right" width="45%">电话号码：
            </td>
            <td>
                <asp:TextBox runat="server" CssClass="form-control pull-left" ID="phoneSection" Width="80px"></asp:TextBox>
               <span style=" float:left; line-height:32px; margin-left:5px;margin-right:5px;">-</span>
            <asp:TextBox runat="server" ID="phone" CssClass="form-control pull-left"></asp:TextBox><span class="tips"><font color="gray">区号-电话号码</font></span>
        ...
        <tr>
            <td align="right" width="45%">手机号码：
            </td>
            <td>
                <asp:TextBox ID="txtMobile" CssClass="form-control pull-left" runat="server"></asp:TextBox>
