<%@ page language="C#" autoeventwireup="true" inherits="MIS_AddFiles, App_Web_cmmpujjo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html> 
<html>
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
<link href="../App_Themes/UserThem/Mis.css" rel="stylesheet" type="text/css"/>
<title>添加文档</title>
</head>
<body>
...
<td> <asp:FileUpload ID="Files" runat="server" class="M_input" onkeydown="event.returnValue=false;"   onpaste="return false" />单次上传文件大小不能超过36MB。 </td>
</tr>
