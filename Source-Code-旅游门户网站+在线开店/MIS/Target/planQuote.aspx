<%@ page language="C#" autoeventwireup="true" inherits="MIS_Target_planQuote, App_Web_vixzywbt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<a href="PlanInfoView.aspx?ID=<%#Eval("ID") %>"><%#Eval("PlanName") %></a> </li>
</ItemTemplate>
</asp:Repeater> 
</ul>
<table>
