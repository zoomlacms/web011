<%@ page language="C#" autoeventwireup="true" inherits="MIS_MisSignSetInfo, App_Web_cmmpujjo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
  ...
  <form id="form1" runat="server">
    ...
    <div id="pro_right">
      <div id="SetSign" style="margin-left:24px;">
        ...
        <div>
          <asp:Button ID="BtnSub" runat="server" OnClick="BtnSub_Click" CssClass="i_bottom" Text="提交"/>
          &nbsp;
          <asp:Button ID="BtnReset" runat="server" OnClick="BtnReset_Click" CssClass="i_bottom" Text="取消"/>
        </div>
      </div>
    </div>
  </form>
