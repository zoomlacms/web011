<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Sched_BCManage, App_Web_2wydnesy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
    ...
    <div id="main" style="margin:10px;">
        ...
        <div style="margin-top:5px;">
            <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnRowCommand="EGV_RowCommand"  EnableTheming="False"  GridLines="None" CellPadding="2" CellSpacing="1"  Width="98%" CssClass="table_li table-border" EmptyDataText="当前没有信息!!" OnPageIndexChanging="EGV_PageIndexChanging">
                <Columns>
