<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_AffairDrafting, App_Web_kvow1qcj" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server" enctype="multipart/form-data">
        <div class="draftnav">
            <a href="/MIS/OA/Main.aspx">行政公文</a>/<a href="AffairDrafting.aspx">行政办公起草</a>
        </div>
        <div style="padding-left: 10px; padding-right: 10px; min-width: 960px;">
            <table class="table_li table-border" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="8" class="trhead">事务起草</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="1" style="width: 300px;">
                        <asp:TextBox ID="Title" runat="server" Width="200" CssClass="form-control" /><span class="required">*</span>
                    ...
                    <td colspan="3">
                        <div id="OAkeyword" style="max-width: 300px;"></div>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="Type" runat="server" onchange="PostToCS();"></asp:DropDownList>
                    </td>
                    <td class="text-right" style="width: 100px;">流 程：</td>
                    <td>
                        <asp:DropDownList runat="server" ID="proDP" Width="80"></asp:DropDownList><span class="required">*</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width: 140px; text-align: right; padding: 5px; height: 30px;">
                        <button type="button" name="selruser" id="selruser" class="btn-primary" onclick="selRuser();">选择发送人</button>
                    </td>
                    <td colspan="7">
                ...
                <tr runat="server" visible="false">
                    <td style="width: 140px; text-align: right; padding: 5px; height: 30px;">
                        <button type="button" name="selcuser" id="selcuser" class="btn-primary" onclick="selCuser();">选择协办人</button></td>
                    <td colspan="7">
                ...
                <tr>
                    ...
                    <td colspan="7">
                        <asp:Button runat="server" CssClass="btn-primary" ID="saveBtn" Text="发布" OnClick="saveBtn_Click" OnClientClick="return checkF();" />
                        ...
                        <button type="button" class="btn-primary" style="margin-left: 10px" onclick="printpage();">打印</button>
                    </td>
                </tr>
            </table>
        </div>
        <div id="select" style="position: absolute; display: none; width: 800px; background: #FFF; border: 1px solid #ddd; top: 20%; left: 20%; z-index: 99999;">
            <div id="Free_Div" runat="server" class="panel panel-primary">
                ...
                <div class="panel-body">
                    <iframe runat="server" id="User_IFrame" style="visibility: inherit; overflow: auto; overflow-x: hidden; width: 800px; height: 420px;" name="main_right" src="/Mis/OA/Mail/SelGroup.aspx?Type=AllInfo" frameborder="0"></iframe>
                </div>
            </div>
        </div>
