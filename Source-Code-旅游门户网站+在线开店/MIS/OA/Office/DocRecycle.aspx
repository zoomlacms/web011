<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Office_DocRecycle, App_Web_l1ttvgdr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="draftnav"><div class="draftnav"><a href="/MIS/OA/Main.aspx">行政公文</a>/<a href="Default.aspx">文档管理</a></div></div>
        ...
        <div class="input-group" style=" width:600px;float:left;margin-bottom:10px;margin-left:30px;">
            ...
            <span class="input-group-btn">
             ...
             <span style="color:red;"><input type="radio" id="r1" name="recycleRadio" onchange="GetTo('Garbagebox.aspx');"/><label for="r1">公文</label>
                   <input type="radio" id="r2" name="recycleRadio" checked="checked"/><label for="r2">文档</label></span>
        </div>

    <div class="tab3">
        <ZL:ExGridView runat="server" ID="EGV" DataKeyNames="GeneralID" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"  EnableTheming="False"  GridLines="None" CellPadding="2" CellSpacing="1"  Width="100%" CssClass="table_li table-border" EmptyDataText="回收站中无文件!!" OnPageIndexChanging="EGV_PageIndexChanging" OnRowCommand="EGV_RowCommand" OnRowDataBound="EGV_RowDataBound" >
            <Columns>
