<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Office_Default, App_Web_l1ttvgdr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
...
<body>
    ...
    <div id="site_main" style="margin:5px;">
        <div style="margin-bottom:5px;">
            <ul class="draft_ul">
                <li class="current"><a href="Default.aspx">公文</a></li>
