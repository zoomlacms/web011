<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Office_DocManage, App_Web_l1ttvgdr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
      <div class="draftnav"><a href="/MIS/OA/Main.aspx">行政公文</a>/<a href="Default.aspx">文档管理</a>
          <asp:LinkButton runat="server" ID="addBtn" OnClientClick="GetTo();return false;">[添加新公文]</asp:LinkButton></div>
            ...
            <ul class="draft_ul">
                ...
                <li class="current"><a href="DocManage.aspx">文档</a></li>
...
<div id="site_main" style="margin:5px;">
    ...
    <div class="tab3">
        <ZL:ExGridView runat="server" ID="EGV" DataKeyNames="GeneralID" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"  EnableTheming="False"  GridLines="None" CellPadding="2" CellSpacing="1"  Width="100%" CssClass="table_li table-border" EmptyDataText="没有任何数据!!" OnPageIndexChanging="EGV_PageIndexChanging" OnRowCommand="EGV_RowCommand" OnRowDataBound="EGV_RowDataBound" >
            <Columns>
