<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Office_ReadOffice, App_Web_oiluqk04" clientidmode="Static" validaterequest="false" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
...
<body>
    ...
    <div style="margin:10px;">
        ...
        <tr runat="server" id="opBar"><td class="text-right">操作：</td>
            <td colspan="7">
                <asp:Button runat="server" ID="agreeBtn" Visible="false" Text="同意" CssClass="btn-primary opBtn" OnClick="agreeBtn_Click" OnClientClick="return sureF('请点击确认同意!!');"/>
        ...
        <div id="main" style="margin:5px 0 0 0;">
            <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False"  GridLines="None"   Width="100%" CssClass="table_li table-border" OnPageIndexChanging="EGV_PageIndexChanging" OnRowCommand="EGV_RowCommand" >
                <Columns>
