<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Office_DraftBox, App_Web_l1ttvgdr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="site_main" style="margin:10px;">
        <div style="margin-bottom:10px;">
            <ul class="draft_ul">
                ...
                <li class="current"><a href="DraftBox.aspx">草稿箱</a></li>
        ...
        <div class="tab3">
            <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"  EnableTheming="False"  GridLines="None" CellPadding="2" CellSpacing="1"  Width="100%" CssClass="table_li table-border" EmptyDataText="你当前尚未发出任何公文!!" OnPageIndexChanging="EGV_PageIndexChanging" OnRowCommand="EGV_RowCommand" OnRowDataBound="EGV_RowDataBound" >
                <Columns>
