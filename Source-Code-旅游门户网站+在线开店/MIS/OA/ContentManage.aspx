<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_ContentManage, App_Web_kvow1qcj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
...
<div class="draftnav">
     <span><a href="/MIS/OA/Main.aspx">工作台</a>>><asp:Label ID="nodeNameL" runat="server" />
...
<div id="site_main" style="margin:5px;">
    ...
    <div class="tab3">
        <ZL:ExGridView runat="server" ID="EGV" DataKeyNames="GeneralID" AutoGenerateColumns="false" AllowPaging="true" PageSize="20" enablec
             EnableTheming="False"  GridLines="None" CellPadding="2" CellSpacing="1"  Width="100%" CssClass="table_li table-border" EmptyDataText="没有任何数据!!" OnPageIndexChanging="EGV_PageIndexChanging" OnRowCommand="EGV_RowCommand" OnRowDataBound="EGV_RowDataBound" >
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
