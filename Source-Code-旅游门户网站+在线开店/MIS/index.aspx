<%@ page language="C#" autoeventwireup="true" inherits="MIS_Mis, App_Web_cmmpujjo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
    ...
    <div id="M_right">
        <div class="M_File">
            ...
            <ul class="list-unstyled m_border">
                <li><span class="glyphicon glyphicon-file"></span><a href="#"> 企业社区 2.2 发布企业社区 2.2 发布</a></li>
                <li><span class="glyphicon glyphicon-file"></span><a href="#"> 企业社区 2.2 发布企业社区 2.2 发布</a></li>
                <li><span class="glyphicon glyphicon-file"></span><a href="#"> 企业社区 2.2 发布企业社区 2.2 发布</a></li>
                <li><span class="glyphicon glyphicon-file"></span><a href="#"> 企业社区 2.2 发布企业社区 2.2 发布</a></li>
                <li><span class="glyphicon glyphicon-file"></span><a href="#"> 企业社区 2.2 发布企业社区 2.2 发布</a></li>
