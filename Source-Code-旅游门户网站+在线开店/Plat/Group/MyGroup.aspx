<%@ page language="C#" autoeventwireup="true" inherits="Plat_Group_MyGroup, App_Web_rd103gw3" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="child_head">
        ...
        <span class="child_head_span2">群组列表</span>
    </div>
    <asp:DropDownList runat="server" ID="Group_DP" style="margin:10px 0 10px 0">
        <asp:ListItem Value="1">所有群组</asp:ListItem>
