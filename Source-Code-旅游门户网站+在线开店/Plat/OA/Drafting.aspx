<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Drafting, App_Web_tkqthnmr" validaterequest="false" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="Free_Div" runat="server" class="panel panel-primary">
  <div class="panel-heading">
	...
	<span style="position:absolute;top:13px;font-size:1.2em; cursor: pointer;" title="关闭" onclick="closesel();" class="glyphicon glyphicon-remove"></span>
