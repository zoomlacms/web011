<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_InfoDetail, App_Web_twso2v0w" clientidmode="Static" masterpagefile="~/Plat/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="Head">
    <title>个人信息</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div style="height: 40px; line-height: 40px; background-color: #f7f7f7;">
            <div style="width:50%;float:left;padding-left:10px;"><span class="glyphicon glyphicon-remove" title="关闭" onclick="CloseSelf();"></span></div>
            <div style="width:50%;float:left;padding-right:10px;text-align:right;">
            <%--    <span class="glyphicon glyphicon-envelope" style="margin-right:5px;" title="站内邮件"></span>
                <span class="glyphicon glyphicon-comment" title="站内短信"></span>--%>
            </div>
        </div>
    <div id="content">
        <div id="head">
