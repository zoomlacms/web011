<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_ProjectDetail, App_Web_yqt4rj4s" masterpagefile="~/Plat/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tr>
  <td colspan="2"><span class="glyphicon glyphicon-user"></span> <a href="javascript:;" target="_blank">
	<asp:Label runat="server" ID="CUser_T"></asp:Label>
	</a> <span style="margin-left:10px;">创建</span></td>
</tr>
<tr>
  <td><span class="glyphicon glyphicon-user"></span> <span>主负责人：</span> <a href="#"><span class="glyphicon glyphicon-plus-sign" title="添加" onclick="selRuser();"></span></a>
	<asp:HiddenField runat="server" ID="LeaderIDS_Hid" /></td>
  <td><asp:Label runat="server" ID="LeaderIDS_L"></asp:Label></td>
</tr>
<tr>
  <td><span class="glyphicon glyphicon-user"></span> <span>任务成员：</span> <a href="#"><span class="glyphicon glyphicon-plus-sign" title="添加" onclick="selCuser();"></span></a>
...
<tr>
  <td><span class="glyphicon glyphicon-bookmark"></span><span>是否完成：</span></td>
...
<tr>
  <td><span class="glyphicon glyphicon-paperclip" onclick="openUpfile()"></span><span>附件：</span></td>
