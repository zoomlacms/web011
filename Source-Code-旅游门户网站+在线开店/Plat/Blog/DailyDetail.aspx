<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_Declined, App_Web_yqt4rj4s" masterpagefile="~/Plat/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div style="width:600px;">
    ...
    <div style="padding-left:1em; padding-top:10px;">
      <table id="DetailTable">
        ...
        <tr>
          <td><span class="glyphicon glyphicon-pushpin"></span>地点：</td>
          <td><span>
            <asp:TextBox runat="server" ID="Place" CssClass="form-control required date"></asp:TextBox>
            </span></td>
        </tr>
        <tr>
