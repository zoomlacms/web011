<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_ContentDetail, App_Web_50tr421b" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                <div class="ContentDiv">
                    ...
                    <div class="content_operate">
                        <span class="createDate">
                            <asp:Label ID="CreateTime_L" runat="server"></asp:Label></span>
                        ...
                        <span class='glyphicon glyphicon-send' title='转发' id='re_span' onclick="ShowForWard()"></span>
                    </div>
                </div>
                ...
                <div class="comment_content text-center">
                                ...
                                <div class="msgmain_div margintop10">
                                    <div class="row">
                                        <div class="msg_left_div padding0 col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                            <img class="imgface_mid" src="<%#Eval("UserFace") %>" onerror="this.src='/Images/userface/noface.gif';" title="<%#Eval("CreateUName") %>" onclick="ShowUser(<%#Eval("CreateUser") %>);" /><br />
                                            <a href="javascript:ShowUserDiv('<%#Eval("CreateUser") %>')"><%#Eval("CreateUName") %></a>
                                        </div>
                                        <div class="msg_content_div padding0 text-left col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                            <div class="msg_content_article_div"><%#Eval("MsgContent")%></div>
                                            <span class="content_date">
                                                <%#Convert.ToDateTime(Eval("CreateTime")).ToString("yyy年MM月dd日 hh:mm") %>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="likes_div" style="display: none;">
                        <span class="noneContent" id="Empty_Span_Like" style="padding: 3px;" visible="false" runat="server">当前无人点赞！</span>
                        <div class="msgmain_div margintop10">
                ...
                <div class="send_div margintop10">
                    <span class="glyphicon glyphicon-comment"></span><strong>发表评论</strong>
                    <div>
                        <asp:TextBox ID="sendComment_T" CssClass="margintop10" Width="100%" Height="100" TextMode="MultiLine" runat="server"></asp:TextBox>
                    </div>
                    <div class="text-right margintop10">
                        <asp:Button ID="sendButton" Text="发表" OnClick="sendButton_Click" CssClass="btn btn-primary" runat="server" /></div>
                </div>
            </div>
