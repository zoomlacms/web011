<%@ page language="C#" autoeventwireup="true" inherits="Plat_Admin_Default, App_Web_2m435bxa" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="child_head"> <span class="child_head_span1"></span> <span class="child_head_span2">邀请注册</span> </div>
<div style="padding-top:10px;">
<div class="col-lg-5"> <span>使用邮箱地址邀请用,号隔开：</span>
  <div>
...
<div>
<div class="child_head"> <span class="child_head_span1"></span> <span class="child_head_span2">用户列表</span> </div>
...
<ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" IsHoldState="false"
  ...
  <asp:TemplateField HeaderText="会员名">
	<ItemTemplate> <%#Eval("UserName","{0}") %> </ItemTemplate>
  </asp:TemplateField>
  ...
  <asp:TemplateField HeaderText="加入时间">
	<ItemTemplate> <%#Convert.ToDateTime(Eval("CreateTime")).ToString("yyyy年MM月dd日") %> </ItemTemplate>
  </asp:TemplateField>
  <asp:TemplateField HeaderText="操作">
	<ItemTemplate> <a href="/Plat/UPCenter.aspx?uid=<%#Eval("UserID") %>" title="修改"><span class="glyphicon glyphicon-pencil"></span></a>
	  <asp:LinkButton runat="server" CommandName="Del2" CommandArgument='<%#Eval("UserID") %>' OnClientClick="return confirm('你确定要删除吗!');" ToolTip="删除" style="margin-left:5px;"> <span class="glyphicon glyphicon-trash"></span></asp:LinkButton>
	</ItemTemplate>
  </asp:TemplateField>
  </Columns>
