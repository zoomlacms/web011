<%@ page language="C#" autoeventwireup="true" inherits="Plat_Mail_NetMessageDail, App_Web_cp3nij5i" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="mainDiv">
  ...
  <table class="table table-bordered table-striped">
    ...
    <style type="text/css">
        .fileli{cursor:pointer;padding-top:5px;}
        .fileli:hover{background:#428bca;}
    </style>
