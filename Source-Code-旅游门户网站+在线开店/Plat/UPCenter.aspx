<%@ page language="C#" autoeventwireup="true" inherits="Plat_RegisterDetail, App_Web_5q1we5yy" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="admin_div">
      <table class="table table-bordered table-hover table-striped">
        <tr>
          ...
          <td class="tdcontent"><asp:TextBox ID="UserName_T2" CssClass="form-control " ReadOnly="true" runat="server" /></td>
        </tr>
        <tr>
          <td class="tdname">用户组：</td>
          <td class="tdcontent"><asp:TextBox ID="Plat_Group_T2" onkeydown="return GetEnterCode('focus','Status_T2');" CssClass="form-control" Enabled="false" runat="server" /></td>
        </tr>
        <tr>
          <td class="tdname">状态：</td>
          <td class="tdcontent"><asp:TextBox ID="Status_T2" onkeydown="return GetEnterCode('focus','TrueName_T2');" CssClass="form-control " runat="server" Enabled="false" Text="正常" /></td>
        </tr>
        <tr>
          <td class="tdname">真实姓名：</td>
          <td class="tdcontent"><asp:TextBox ID="TrueName_T2" onkeydown="return GetEnterCode('focus','Mobile_T2');" CssClass="form-control" runat="server" />
            <asp:RequiredFieldValidator runat="server" ID="R1" ControlToValidate="TrueName_T2" ErrorMessage="真名不能为空" ForeColor="Red" Display="Dynamic" ValidationGroup="Add" /></td>
        </tr>
        <tr>
          <td class="tdname">移动电话：</td>
          <td class="tdcontent"><asp:TextBox ID="Mobile_T2" onkeydown="return GetEnterCode('focus','Post_T2');" CssClass="form-control" runat="server" /></td>
        </tr>
        <tr>
          <td class="tdname">工作岗位：</td>
          <td class="tdcontent"><asp:TextBox ID="Post_T2" onkeydown="return GetEnterCode('click','Save_Btn');" CssClass="form-control" runat="server" /></td>
        </tr>
        <tr>
          <td class="tdname">个人头像：</td>
          <td><asp:FileUpload ID="File_Up" runat="server" Style="margin-top: 20px; display: inline;" />
            <asp:Button ID="ImgUP_Btn" CausesValidation="false" runat="server" ToolTip="上传图片" CssClass="btn btn-primary" Text="上传" OnClientClick="return checkFile()" OnClick="ImgUP_Btn_Click" />
            <span id="img_D" title="图片预览">
            <asp:Image runat="server" ID="pre_img" Style="width: 150px; height: 80px; margin-left: 30px;" />
            </span></td>
        </tr>
        <tr>
