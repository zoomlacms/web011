...
public class UserAPI : IHttpHandler {
    public void ProcessRequest (HttpContext context) {
        ...
        M_Net_User model = JsonHelper.JsonDeserialize<M_Net_User>(context.Request["Model"]), rmod = new M_Net_User();
        ...
        catch (Exception ex) { B_Site_Log.Insert("UserApi", model.source + ":" + method + ":" + ex.Message); }
    ...
    public M_Net_User B_UserDeal(string method, M_Net_User model)
    {
        ...
        {
            case "Adds":
                rmod.str = buser.Adds(model.mu).ToString();
                break;
            case"AddBase":
            ...
            case "GetSelect":
                ...
                break;
            case "getUserinfo":
                rmod.str = buser.getUserinfo(model.uid.ToString());
                break;
            ...
            case "UpDateUser":
                ...
                break;
            case "UpUserUnLock":
                rmod.flag = buser.UpUserUnLock(model.uid);
                break;
            case "Audit":
            ...
            case "AuthenticateUsers":
                ...
                break;
            case "AddExp":
                rmod.flag = buser.AddExp(model.uid, model.gid);
                break;
            case "DelExp":
                rmod.flag = buser.DelExp(model.uid, model.gid);
                break;
            case "AddGuestScore":
                rmod.flag = buser.AddGuestScore(model.uid, model.gid);
                break;
            case "DelGuestScore":
                rmod.flag = buser.DelGuestScore(model.uid, model.gid);
                break;
            case "AddCoin":
                rmod.flag = buser.AddCoin(model.uid, model.gid);
                break;
            case "DelCoin":
                rmod.flag = buser.DelCoin(model.uid, model.gid);
                break;
            case "AddPurse":
                rmod.flag = buser.AddPurse(model.uid, model.gid);
                break;
            case "AddPurseWithLog":
                rmod.flag = buser.AddPurseWithLog(model.uid, model.gid, model.str);
                break;
            case "MinusPurse":
                rmod.flag = buser.MinusPurse(model.uid, model.gid);
                break;
            case "AddSilverCoin":
                rmod.flag = buser.AddSilverCoin(model.uid, model.gid);
                break;
            case "MinSilverCoin":
                rmod.flag = buser.MinSilverCoin(model.uid, model.gid);
                break;
            case "AddDummyPurse":
                rmod.flag = buser.AddDummyPurse(model.uid, model.gid);
                break;
            case "MinusDummyPurse":
                rmod.flag = buser.MinusDummyPurse(model.uid, model.gid);
                break;
            case "UpdateUserFile":
            ...
            case "UpdateUserHouse":
                ...
                break;
            case "UpdateUserFace":
                rmod.flag = buser.UpdateUserFace(model.uid, model.str);
                break;
            ...
            case "UpdateIsCloud":
                ...
                break;
            case "Insert":
                rmod.flag = buser.Insert(model.mu);
                break;
            case "UpByWhere":
            ...
            case "ReturnMoney":
                ...
                break;
            case "BatAudit":
                rmod.flag = buser.BatAudit(model.str);
                break;
            case "GetUserInfo":
                rmod.dt = buser.GetUserInfo().ToTable();
                break;
            case "GetUserByGroup":
            ...
            case "ModeleState":
                ...
                break;
            case "UpUserLock":
                rmod.flag = buser.UpUserLock(model.uid, DateTime.Parse(model.str));
                break;
            case "UpdateTime":
