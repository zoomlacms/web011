<%@ page language="C#" autoeventwireup="true" inherits="API_GetPageHtml, App_Web_uo3oyca3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>源码分析器</title>
...
目标网址：
  ...
  <br>
  <asp:TextBox id="ContentHtml" runat="server"  TextMode="MultiLine"  Style=" width:100%;height:360px;" > </asp:TextBox>
</form>
</body>
</html>