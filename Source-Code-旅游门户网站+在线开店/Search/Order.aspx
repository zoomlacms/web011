<%@ page language="C#" autoeventwireup="true" inherits="User_SearchOrder, App_Web_f01hyl3b" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
	  ...
	  <div class="us_seta" style="margin-top:10px;">
       ...
       <ul>
         <li style="width:100%; float:left;line-height:30px; text-align:left">
              ...
              说明：这里只能查询非会员的订单。订单编号和收货人姓名必须完全正确才能找得到如果您是会员，<br />请登陆后进入会员控制面板查询自己的订单。
          </li>
       </ul>
    </asp:Panel>
