<%@ page language="C#" autoeventwireup="true" inherits="Install_Default, App_Web_et451goi" responseencoding="utf-8" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="col-sm-offset-1 col-lg-2">
	<a href="http://www.zoomla.cn/" target="_blank">
		<img src="/Install/images/logo.jpg" class="img-responsive" alt="欢迎使用逐浪CMS" /></a>
</div>
<div class="col-lg-7">
	<ul>
	...
	<div id="DivInstall6" runat="server">
		<div class="insbox">
			...
			<table cellspacing="0" cellpadding="0" class="ins_table" align="center">
				<tr>
					<td>
						<asp:Label ID="Label1" runat="server" Style="padding-right: 15px;"></asp:Label></td>
					<td>
						<asp:Image ID="Image1" runat="server" /></td>
					<td rowspan="4" style="padding: 15px;">
						<div id="lable5" runat="server"></div>
					</td>
					<td rowspan="4" style="padding: 15px;">
						<div id="img5" runat="server"></div>
					</td>
					<td rowspan="4" style="padding: 15px;">
						<div id="lable6" runat="server"></div>
					</td>
					<td rowspan="4" style="padding: 15px;">
						<div id="img6" runat="server"></div>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<div id="lable4" runat="server"></div>
					</td>
					<td>
						<div id="img4" runat="server"></div>
					</td>
				</tr>
				<tr>
					<td id="Td1" colspan="2" runat="server">
						<asp:Label ID="lbltip" runat="server" ForeColor="Red"></asp:Label></td>
				</tr>
			</table>
			<div class="lbot2">
				...
				<asp:UpdatePanel ID="UpdatePanel1" runat="server">
					<ContentTemplate>
						<table>
							...
							<tr>
								<td>
									<asp:Button ID="BtnCreateDateBase" runat="server" OnClientClick="ShowProgress();disBtn(this,2000);" Text="开始创建" OnClick="BtnCreateDateBase_Click" Width="70" Height="26" />
								</td>
							</tr>
						</table>
					</ContentTemplate>
...
<asp:WizardStep ID="WizardStep4" runat="server" Title="Step 5">
	<div id="DivInstall4" runat="server" class="left140">
		...
		<div class="install" style="margin-top: 3em;">
			<div class="biao">
				<span style="margin-left: 570px; _margin-left: 580px;"></span>
			</div>
...
<script type="text/javascript" src="http://code.zoomla.cn/jquery/jquery-1.10.2.min.js"></script>
