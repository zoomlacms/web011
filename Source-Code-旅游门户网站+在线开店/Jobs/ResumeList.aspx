<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Jobs.ResumeList, App_Web_irxm4xe1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>求职信息</title>
...
<asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>&gt;&gt; 求职信息</div>
  <div class="us_seta" style="margin-top:10px;" id="manageinfo" runat ="server">
    ...
    <asp:GridView ID="Egv" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="CID" PageSize="10" OnPageIndexChanging="Egv_PageIndexChanging" OnRowCommand="Lnk_Click" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" EmptyDataText="暂时没有用户向贵单位投递简历">
      <Columns>
