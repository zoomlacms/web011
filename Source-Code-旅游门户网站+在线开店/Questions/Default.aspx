<%@ page language="C#" autoeventwireup="true" inherits="Questions_Default, App_Web_0nolphw2" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<!DOCTYPE HTML>
<html>
<head runat="server">
<meta http-equiv="Content-Type" content="text/html" charset="utf-8" />
<title><%Call.Label("{$SiteName/}");%>-×é¾íÏµÍ³</title>
<style type="text/css">
    body{font-size: 9pt;}
