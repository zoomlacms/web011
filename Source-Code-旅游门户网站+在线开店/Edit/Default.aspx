<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="Edit_EditContent, App_Web_xkyox3ti" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>写作助理</title>
...
<div id="wtfltx_nav">
<div id="wtfltx_navH">
<img id="wt_close" onclick="nav_close('wtfltx_navC','wt_close','wt_show')" src="../App_Themes/UserThem/images/edit/w_close.gif"
    alt="" />
...
<div id="w_navGD">
<img onclick="nav_close('w_navGD','w_navGD','w_navGD')" src="../App_Themes/UserThem/images/edit/w_close.gif"
    alt="" />
<br />
<span id="hidden1" onclick="nav_close('zhank01','hidden1','zh1')">关闭</span><img id="zh1"
    src="../App_Themes/UserThem/images/edit/w_nav_zhank.jpg" onclick="nav_show('zhank01','zh1','hidden1')"
    alt="" /><b>知照类：</b><br />
<div id="zhank01" style="display: none">
    <a href="#">公告</a> <a href="#">通报</a> <a href="#">公报</a> <a href="#">通知</a> <a href="#">
        函</a><br />
</div>
<img id="zh2" src="../App_Themes/UserThem/images/edit/w_nav_zhank.jpg" onclick="nav_show('zhank02','zh2','hidden2')"
    alt="" /><span id="hidden2" onclick="nav_close('zhank02','hidden2','zh2')">关闭</span><b>批答类：</b><br />
<div id="zhank02" style="display: none">
    <a href="#">批复</a> <a href="#">答复函</a><br />
</div>
<img id="zh3" src="../App_Themes/UserThem/images/edit/w_nav_zhank.jpg" onclick="nav_show('zhank03','zh3','hidden3')"
    alt="" /><span id="hidden3" onclick="nav_close('zhank03','hidden3','zh3')">关闭</span><b>执办类：</b><br />
<div id="zhank03" style="display: none">
    <a href="#">决议</a> <a href="#">命令</a> <a href="#">条例 </a><a href="#">决定 </a><a href="#">
        通告</a><br />
</div>
<img id="zh4" src="../App_Themes/UserThem/images/edit/w_nav_zhank.jpg" onclick="nav_show('zhank04','zh4','hidden4')"
    alt="" /><span id="hidden4" onclick="nav_close('zhank04','hidden4','zh4')">关闭</span><b>报请类：</b><br />
...
<ul>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" onclick="nav_show('w_navGD','w_navGD','w_navGD')" /><b>法定公文：</b><a
            href="SourceList.aspx?NodeID=78" target="contents">请示</a> <a href="#">公告</a><a href="#">
                通告</a><a href="#"> 通知</a><a href="#"> 意见函</a><a href="#"> 批复</a> </li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>军事文书：</b><a
            href="#">动员令</a><a href="#"> 政工信息</a><a href="#"> 考核材料 </a><a href="#">政课教案</a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>事务公文：</b><a
            href="#" id="fltx11" class="zy_s02">讲话稿</a><a href="#" id="fltx12" class="zy_s02"> 工作总结</a><a
                href="#"> 竞聘演讲稿 </a><a href="#">述职报告</a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>教育文书：</b><a
            href="#">教学大纲</a><a href="#"> 教案 </a><a href="#">毕业论文</a><a href="#"> 网络课件</a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>商务文书：</b><a
            href="#">商品询价函</a><a href="#"> 承包合同 </a><a href="#">网上交易协议书</a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>涉外文书:</b><a
            href="#">进口合同</a><a href="#"> 反倾销应诉书</a><a href="#"> 出口商品推广函</a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>经济文书：</b><a
            href="#">经济活动分析报告</a><a href="#"> 财经决算报告</a> </li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>其他行业文书:</b><a
            href="#"> 房屋租用协议书</a><a href="#"> 住院记录</a><a href="#"> 信贷计划书</a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>法律文书：</b><a
            href="#">辩护词</a><a href="#"> 刑事上诉状</a><a href="#"> 民事调解书 </a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>日常实用文书：</b><a
            href="#">求职信 </a><a href="#">招聘启事</a><a href="#"> 招工启事</a><a href="#"> 推荐信</a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>科技文书：</b><a
            href="#">科技论文 </a><a href="#">科研开题报告词</a><a href="#"> 发明申报书</a> </li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b> 社交礼仪文书：</b><a
            href="#">祝酒辞 </a><a href="#">欢送词</a><a href="#"> 颁奖词</a><a href="#"> 贺电 </a>
        <a href="#">悼词</a> </li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>新闻出版文书：</b><a
            href="#">人物消息 </a><a href="#">综合报道</a><a href="#"> 深度报道</a><a href="#"> 发刊词</a></li>
    <li>
        <img src="../App_Themes/UserThem/images/edit/w_more.gif" alt="" /><b>日常电子文书：</b><a
...
<div id="WCON_m">
<div id="WCON_m_pic">
    <img src="../App_Themes/UserThem/images/edit/toleft.jpg" alt="" onclick="nav_close('w_conL','','WCON_r')" /><img
        src="../App_Themes/UserThem/images/edit/middel.jpg" alt="" onclick="nav_close('w_conL','m','WCON_r')" /><img
            src="../App_Themes/UserThem/images/edit/toright.jpg" alt="" onclick="nav_close('WCON_r','','w_conL')" /></div>
</div>
