<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_AddPageStyle, App_Web_y1nkzetg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
  <tbody id="Tbody1">
    ...
    <tr class="tdbg" id="1" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      <td width="26%" height="24" align="left" class="tdbgleft"><strong>样式名称：</strong></td>
      <td width="74%" align="left">
          <asp:TextBox ID="styleName" class="l_input" runat="server" Width="259px"></asp:TextBox>
          <span style="color:red;">*
              <asp:RequiredFieldValidator ID="RF1" runat="server" ControlToValidate="styleName"
                  ErrorMessage="样式名称不能为空!"></asp:RequiredFieldValidator></span></td>
    </tr>
      <tr class="tdbg" id="1" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          <td height="24" align="left" class="tdbgleft"><strong> 样式目录：</strong></td>
          <td align="left">
    ...
    <tr class="tdbg" id="Tr3" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td align="left"><asp:TextBox ID="orderid" class="l_input" runat="server" Width="247px">0</asp:TextBox>*数字越大排列越前
          </td>
    </tr>
