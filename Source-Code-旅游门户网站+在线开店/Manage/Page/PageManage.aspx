<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_PageManage, App_Web_y1nkzetg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
  ...
  <span class="ml30"> 申请人：</span></div>
      <table  cellpadding="2" border="0" cellspacing="1" style="background:#fff;float:left;margin-right:5px;" class="l_input"><tr ><td> 
      <asp:TextBox ID="keyword" BorderColor="#fff" CssClass="l_inpnon" runat="server"></asp:TextBox> 
  <asp:Button ID="Button1" runat="server" class="C_sch" Text="" OnClick="Button1_Click" />
      </td></tr></table>    
          
     按申请人地区筛选： <select runat="server" id="selprovince" name="selprovince" onchange="javascript:area()">
                                            </select>
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr align="center">
        ...
        <td id="TabTitle1" class="tabtitle" onclick="ShowTabs(1)">已审核</td>
        <td id="TabTitle2" class="tabtitle" onclick="ShowTabs(2)">待审核</td>
    </tr>
</table>
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
    <tbody id="Tbody1">
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td align="center" class="title" style="width:18%"><span class="tdbgleft">黄页样式</span></td>
        ...
        <asp:Repeater ID="Pagetable" runat="server">
            <ItemTemplate>
                <tr class="tdbg" id="<%#Eval("ID") %>" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" ondblclick="getinfo(this.id)">  
                    ...
                    <td style="height: 24px" align="center"><%#GetStyleName(Eval("NodeStyle")) %></td>
...
<table width="100%">
    <tr>
        <td align="left" style="width:100%">          
            <asp:Button runat="server" CssClass="C_input" ID="Button3" Text="批量审核" OnClick="Button3_Click" />&nbsp;
             <asp:Button runat="server" CssClass="C_input" ID="Button2" Text="取消审核" OnClick="Button2_Click" />&nbsp;
            ...
            <asp:Button runat="server" CssClass="C_input" id="Button7" Text="批量将样式修改为" OnClick="Button7_Click" OnClientClick="return confirm('确定要修改吗?');"/>
