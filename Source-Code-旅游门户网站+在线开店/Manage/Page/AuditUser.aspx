<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="manage_Page_AuditUser, App_Web_y1nkzetg" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    ...
                    <tr id="Tr5" class="tdbg" runat="server">
                        ...
                        <td align="right" class="tdbgleft" style="height: 24px; width: 30%">黄页样式：
                        </td>
                        <td align="left" class="tdbgright" style="height: 24px; width: 70%">
