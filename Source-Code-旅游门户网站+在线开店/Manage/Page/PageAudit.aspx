<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_PageAudit, App_Web_y1nkzetg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
  ...
  <tbody id="Tabs" >
    ...
    <td width="50%" align="center" class="title">
        ...
        <asp:Button ID="Button1"   PostBackUrl="PageAudit.aspx" runat="server" Text="" class="C_sch" />
