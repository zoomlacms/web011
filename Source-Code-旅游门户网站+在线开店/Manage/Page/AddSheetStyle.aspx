<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_AddSheetStyle, App_Web_y1nkzetg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span></span> 企业黄页 &gt;&gt; <span><a href="SheetStyleManage.aspx">样式库</a> &gt;&gt; <span><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
</span></span></div>
  ...
  <tbody id="Tbody1">
    ...
    <tr class="tdbg" id="1" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td width="74%" align="left">
          <asp:TextBox ID="Alias" name="Alias" class="l_input" runat="server" Width="259px"></asp:TextBox>
          <font color=red>*
              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Alias"
                  ErrorMessage="样式标题不能为空!"></asp:RequiredFieldValidator></font></td>
    </tr>
    <tr class="tdbg" id="Tr2" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td width="74%" align="left">
          <asp:TextBox ID="Lname" name="Lname" class="l_input" runat="server" Width="259px"></asp:TextBox>
          <font color=red>*
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Lname"
                  ErrorMessage="标签名不能为空!"></asp:RequiredFieldValidator></font></td>
    </tr>
    <tr class="tdbg" id="Tr4" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td width="74%" align="left">
            <asp:DropDownList runat="server" ID="Ltype" name="Ltype">
           ...
           <%-- <select name="Ltype" runat="server">
            <option value="1">商品列表</option>
            <option value="2">文章列表</option>
            <option value="3">新相册</option>
            <option value="4">布局</option>
            <option value="5">天气预报</option>
            <option value="6">图层</option>
            <option value="7">版式</option>
            <option value="8">背景</option>
            <option value="9">在线地图</option>
            <option value="10">模板</option>
            <option value="11">系统</option>
            </select>--%></td>
    </tr>
    <tr class="tdbg" id="Tr1" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td width="74%" align="left">
          <asp:TextBox ID="Price" name="Price" class="l_input" runat="server" Width="259px">0</asp:TextBox>元
          <font color=red>*
...
<td align="left">
          <asp:TextBox ID="ShowImg" class="l_input" runat="server" Width="259px"></asp:TextBox>
           <font color="red">*
              <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ShowImg"
                  ErrorMessage="缩略图不能为空!"></asp:RequiredFieldValidator></font>
                  <iframe id="bigimgs" style="top: 2px" src="../shop/fileupload.aspx?menu=ShowImg" width="100%"
    ...
    <tr class="tdbg" id="Tr18">
      <td height="24" colspan="2" align="center">
          ...
          <asp:Button ID="Button2" class="C_input"  runat="server" Text="取消" OnClick="Button2_Click" /></td>
    </tr>
  </tbody>
</table>
</form>
