<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.UpdatePageField, App_Web_y1nkzetg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<a href="/manage/Page/PageModelManage.aspx">模型管理</a> &gt;&gt; <a href="/manage/Page/PageField.aspx?ModelID=<%= MID %>">字段列表</a> &gt;&gt; 修改[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段
    </div>
    <div class="clearbox">
    </div>
