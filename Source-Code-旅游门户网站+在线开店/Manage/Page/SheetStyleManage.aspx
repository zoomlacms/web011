<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_SheetStyleManage, App_Web_y1nkzetg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
        <tbody id="Tabs">
            ...
            <table  cellpadding="2" border="0" cellspacing="1" style="background:#fff;float:left;margin-left:10px;" class="l_input"><tr ><td>
                    <asp:TextBox ID="souchkey" runat="server" BorderColor="#fff" CssClass="l_inpnon" Width="140px"/>
                    <asp:Button ID="souchok" runat="server" Text="" class="C_sch" 
                        onclick="souchok_Click" /></td></tr></table>
                </td>
            </tr>
        </tbody>
    </table>
