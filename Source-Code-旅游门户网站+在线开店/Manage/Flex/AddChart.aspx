<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="manage_Flex_Chart, App_Web_3ebbleh4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
<div class="r_navigation">后台管理&gt;&gt; 扩展功能&gt;&gt; <a href="../Plus/ChartManage.aspx">图表管理</a>&gt;&gt;<asp:Label
    ID="Lt" runat="server" Text="添加图表"></asp:Label></div>
