<%@ page language="C#" enableviewstatemac="false" autoeventwireup="true" inherits="manage_Plus_ChartManage, App_Web_ka5t45ft" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html>
...
<body>
  ...
  <%} %> 后台管理 &gt;&gt;扩展功能 &gt;&gt; 图表管理&gt;&gt;&nbsp;图表列表<font color="red">[<a href="../Flex/AddChart.aspx" target="_self" style="color:Red;" >添加图表</a>]</font></div>
