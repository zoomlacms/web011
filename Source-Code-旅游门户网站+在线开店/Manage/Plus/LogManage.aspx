<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Log.LogManage, App_Web_ka5t45ft" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>日志管理</title>
...
<body>
    ...
    <asp:GridView ID="Egv" class="border" DataKeyNames="LogID" runat="server" AutoGenerateColumns="False"
        ...
        OnRowCommand="Lnk_Click" EmptyDataText="无相关数据" onrowdatabound="Egv_RowDataBound">
        <Columns>
