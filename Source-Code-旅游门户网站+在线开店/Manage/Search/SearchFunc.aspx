<%@ page language="C#" autoeventwireup="true" inherits="manage_Search_SearchFunc, App_Web_rgdbixrc" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>便捷导航</title>
...
<div>
	<asp:GridView ID="gvCard" runat="server" AutoGenerateColumns="False" CssClass="border" Width="100%" OnRowDataBound="gvCard_RowDataBound" RowStyle-CssClass='tdbg' GridLines="None" CellPadding="2" CellSpacing="1">
		<Columns>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
	<tr class="tdbg">
		<td colspan="6">
			<div class="tdbg">
				<span>
					<asp:CheckBox ID="CheckSelectAll" runat="server" AutoPostBack="True" Text="全选" onclick="CheckAll(this)" />
