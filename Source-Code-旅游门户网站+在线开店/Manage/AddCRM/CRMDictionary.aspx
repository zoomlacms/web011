<%@ page language="C#" autoeventwireup="true" inherits="manage_AddCRM_CRMDictionary, App_Web_yrpnlfyh" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %>
    ...
    <asp:Panel ID="asdf" runat="server">
            ...
            <asp:Repeater ID="repeater1" runat="server" OnItemCommand="repeater1_ItemCommand">
                <ItemTemplate>
                    <tr style="width: 500px" class="tdbg" onmouseover="this.className='tdbgmouseover'"
                        ...
                        <td align="center">
                            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Del" CommandArgument='<%#Eval("sort") %>' OnClientClick="return confirm('你确定要删除吗!');">删除</asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
        ...
        <asp:Button ID="Button1" runat="server" Text="保存" OnClick="Save_Click" class="C_input" />
