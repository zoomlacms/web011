<%@ page language="C#" autoeventwireup="true" inherits="manage_AddCRM_Customer, App_Web_yrpnlfyh" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<!DOCTYPE HTML>

<html>
<head id="Head1" runat="server">
<title><%=lang.LF("日常操作")%></title>
...
<ul>
    ...
    <li id="Guide_main">
        <div id="Guide_box">
          <div class="guideexpand" onclick="Switch(this)"><%=lang.LF("客户管理")%></div>
            <div class="guide">
                <ul>
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CustomerList.aspx?usertype=0" target="main_right"><%=lang.LF("所有客户")%></a></li>                    
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CustomerList.aspx?usertype=2" target="main_right"><%=lang.LF("企业客户")%></a></li>
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CustomerList.aspx?usertype=1" target="main_right"><%=lang.LF("个人客户")%></a></li>
...
<div id="Div16">
    <ul>
        <li id="Li4">
            <div id="Div18">
              <div class="guidecollapse" onclick="Switch(this)"><%=lang.LF("CRM配置")%></div>
                <div class="guide" style="display:none">
                    <ul>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/AddOption.aspx" target="main_right">添加新选项</a></li>     
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Complain_Type" target="main_right"><%=lang.LF("投诉记录表")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Service_Type" target="main_right"><%=lang.LF("服务记录表")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Area" target="main_right"><%=lang.LF("客户区域")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Calling" target="main_right"><%=lang.LF("所属行业")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Value" target="main_right"><%=lang.LF("价值评估")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Credit" target="main_right"><%=lang.LF("信用等级")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Importance" target="main_right"><%=lang.LF("重要程度")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Connection" target="main_right"><%=lang.LF("关系等级")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Group" target="main_right"><%=lang.LF("客户组别")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Source" target="main_right"><%=lang.LF("客户来源")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Client_Phase" target="main_right"><%=lang.LF("阶段")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Co_Status" target="main_right"><%=lang.LF("行业地位")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Co_Size" target="main_right"><%=lang.LF("公司规模")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Co_Management" target="main_right"><%=lang.LF("经营状态")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Complain_Type" target="main_right"><%=lang.LF("服务类型")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Complain_Mode" target="main_right"><%=lang.LF("服务方式")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Complain_Urgency" target="main_right"><%=lang.LF("紧急程度")%></a></li>                    
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Linkman_Income" target="main_right"><%=lang.LF("月收入")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Linkman_Education" target="main_right"><%=lang.LF("学历")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Service_Type" target="main_right"><%=lang.LF("服务类型")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Service_Mode" target="main_right"><%=lang.LF("服务方式")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Service_TakeTime" target="main_right"><%=lang.LF("花费时间")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Service_Result" target="main_right"><%=lang.LF("服务结果")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Service_Score" target="main_right"><%=lang.LF("客户评价")%></a></li>
                        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../AddCRM/CRMDictionary.aspx?FieldName=Time" target="main_right">期限</a></li>
                    </ul>
                </div>
            </div>
        </li>
