<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_UserShopManage_Shoplabelsclass, App_Web_bpwq2he1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理 &gt;&gt;店铺管理 &gt;&gt; <a href="Shoplabelsclass.aspx">店铺标签管理</a> 
   <asp:Label ID="Label2" runat="server"></asp:Label>[<asp:Label ID="Label1" runat="server"></asp:Label>]</div>
