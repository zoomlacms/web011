<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_AddShoplabels, App_Web_bpwq2he1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">后台管理&gt;&gt; 店铺管理 &gt;&gt; <a href="Shoplabelsclass.aspx">店铺标签管理</a> &gt;&gt;<asp:Label ID="Label3" runat="server"></asp:Label><a href="addshoplabels.aspx">添加标签</a></div>
