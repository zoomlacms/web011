<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Zoomla.Website.manage.UserShopManage.Producer, App_Web_bpwq2he1" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt; <span>店铺管理 &gt;&gt; 店铺设置 &gt;&gt;<a href="Producer.aspx">添加厂商</a></div>
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
	...
	<tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td height="22" valign="middle">
			<asp:TextBox ID="CreateTime" class="l_input" runat="server" Width="217px" onclick="
WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
