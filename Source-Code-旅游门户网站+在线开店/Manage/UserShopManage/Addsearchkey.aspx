<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_Addsearchkey, App_Web_bpwq2he1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt; 店铺管理 &gt;&gt; <a href="ShopSearchKey.aspx">店铺关键字管理</a> &gt;&gt; <a href="Addsearchkey.aspx">添加关键字</a></div>
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
  <tbody id="Tabss">
	...
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
	  ...
	  <td height="24" width="80%" align="left">
		  <asp:TextBox ID="SearchTime" class="l_input" runat="server" Width="160px"　onblur="setday(this);" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
