<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ShopinfoManage, App_Web_bpwq2he1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form2" runat="server">
        ...
        <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
            <tbody id="Tabss">
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft" height="24" width="20%" align="left"><b>允许用户修改订单价格</b></td>
                    <td height="24" width="80%" align="left">
