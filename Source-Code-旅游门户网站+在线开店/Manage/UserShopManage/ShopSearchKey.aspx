<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ShopSearchKey, App_Web_bpwq2he1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ItemTemplate>
         <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          ...
          <td height="24" align="center"><a href="Addsearchkey.aspx?menu=edit&id=<%#Eval("ID") %>">修改</a> <a href="?menu=del&id=<%#Eval("ID") %>" OnClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');">删除</a></td>
                 ...
                 <tr class="tdbg">
          <td height="24" colspan="9" align="center" class="tdbgleft">共<asp:Label ID="Allnum" runat="server"></asp:Label>条&nbsp;
              <asp:Label ID="Toppage" runat="server" /> <asp:Label ID="Nextpage" runat="server" /> 
              <asp:Label ID="Downpage" runat="server" /> <asp:Label ID="Endpage" runat="server" />  页次：
              <asp:Label ID="Nowpage" runat="server" />/<asp:Label ID="PageSize" runat="server" />页  
              <asp:Label ID="pagess" runat="server" />个/页
              转到第<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True"></asp:DropDownList>页</td>
        </tr>
     </tbody>
    </table>
    <br />
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td style="height: 21px">&nbsp;
            <asp:Button ID="Button3" class="C_input"  style="width:110px;"  runat="server" Text="批量删除" CommandName="5" 
