<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.UserShopManage.DeliverType, App_Web_bpwq2he1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理 &gt;&gt; 店铺管理 &gt;&gt; 店铺设置 &gt;&gt; <a href="DeliverType.aspx" target="_self">送货方式管理</a>[<a href="AddDeliverType.aspx">添加送货方式</a>]</div>
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
  <tbody id="Tbody1">
	<tr class="tdbg">
	  <td width="37" height="24" align="center" class="title"><span class="tdbgleft">&nbsp;ID</span></td>
  <td width="110" align="center" class="title">送货方式名称</td>
  <td width="152" align="center" class="title">送货方式简介</td>
	  <td width="96" align="center" class="title"><span class="tdbgleft">运费</span></td>
  <td width="98" align="center" class="title">是否默认</td>
	<td width="73" align="center" class="title"><span class="tdbgleft">已启用</span></td>
  <td width="231" align="center" class="title">
	...
	<tr>
	  <td height="24" colspan="12">说明：“禁用”某送货方式后，前台订购时将不再显示此送货方式，但已有订单中仍然显示。</td>
	</tr>
  </tbody>
</table>
</form>
