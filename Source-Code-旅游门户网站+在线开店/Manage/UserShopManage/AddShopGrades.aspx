<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_AddShopGrades, App_Web_bpwq2he1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加商铺等级</title>
...
<div class="r_navigation">后台管理 &gt;&gt; 店铺管理 &gt;&gt;<asp:Literal ID="LNav" runat="server" Text="添加等级"></asp:Literal></div>
