<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_StoreManage, App_Web_bpwq2he1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <asp:Repeater ID="Productlist" runat="server">
                <ItemTemplate>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td height="24" align="center">
                            <a href="../User/UserInfo.aspx?id=<%# GetUserIDByInputer(GetUsername(DataBinder.Eval(Container.DataItem,"GeneralID").ToString())) %>"><%#GetUsername(DataBinder.Eval(Container.DataItem, "GeneralID").ToString())%></a>
                        </td>
                        <td height="24" align="center">
            ...
            <td class="tdbg">
                <div style="text-align: center">
                    <span style="text-align: center">
                        ...
                        </asp:DropDownList><!--OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged"-->
