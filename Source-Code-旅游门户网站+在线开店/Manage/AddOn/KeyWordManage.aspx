<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_KeyWordManage, App_Web_0sth0hzm" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
   <div class="r_navigation">
	<span>内容管理</span>&gt;&gt;<span><a href="SourceManage.aspx">内容参数</a></span>&gt;&gt;<span>关键字管理</span>
&nbsp;&nbsp;<span><a href="AddSource.aspx"  style="color:red;" target="main_right">[添加来源]</a></span>&nbsp;&nbsp;<span><a href="Author.aspx"  style="color:red;" target="main_right">[添加作者]</a></span>&nbsp;&nbsp;<span><a href="AddKeyWord.aspx" style="color:red;" target="main_right">[添加关键字]</a></span>
   </div> <!--end nativation-->
