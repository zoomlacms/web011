<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_AddWork, App_Web_0sth0hzm" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加流程</title>
...
<body>
    ...
    <div class="r_navigation">         
        <span>后台管理</span>&nbsp;&gt;&gt;&nbsp;<span>CRM应用</span>&nbsp;&gt;&gt;&nbsp;<span><a href="Projects.aspx">项目管理</a></span>&nbsp;&gt;&gt;&nbsp;<span> <a href="WorkManage.aspx">流程管理</a></span>
