<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_AddKeyWord, App_Web_hc0q2vuk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加关键字</title>
...
<div class="r_navigation"><span>内容管理</span>&gt;&gt;<span><a href="SourceManage.aspx">内容参数</a></span>&gt;&gt;<a href="KeyWordManage.aspx">关键字管理</a> &gt;&gt;添加关键字</div> 
