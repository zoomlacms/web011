<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.PayPlatManage, App_Web_0sth0hzm" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>支付平台管理</title>
...
<%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %> 后台管理&gt;&gt;系统管理&gt;&gt;支付平台管理<span>&nbsp;<a href="AddPayPlat.aspx" style="color:red">[添加支付平台]</a></span></div>
