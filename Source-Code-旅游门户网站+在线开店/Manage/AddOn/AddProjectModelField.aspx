<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_AddProjectModelField, App_Web_0sth0hzm" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加项目模型字段</title>
...
<body>
    ...
    <div class="r_navigation">
		<span>后台管理</span> &gt;&gt; <span>CRM应用</span>&gt;&gt; <a href="ProjectsModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>">项目模型字段</a>
        &gt;&gt; 添加项目字段
	</div>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="l_input" ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font
                    color="#ff0066">*</font><span class="tips"> 如：标题</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" class="C_input" runat="server" Text=" 添加字段 " OnClientClick="return isok()"
                    OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 " class="C_input" onclick="javascript:window.location.href='ProjectsModelField.aspx'" />
