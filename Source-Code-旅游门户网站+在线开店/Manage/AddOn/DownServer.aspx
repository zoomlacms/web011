<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_DownServer, App_Web_0sth0hzm" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>下载服务器</title>
...
<div class="clearbox"></div>  
 <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td class="tdbg" style="text-align: left; width: 60%;">
            <asp:TextBox ID="TxtServerLogo" runat="server" Width="290px" class="l_input"></asp:TextBox></td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td class="tdbg" style="text-align: left; width: 60%; height: 49px;">
            <asp:TextBox ID="TxtServerUrl" runat="server" Width="290px" class="l_input"></asp:TextBox>
