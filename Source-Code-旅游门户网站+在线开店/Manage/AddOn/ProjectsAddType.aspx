<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_ProjectsAddType, App_Web_0sth0hzm" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加项目类型</title>
...
<body>
    ...
    <div class="r_navigation">
            <span>后台管理</span> &gt;&gt; <span>CRM应用</span> &gt;&gt; <a href="ProjectsType.aspx">项目配置</a> &gt;&gt; <span>新建项目类别</span>
        </div>
