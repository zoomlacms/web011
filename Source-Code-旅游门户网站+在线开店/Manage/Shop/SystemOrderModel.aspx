<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_SystemOrderModel, App_Web_i0yrs3js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>订单参数</title>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <span>订单模型</span> &gt;&gt; <span id="spOrder" runat="server"></span>&nbsp;&nbsp;<span style="color:red;">[</span><span id="spAdd" runat="server"></span><span style="color:red;">]</span>
    </div>
    <div class="clearbox">
    </div>
