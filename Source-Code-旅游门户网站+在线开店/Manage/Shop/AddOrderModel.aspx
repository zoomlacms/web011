<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddOrderModel, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加订单模型</title>
...
<body>
 <form id="form1" runat="server">
    <div class="r_navigation">后台管理&gt;&gt;<a href="ProductManage.aspx">商城管理</a>&gt;&gt;订单模型管理 &gt;&gt; <span id="spLink" runat="server"></span> &gt;&gt; 添加系统订单字段 </div>
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
        <tr class="tdbg">
            ...
            <td>
                <asp:TextBox class="l_input" ID="Alias" runat="server" MaxLength="20" onkeyup="Getpy('Alias','Name')"></asp:TextBox><font color="#ff0066">*</font><span class="tips"> 如：标题</span>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="l_input" ID="Tips" MaxLength="50" runat="server"></asp:TextBox><span
                    class="tips">显示在字段别名下方作为重要提示的文字</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
            ...
            <td>
                <asp:TextBox class="x_input" ID="Description" runat="server" Columns="40" Rows="6"
        ...
        <tbody id="DivTextType">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TextType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
        </tbody>
        <!--  多行文本(不支持Html)    -->
        <tbody id="DivMultipleTextType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="x_input" ID="MultipleTextType_Width" runat="server" Columns="10"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="MultipleTextType_Height" runat="server" Columns="10"
        ...
        <tbody id="DivMultipleHtmlType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="MultipleHtmlType_Width" runat="server" Columns="10"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="MultipleHtmlType_Height" runat="server" Columns="10"
        ...
        <tbody id="DivOptionType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    ...
                    <asp:TextBox class="x_input" ID="RadioType_Content" runat="server" TextMode="MultiLine"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="RadioType_Default" runat="server"></asp:TextBox>
        ...
        <tbody id="DivListBoxType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    ...
                    <asp:TextBox class="x_input" ID="ListBoxType_Content" runat="server" TextMode="MultiLine"
                        Columns="40" Rows="6"></asp:TextBox>
                    <span style="color: red">*</span>
                </td>
            </tr>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            <td>
                                <asp:TextBox class="x_input" ID="DateSearchRang" runat="server" TextMode="MultiLine"
        ...
        <tbody id="DivPicType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TxtSPicSize" runat="server" Columns="5">1024</asp:TextBox>KB
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TxtPicExt" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivMultiPicType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    ...
                    <asp:TextBox class="l_input" ID="TxtThumb" runat="server" Columns="20"></asp:TextBox><span
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TxtPicSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">
                        *</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TextImageType" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivSmallFileType" style="display: none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TxtMaxFileSizes" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">
                        *</span>
                </td>
            </tr>
        ...
        <tbody id="DivFileType" style="display: none" runat="server">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TxtMaxFileSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">
                        *</span>
                </td>
            </tr>
        ...
        <tbody id="DivOperatingType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="x_input" ID="TxtOperatingOption" runat="server" TextMode="MultiLine"
                        Columns="40" Rows="6"></asp:TextBox>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="OperatingType_TitleSize" runat="server" Columns="10"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="OperatingType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivSuperLinkType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="SuperLinkType_TitleSize" runat="server" Columns="10"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="SuperLinkType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivNumType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="NumberType_TitleSize" runat="server" Columns="10"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="NumberType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            <td>
                                <asp:TextBox class="x_input" ID="NumSearchRange" runat="server" TextMode="MultiLine"
                                    Columns="40" Rows="6"></asp:TextBox><br />
                            </td>
                            <td>
                                <font color="red">选择了自定范围时请输入此项内容,格式：范围名|范围<br />
        ...
        <tbody id="DivColorType" style="display: none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="ColorDefault" runat="server" MaxLength="7" Columns="7"
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" class="C_input" runat="server" Text=" 添加字段 " OnClientClick="return isok()" OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 " class="C_input" onclick="javascript:window.location.href='SystemOrderModel.aspx?Type=shop'" />
