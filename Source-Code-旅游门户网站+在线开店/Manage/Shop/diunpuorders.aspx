<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_diunpuorders, App_Web_i0yrs3js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<style>   
   table{ border-bottom:Black 1px solid; border-left:Black 1px solid; border-right:Black 1px solid;  border-top:Black 1px solid; }  
</style>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <a href="UserOrderinfo.aspx">店铺订单</a>
        &gt;&gt; <span>订单详情</span>
    </div>
    <div class="clearbox">
    </div>
