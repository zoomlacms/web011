<%@ page language="C#" autoeventwireup="true" inherits="Manage_Shop_OtherOrder_DomainOrder, App_Web_q55uxuf1" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>   
    ...
    <div class="r_navigation">
        <span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <a href="DomainOrder.aspx?OrderType=5">域名订单管理</a>
        &gt;&gt; <span>订单列表</span>
            ...
            <tr>
                 <td height="24" colspan="11">
                    <asp:Button ID="Button1" Style="width: 110px" class="C_input" Text="批量删除" runat="server"
                        OnClick="Button1_Click1" OnClientClick="if(!IsSelectByName('Item')){alert('请选择内容');return false;}else{return confirm('不可恢复性删除数据,你确定将该数据删除吗？')}" />
                       <asp:Button ID="Button2" Style="width: 110px" class="C_input" Text="设为成功" runat="server"
                        OnClick="Button2_Click" OnClientClick="if(!IsSelectByName('Item')){alert('请选择内容');return false;}else{return confirm('你确定要将订单设为成功吗？')}" />
                </td>
            </tr>
        </tbody>
    </table>
