<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.SaleList, App_Web_i0yrs3js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
      ...
      <tbody id="Tabs" >
        ...
        <tr class="tdbg">
          ...
          <asp:DropDownList ID="souchtable" runat="server">
              ...
              <asp:ListItem Value="Username">用户ID</asp:ListItem>
          ...
          <asp:Button ID="souchok" runat="server" Text="" class="C_sch" />
              </td></tr></table>
 </td>
        </tr>
      </tbody>
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
      <tbody id="Tbody1">
        <tr class="tdbg">
          <td width="123" height="24" align="center" class="title"><span>下单时间</span></td>
          <td width="130" align="center" class="title"><span>订单编号</span></td>
          <td width="84" align="center" class="title"><span>客户名称</span></td>
          <td width="66" align="center" class="title"><span>用户名称</span></td>
          <td width="73" align="center" class="title"><span>商品名称</span></td>
          <td width="33" align="center" class="title"><span>单位</span></td>
          <td width="34" align="center" class="title"><span>数量</span></td>
          <td width="78" align="center" class="title"><span>市场价</span></td>
          <td width="51" align="center" class="title"><span>指定价</span></td>
          <td width="66" align="center" class="title"><span>金额</span></td>
        </tr>
          ...
          <td height="24" align="center"><%#Eval("Danwei","{0}") %></td>
