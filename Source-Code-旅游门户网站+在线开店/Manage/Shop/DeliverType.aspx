<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.DeliverType, App_Web_i0yrs3js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
    ...
    &gt;&gt; <span><a href="DeliverType.aspx" target="_self">送货方式管理</a></span> <span> [<a
        href="AddDeliverType.aspx">添加送货方式</a>]</span> [<a href="DeliverCity.aspx">确认默认地区</a>] [<a href="/manage/Config/SiteOption.aspx?tad=4">运费设置</a>]</div>
<div class="clearbox">
</div>
