<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Shop.AddModelField, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理 &gt;&gt; 商城管理 &gt;&gt; <a href="ModelManage.aspx">模型管理</a>  &gt;&gt; <a href="ModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">字段列表</a>&gt;&gt; 添加[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段</div>    
<table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
        ...
        <tbody id="DivOptionType" style="display:none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td><input id="Button3" type="button" value="从数据字典中选择选项" class="C_input"  style="width:150px;" onclick="SelectDictionary('RadioType_Content')" /><input 
                    id="Button5" type="button" class="C_input"  style="width:150px;"  value="添加数据字段" onclick='SubPage("RadioType_Content")' /><br />
        ...
        <tbody id="DivListBoxType" style="display:none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">分行键入每个选项：</td>
                <td><input id="Button4" type="button" value="从数据字典中选择选项" class="C_input"  style="width:150px;"  onclick="SelectDictionary('ListBoxType_Content')" /><input 
                    id="Button6" class="C_input"  style="width:150px;"  type="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
