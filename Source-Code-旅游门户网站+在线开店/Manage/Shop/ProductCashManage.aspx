<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ProductCashManage, App_Web_i0yrs3js" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        状态选择：<a href="ProductCashManage.aspx">全部</a>　<a href="?CardState=2">已处理</a>　<a href="?CardState=1">未处理</a>
    </div>
    <div class="clearbox">
    </div>
    <div>
