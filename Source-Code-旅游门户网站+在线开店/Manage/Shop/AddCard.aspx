<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddCard, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <div>
        <table width="100%" cellpadding="2" cellspacing="1" border="0" >
            ...
            <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="endtime" class="l_input" runat="server" Width="133px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
