<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.shop.Model, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <a href="ModelManage.aspx">商品模型管理</a> &gt;&gt; <span><asp:Literal ID="LNav" runat="server" Text="添加商品模型"></asp:Literal></span>
	</div>
    ...
    <table class="border" width="100%" cellpadding="2" cellspacing="1">
        ...
        <tr class="tdbgbottom">
            ...
            <asp:HiddenField ID="HdnModelId" runat="server" />
                ...
                &nbsp;&nbsp;
                <input name="Cancel" type="button" id="Cancel"  class="C_input" value="取消" onclick="window.location.href='ModelManage.aspx';" />                
            </td>
        </tr>
    </table>
