<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_StoreOrderinfo, App_Web_i0yrs3js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>订单详情</title>
     ...
     <td></td>
        <td height="27" align="left">合计：&nbsp;
            ...
            <asp:Button ID="Button8" runat="server" Text="修改" CssClass="C_input" onclick="Button8_Click" /> &nbsp;
             <asp:Button ID="Button1" runat="server" Text="转让" CssClass="C_input" OnClientClick="SelectShopUserID();return false;"/>
        </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
     <td></td>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;" id="TABLE1">
    ...
    <tr class="tdbg">
            <td width="25%" rowspan="3">
                ...
                <asp:Button ID="Button3" class="C_input"  style="width:100px;" runat="server" Text="发花" Width="100px" OnClientClick="SelectDelivery(); return false;"  />
            </td>
            <td width="25%" rowspan="3">
