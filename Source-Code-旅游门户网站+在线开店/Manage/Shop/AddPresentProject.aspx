<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddPresentProject, App_Web_i0yrs3js" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
...
<body>
  ...
  <td height="22" valign="middle"><asp:TextBox ID="Promostart" class="l_input" runat="server" Width="150px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" />&nbsp;
    &nbsp;止        <asp:TextBox ID="Promoend" class="l_input" runat="server" Width="150px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" />
      不填写为不限制有效期</td>
      </tr>
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
