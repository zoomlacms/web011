<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_BidComplete_Modify, App_Web_u3mtf5l3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
 ...
 <table id="Guess2" width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="height: 19px">
            从<asp:TextBox ID="txtStime" onclick="WdatePicker()" runat="server" class="l_input"></asp:TextBox>
            &nbsp;到<asp:TextBox ID="txtEtime" onclick="WdatePicker()" runat="server" class="l_input"></asp:TextBox>&nbsp;为止
        </td>
    </tr>
