<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_BidComplete_Manage, App_Web_u3mtf5l3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>竞拍商品管理</title>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
    <tr class="tdbg">
        ...
        <td width="66%" class="tdbgleft">
          <table style="float:left;margin-left:15%"><tr><td>
            商品名称：</td></tr></table>
