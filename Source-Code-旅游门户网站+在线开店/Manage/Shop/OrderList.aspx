<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.OrderList, App_Web_3rrk3jrp" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %>后台管理 &gt;&gt; 商城管理 &gt;&gt; <a href="OrderList.aspx">订单管理</a> &gt;&gt; <a href="OrderList.aspx">订单列表</a>&gt;&gt;
    <span style="color:Red"> <asp:Label ID="LblLocation" runat="server" Text=""></asp:Label></span></div>
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
        <tbody id="Tabs" runat="server">
            <tr class="tdbg">
                ...
                <td width="66%" align="center" class="title">
                    ...
                    <table  cellpadding="2" border="0" cellspacing="1" style="background:#fff;float:left;margin-left:10px;" class="l_input" >
                        <tr >
                            <td>
                                <asp:TextBox ID="souchkey" runat="server" BorderColor="#fff" CssClass="l_inpnon"/>
                                <asp:Button ID="souchok" runat="server" class="C_sch" OnClick="souchok_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <tbody id="Tbody1">
            ...
            <tr>
                <td height="24" colspan="13">
                    <asp:Button ID="Button2" Style="width: 110px" class="C_input" Text="确认订单" runat="server" OnClick="Button2_Click1"  OnClientClick="return confirm('是否确认？');" />
                    <asp:Button ID="Button3" Style="width: 110px" class="C_input" Text="汇款到帐" runat="server" OnClick="Button3_Click1"  OnClientClick="return confirm('是否确认？');" />
                    <asp:Button ID="Button1" Style="width: 110px" class="C_input" Text="删除订单" runat="server" OnClick="Button1_Click1" OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" />*说明：“已结清”与“已付款”的订单不允许删除,当订单号码成“灰色”代表此订单已“作废”
                </td>
            </tr>
        </tbody>
    </table>
