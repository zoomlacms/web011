<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.Stock, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
        <span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <span><a href="StockManage.aspx">库存管理</a></span> &gt;&gt; <span><a href="Stock.aspx">添加入库出库记录</a></span>
    </div>
    </div>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
        ...
        <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td valign="middle" style="height: 22px">
                <asp:TextBox ID="calendars" runat="server" class="l_input" Width="178px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
            </td>
        </tr>
        <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td width="34%" class="tdbgleft" style="height: 22px">
