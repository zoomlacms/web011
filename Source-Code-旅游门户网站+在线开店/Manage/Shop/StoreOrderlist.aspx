<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_StoreOrderlist, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>快速订单管理</title>
...
<body>
 ...
 <div class="r_navigation">
    ...
    <span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; 订单管理&gt;&gt; <span><a href="UserOrderlist.aspx">店铺订单列表</a></span>
</div>
