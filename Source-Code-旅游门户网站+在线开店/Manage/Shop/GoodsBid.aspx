<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_GoodsBid, App_Web_i0yrs3js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="clearbox"></div>    
      ...
      <tbody id="Tbody1">
        <tr class="tdbg">
          <td width="10%"  align="center" class="title"><span>ID</span></td>
        ...
        <td width="10%" align="center" class="title">
          ...
          <td width="10%" align="center" class="title">
              ...
              <td width="20%" align="center" class="title"> 
              竞拍时间</td>
          <td width="10%" align="center" class="title"><span>操作</span></td>
        </tr>
