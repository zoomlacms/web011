<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ShopRecycler, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>商品回收站</title>
        ...
        <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
          <tbody id="Tabss">
            <tr class="tdbg">
              ...
              <td width="3%" align="center" class="title"><span>ID</span></td>
              <td width="12%" align="center" class="title"><span>商品图片</span></td>
              <td width="22%" align="center" class="title"><span>商品名称</span></td>
              <td width="7%" align="center" class="title"><span>单位</span></td>
              <td width="7%" align="center" class="title"><span>库存</span></td>
              <td width="6%" align="center" class="title"><span>价格</span></td>
              <td width="6%" align="center" class="title"><span>类型</span></td>
              <td width="5%" align="center" class="title"><span>推荐</span></td>
              <td width="8%" align="center" class="title"><span>商品属性</span></td>
              <td width="6%" align="center" class="title"><span>销售中</span></td>
              <td width="7%" align="center" class="title"><span>操作</span></td>
            </tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td style="height: 21px">&nbsp;
              ...
              <asp:Button ID="Button4" class="C_input" Style="width: 110px;" runat="server" Text="清空回收站" onclick="Button4_Click" OnClientClick="return confirm('你确定要清空回收站吗')"/>
          </tr>
        </table>
    </form>
</body>
