<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_i0yrs3js" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
            ...
            <table width="100%" cellpadding="2" cellspacing="1" style="background-color: white;">
                <tbody id="Tabs0">
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td style="height: 26px">
                            <asp:TextBox ID="ServerPeriod" Text="0" runat="server" Width="53px" class="l_input" disabled="disabled"/>
                            <select onchange="changeType(this)" name="ServerType" id="ServerType" runat="server">
                                <option value="3">年</option>
                                <option value="2">月</option>
                                <option value="1">日</option>
                                <option value="0" selected="selected">无限期</option>
                            </select>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator11" runat="server" ControlToValidate="ServerPeriod" ErrorMessage="服务期限必须是数字!" ValidationExpression="^\d+$" SetFocusOnError="True"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        <td class="tdbgleft">
                        ...
                        <td>
                            <asp:RadioButtonList ID="ProClass" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="ProClass_SelectedIndexChanged" AutoPostBack="True">
                                ...
                                <asp:ListItem Value="5">动态库存商品</asp:ListItem>
                                <asp:ListItem Value="6">IDC商品</asp:ListItem>
                            </asp:RadioButtonList>
                            <div id="TG">
                                    ...
                                    <asp:View ID="View1" runat="server">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="ColonelStartTimetxt" runat="server"  onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="l_input"></asp:TextBox>
                                                </td>
                                                <td>
                                                    结束时间:
                                                </td>
                                ...
                                <table id="cloudTable" runat="server" visible="false">
                                    <tr><td>库存数量：</td><td>
                                        <asp:TextBox runat="server" onkeyup="$('#Stock').val($(this).val());" Text="10"/></td></tr>
                                </table>
                            </div>
                        </td>
                    </tr>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        <td class="tdbgleft"><strong>销售状态：</strong></td>
                        <td><asp:CheckBox ID="Sales" Text="打勾表示销售中，否则为停售状态" runat="server" /></td>
                    </tr>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        <td class="tdbgleft"><strong>属性设置：</strong></td>
                        <td>
...
-->
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td style="height: 24px">
                            <asp:TextBox ID="Stock" runat="server" Width="100px" class="l_input" ClientIDMode="Static">10</asp:TextBox>
                        ...
                        <td colspan="2">
                            <table cellpadding="0" id="Guess1" style="display: none" cellspacing="0" border="0"
                                ...
                                <tr class="tdbg">
                                    ...
                                    <td>
                                        从<asp:TextBox ID="TextBox3" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" runat="server" class="l_input"></asp:TextBox>
                                        &nbsp;到<asp:TextBox ID="TextBox4" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" runat="server" class="l_input"></asp:TextBox>&nbsp;为止
                                    </td>
                                </tr>
                                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                    <td class="tdbgleft">
                            ...
                            <table id="Guess2" style="display: none" width="100%" border="0" cellpadding="0"
                                ...
                                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                    ...
                                    <td style="height: 19px">
                                        ...
                                        从<asp:TextBox ID="txtStime" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' })" runat="server" class="l_input"></asp:TextBox>
                                        &nbsp;到<asp:TextBox ID="txtEtime" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' })" runat="server" class="l_input"></asp:TextBox>&nbsp;为止
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="TABLE1">
    <tr>
        <td align="left" style="height: 59px">
            &nbsp; &nbsp;
            <asp:Button ID="EBtnSubmit" class="C_input" Text="保存商品信息" runat="server"  OnClick="EBtnSubmit_Click1" /><!--OnClientClick="numChange('0');"-->
...
<script type="text/javascript">
    ...
    {
        if($(obj).val()!="0")
            $("#ServerPeriod").attr("disabled","");
        else
            $("#ServerPeriod").attr("disabled","disabled");
    }
</script>