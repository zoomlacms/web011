<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ModifySysOrderField, App_Web_i0yrs3js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<form id="form1" runat="server">
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span> 用户管理</span> &gt;&gt;<span> 会员模型</span>
    &gt;&gt; <a href="SystemUserModel.aspx">系统会员模型字段列表</a>
    &gt;&gt; 修改系统会员模型字段
	</div>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
     <tr class="tdbg">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="l_input" ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font
                    color="#ff0066">*</font><span class="tips"> 如：文章标题</span>
                    <asp:HiddenField ID="hfType" runat="server" /></td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
                字段名称：
            ...
            <td>
                <asp:TextBox class="l_input" ID="Name" MaxLength="50" runat="server"></asp:TextBox><font
                    color="#ff0066">*</font><span class="tips">字段名由字母、数字、下划线组成，不接受空格</span>
            </td>
        </tr>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="l_input" ID="Tips" MaxLength="50" runat="server"></asp:TextBox><span class="tips">显示在字段别名下方作为重要提示的文字</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
            ...
            <td>
                <asp:TextBox class="x_input" ID="Description" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox></td>
        </tr>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="l_input" ID="TextBox1" runat="server" Columns="10" MaxLength="4">10</asp:TextBox>%
            </td>
        </tr>
        ...
        <tbody id="DivOptionType" style="display:none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td><input id="Button3" type="button" value="从数据字典中选择选项" class="C_input" onclick="SelectDictionary('RadioType_Content')" /><input 
                        id="Button5" type="button" value="添加数据字段" onclick='SubPage("RadioType_Content")' class="C_input"/><br />
                    <asp:TextBox class="x_input" ID="RadioType_Content" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox> <span style="color: red">*</span></td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">默认值：</td>
        ...
        <tbody id="DivListBoxType" style="display:none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td><input id="Button4" type="button" value="从数据字典中选择选项" class="C_input" onclick="SelectDictionary('ListBoxType_Content')"/><input 
                        id="Button6" type="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' class="C_input"/><br />
                    <asp:TextBox class="x_input" ID="ListBoxType_Content" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox> <span style="color: red">*</span></td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">显示选项：</td>
        ...
        <tbody id="DivPicType" style="display:none" runat="server">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    允许上传的图片大小：</td>
                <td>
                    <asp:TextBox class="l_input" ID="TxtSPicSize" runat="server" Columns=5>1024</asp:TextBox>KB <span style="color: blue">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    允许上传的图片类型：</td>
                <td>
                    <asp:TextBox class="l_input" ID="TxtPicExt" runat="server" Columns="30"></asp:TextBox><span style="color: red">*</span>
        ...
        <tbody id="DivMultiPicType" style="display:none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    ...
                    <asp:TextBox class="l_input" ID="TxtThumb" runat="server" Columns="20"></asp:TextBox><span style="color:Red;display:none;">保存缩略图地址字段名不能与主字段名重复！</span></td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">图片是否加水印：</td>
                <td>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    允许上传的图片大小：</td>
                <td>
                    <asp:TextBox class="l_input" ID="TxtPicSize" runat="server" Columns=5>1024</asp:TextBox>KB <span style="color: blue">
                        提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    允许上传的图片类型：</td>
                <td>
                    <asp:TextBox class="l_input" ID="TextImageType" runat="server" Columns="30"></asp:TextBox> <span style="color: red">*</span>
                <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span></td>
            </tr>
        </tbody>            
       <!--  文件类型    -->
        <tbody id="DivSmallFileType" style="display: none"  runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TxtMaxFileSizes" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
        ...
        <tbody id="DivOperatingType" style="display:none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">分行键入&nbsp;&nbsp;<br />
                    每个平台选项：</td>
                <td>
                    <asp:TextBox class="x_input" ID="TxtOperatingOption" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox> <span style="color: red">*</span> <span style="color: blue">注：一行一个默认项</span></td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">文本框长度：</td>
        ...
        <tbody id="DivNumType" style="display:none" runat="server">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" id="showdec" style="display: none">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="txtdecimal" runat="server" Text="0"></asp:TextBox>
                </td>
            </tr>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                            ...
                            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                <td>
                                    <asp:TextBox class="x_input" ID="NumSearchRange" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox><br />                                    
                                </td>
                                <td>
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                ...
                &nbsp;&nbsp;
                <input id="Button2" type="button" runat="server" value=" 返回字段列表 "  onclick="javascript:window.location.href='SystemOrderModel.aspx?Type=shop'" class="C_input"/>
