<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_UserOrderlist, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>店铺用户订单</title>
...
<div id="nav_box">
<div class="r_navigation">后台管理<&gt;&gt;商城管理&gt;&gt; 订单管理&gt;&gt; <a href="UserOrderlist.aspx">店铺订单列表</a><span style="color:Red"><asp:Label ID="LblLocation" runat="server" Text=""></asp:Label></span></div>
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
      <tbody id="Tbody1">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          ...
          <td height="24" colspan="6" align="center">&nbsp;</td>
        </tr>
        <tr class="tdbg">
          <td height="24" colspan="14" align="center" class="tdbgleft">共
