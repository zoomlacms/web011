<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.StockManage, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
        ...
        <asp:Repeater ID="StockRepeater" runat="server">
            <ItemTemplate>
                <tr class="tdbg" id="<%#Eval("id")%>" onmouseover="this.className='tdbgmouseover' onmouseout="this.className='tdbg'" ondblclick="getinfo(this.id )" style="cursor:pointer;" title="双击修改">
                    ...
                    <td height="22" align="center">
                        <a href="Stock.aspx?menu=edit&id=<%#Eval("id") %>">修改</a> <a href="StockManage.aspx?menu=del&id=<%#Eval("id") %>" onclick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');">删除</a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 21px">
                <asp:Button ID="Button3" Style="width: 100px" class="C_input" runat="server" OnClick="Button3_Click" OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" Text="批量删除" />&nbsp;
            </td>
        </tr>
    </table>
    </form>
