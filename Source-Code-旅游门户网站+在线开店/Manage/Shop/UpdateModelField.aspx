<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Shop.UpdateModelField, App_Web_i0yrs3js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
        ...
        <tbody id="DivOptionType" style="display: none" runat="server">
            <tr class="tdbg">
                ...
                <td>
                    <input id="Button3" class="C_input"  style="width:150px;" type="button" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('RadioType_Content')" /><input
        ...
        <tbody id="DivListBoxType" style="display: none" runat="server">
            <tr class="tdbg">
                ...
                <td>
                    <input id="Button4" type="button" class="C_input"  style="width:150px;" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('ListBoxType_Content')" /><input
                        id="Button2" type="button"  class="C_input"  style="width:150px;" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" class="C_input"  style="width:150px;"  runat="server" Text=" 修改字段 "  OnClientClick="return isok()"
                    OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <asp:Button ID="BtnBack" class="C_input"  style="width:150px;"  runat="server" Text="返回字段列表" OnClick="BtnBack_Click" UseSubmitBehavior="False"
