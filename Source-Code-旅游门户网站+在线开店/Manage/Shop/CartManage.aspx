<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.CartManage, App_Web_3rrk3jrp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
    ...
    <tr class="tdbg">
        <td width="21%"  align="center" class="title">
            <span>购物车ID</span></td>
        <td width="142" align="center" class="title"><span>商品名称</span></td>
        <td width="142" align="center" class="title"><span>用户名</span></td>
        <td width="160" align="center" class="title"><span>时间</span></td>
        <td width="73" align="center" class="title"><span>数量</span><span class="tdbgleft"></span></td>
        <td width="167" align="center" class="title"><span>预计金额</span></td>
