<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Zoomla.Website.manage.Shop.Producer, App_Web_i0yrs3js" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      ...
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td width="66%" valign="middle">
            <asp:TextBox ID="Producername" runat="server" class="l_input" Width="251px" /><span style="color:red;margin-left:5px;">*</span>
      ...
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td height="22" valign="middle">
            <asp:TextBox ID="CreateTime" runat="server" class="l_input" Width="230px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
            </td>
      </tr>
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td height="22" class="tdbgleft" style="width: 20%"><strong>公司地址：</strong></td>
        <td height="22" valign="middle">
            <asp:TextBox ID="Coadd" runat="server" class="l_input" Width="251px"></asp:TextBox><span style="color:red;margin-left:5px;">*</span></td>
      </tr>
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td height="22" class="tdbgleft" style="width: 20%"><strong>联系电话：</strong></td>
        <td height="22" valign="middle">
            <asp:TextBox ID="Telpho" runat="server" class="l_input" Width="251px"></asp:TextBox><span style="color:red;margin-left:5px;">*</span> </td>
      </tr>
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    //]]>
      ...
      <tr class="tdbg">
        <td colspan="2" align="center" class="tdbg" style="height: 49px">
            <asp:Button ID="Button1" runat="server" class="C_input"  Text="保存设置" style="width:110px;"  OnClick="Button1_Click" OnClientClick="return checkValue()"/></td>
      </tr>
    </table>
