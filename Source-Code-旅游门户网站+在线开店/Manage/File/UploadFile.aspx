<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.UploadFile, App_Web_xfb0gzz1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>上传文件管理</title>
...
后台管理 &gt;&gt; 附件管理&gt;&gt;文件管理&gt;&gt;<a href="UploadFile.aspx">上传文件管理</a>
	</div>
    ...
    <asp:Repeater ID="RptFiles" runat="server" OnItemCommand="RptFiles_ItemCommand">
        ...
        <asp:Button ID="Backup" runat="server" Text="备份当前目录文件" class="C_input" OnClick="Backup_Click1" OnClientClick="if(!this.disabled) return confirm('是否创建备份？(提示：备份同名文件会覆盖！)');"/>
        <!-- 提示是否 -->
