<%@ page language="C#" autoeventwireup="true" inherits="manage_Zone_BannerAdd, App_Web_muuicuqm" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
   <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>栏目管理</span> &gt;&gt; 栏目管理  &gt;&gt;<span><asp:Literal ID="LNav" runat="server" Text="添加栏目"></asp:Literal></span>
	</div>
