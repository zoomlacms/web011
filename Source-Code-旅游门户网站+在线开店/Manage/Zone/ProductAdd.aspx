<%@ page language="C#" autoeventwireup="true" inherits="FreeHome.Manage.ProductAdd, App_Web_pscmdjiw" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="r_navigation">		
		<span>后台管理</span> &gt;&gt; <span>会员空间管理</span>  &gt;&gt;    <span>虚拟商品管理</span>  &gt;&gt; <a href="ProductManage.aspx">[虚拟商品列表]</a>  |  <a href="ProductAdd.aspx">[添加空间虚拟商品]</a> 
	</div>
