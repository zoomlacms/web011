<%@ page language="C#" autoeventwireup="true" inherits="manage_ZoneManage_ProductManage, App_Web_pscmdjiw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <%} %>
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
      <tbody id="Tabss">
        ...
        <ItemTemplate>
         <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" ondblclick="View(<%# Eval("UserID")%>)">
