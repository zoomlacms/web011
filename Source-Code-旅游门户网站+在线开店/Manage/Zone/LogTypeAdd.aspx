<%@ page language="C#" autoeventwireup="true" inherits="manage_Zone_LogTypeAdd, App_Web_pscmdjiw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<html>
...
<table width="100%" height="100" border="0" cellpadding="2" cellspacing="1" class="border">
  <tr class="tdbg">
    <td colspan="2" align="center" class="spacingtitle">族群类型添加</td>
  </tr>
  <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    <td width="24%" align="center" class="tdbgleft">类型名称：</td>
    <td width="76%">&nbsp;<asp:TextBox ID="Nametxt" class="l_input" runat="server" MaxLength="15"></asp:TextBox>
  ...
  <tr class="tdbg">
    ...
    <td>&nbsp;<asp:Button ID="addbtn" class="C_input"  runat="server" Text="保  存" Width="84px" OnClick="addbtn_Click" /></td>
  </tr>
</table>
    </div>
</form>
