<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_AddUcenter, App_Web_afdgdjnx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<form id="form1" runat="server">
  <div class="r_navigation"> 后台管理 &gt;&gt; <a href="AdminManage.aspx">用户管理</a> &gt;&gt;<a href="Ucenter.aspx">认证中心</a> &gt;&gt; 添加授权网站 </div>
    ...
    <tbody id="Tabs0">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="TxtWebSite" class="l_input" runat="server" />
