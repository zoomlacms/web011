<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_Suppliers, App_Web_afdgdjnx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html >
<head runat="server">
<title>APP配置</title>
...
<script type="text/javascript">
    ...
    <style type="text/css">
        span {color:Green;font-size:13px;}
    </style>
...
<form id="form1" runat="server">
  <div class="r_navigation">
    ...
    <%} %>
    后台管理&gt;&gt;<a href="../User/UserManage.aspx">会员管理</a> &gt;&gt;APP社会化登录</div>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" class="border">
  <tr>
    <td class="spacingtitle" align="center"><asp:Literal ID="LTitle" runat="server" Text="App社会化登录"></asp:Literal></td>
  </tr>
  <tr class="tdbg">
    <td valign="top" style="margin-top: 0px; margin-left: 0px;"><table width="100%" cellpadding="2" cellspacing="1" style="background-color: white;">
        <tbody id="Tabs0">
          <tr class="tdbg">
            <td colspan="3" style="height: 26px;"> 默认回调地址：
              <asp:Label  ID="callback" ForeColor="Green" Text="text" runat="server" /></td>
          </tr>
          <tr class="tdbg">
            <td style="width:17%"><input type="checkbox" id="CkSina"  value="" runat="server" />
              <label for="CkBaidu"><img style="cursor:pointer;" src="../../App_Themes/AdminDefaultTheme/images/Sina_2.png" /></label></td>
            <td><asp:Button ID="Button5" class="C_input" runat="server" Text="配置" onclick="Button5_Click" />
          ...
          <tr class="tdbg">
            <td style="width:17%"><input type="checkbox" id="CkQQ"  value="" runat="server" />
              <label for="CkBaidu"><img style="cursor:pointer;" src="../../App_Themes/AdminDefaultTheme/images/QQ_2.png" /></label></td>
            <td><asp:Button ID="Button6" class="C_input" runat="server" Text="配置" onclick="Button6_Click" />
          ...
          <tr class="tdbg">
            <td style="width:17%"><input type="checkbox" id="CkBaidu"  value="" runat="server" />
              <label for="CkBaidu"><img style="cursor:pointer;" src="../../App_Themes/AdminDefaultTheme/images/Baidu_2.png" /></label></td>
            <td><asp:Button ID="Button1" class="C_input" runat="server" Text="配置" onclick="Button1_Click" />
          ...
          <tr class="tdbg">
            <td><input type="checkbox" id="CkKaixin"  value="" runat="server" />
              <label for="CkKaixin"><img style="cursor:pointer;" src="../../App_Themes/AdminDefaultTheme/images/Kaixin_2.png" /></label></td>
            <td><asp:Button ID="Button2" class="C_input" runat="server" Text="配置" 
          ...
          <tr class="tdbg">
            <td><input type="checkbox" id="CkRenren"  value="" runat="server" />
              <label for="CkRenren"><img style="cursor:pointer;" src="../../App_Themes/AdminDefaultTheme/images/Renren_2.png" /></label></td>
            <td><asp:Button ID="Button3" class="C_input" runat="server" Text="配置" 
          ...
          <tr class="tdbg">
            <td><input type="checkbox" id="CkNetease"  value="" runat="server" />
              <label for="CkNetease"><img style="cursor:pointer;" src="../../App_Themes/AdminDefaultTheme/images/Netease_2.png" /></label></td>
            <td><asp:Button ID="Button4" class="C_input" runat="server" Text="配置" 
           ...
           <tr class="tdbg" style="display:none;">
            <td><input type="checkbox" id="CkSohuChat" runat="server" checked="checked"/>
              <label for="CkChat"><img style="cursor:pointer;" src="/App_Themes/AdminDefaultTheme/images/Netease_2.png" /></label></td>
            <td><asp:Button ID="sohuChatBtn" class="C_input" runat="server" Text="配置" onclick="sohuChatBtn_Click" />
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" id="TABLE1">
        <tr>
          <td align="left" style="height: 39px"><asp:Button ID="KeyTj" runat="server" class="C_input"  Text="提交" onclick="KeyTj_Click" /></td>
        </tr>
      </table>
      <br />
</form>
