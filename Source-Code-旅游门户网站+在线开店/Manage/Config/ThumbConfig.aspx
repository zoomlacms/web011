<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Config.ThumbConfig, App_Web_dpasokpb" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div style="height:28px;"></div>
  <table width="99%" cellspacing="1" cellpadding="0" class="border">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td >
          <asp:TextBox ID="iheight" runat="server" class="l_input"/></asp:TextBox>
          像素&nbsp;&nbsp;设为0时，将以宽度为准按比例缩小。都为0时，则为原图大小。
      </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
...
var color = window.open(url + '&' + clientId, "hbcmsPop", "top=200,left=200,scrollbars=yes,dialog=yes,modal=no,width=300,height=260,resizable=yes");
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td style=" height: 23px;">
          <asp:DropDownList ID="localP" runat="server" AutoPostBack="True" onselectedindexchanged="localP_SelectedIndexChanged"  class="l_input" Height="20px">
