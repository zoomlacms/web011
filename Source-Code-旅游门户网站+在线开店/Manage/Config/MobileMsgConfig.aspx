<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Config.MobileMsgConfig, App_Web_dpasokpb" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div style="height:28px;"></div>
  <table width="100%" cellspacing="1" cellpadding="0" class="border">
    <tr class="tdbg">
      <td class="tdbgleft" style="width: 200px; "><strong>选择默认短信接口：</strong></td>
    ...
    <table width="100%" cellspacing="1" cellpadding="0" class="border">
      ...
      <tr class="tdbg">
        ...
        <td><asp:TextBox ID="blackList" runat="server" class="l_input"></asp:TextBox>
         ...
         <tr class="tdbg">
        <td class="tdbgleft" style="width: 200px; "><strong>会员变更手机号权限：</strong></td>
      ...
      <tr class="tdbg">
        <td class="tdbgleft" style="width: 200px; ">
            <asp:Button ID="Button2" class="C_input" runat="server" Text="保存设置" OnClick="Button2_Click" />
        </td>
  ...
  <div runat="server" id="panel3" visible="false">
        <table style="width:100%;" cellspacing="1" cellpadding="0" class="border">
            <tr class="tdbg">
                <td class="tdbgleft" style="width: 200px;"><strong>序列号：</strong></td>
                <td><asp:TextBox ID="smskeyT" runat="server" class="l_input" /><span>* 必填</span></td></tr>
            <tr class="tdbg"><td class="tdbgleft" style="width: 200px;"><strong>密码：</strong></td>
                <td><asp:TextBox ID="smspwdT" runat="server" class="l_input" TextMode="Password" /><span>* 必填</span></td></tr>
            <tr class="tdbg">
        <td class="tdbgleft" style="width: 200px; "><strong>会员变更手机号权限：</strong></td>
        <td><asp:RadioButtonList runat="server" ID="smsRadio3" RepeatDirection="Horizontal">
            ...
            <asp:ListItem Value="1" Selected="True">自由修改</asp:ListItem></asp:RadioButtonList></td></tr>
             <tr class="tdbg"><td class="tdbgleft" style="width: 200px;"><strong>操作：</strong></td>
                <td><asp:Button runat="server" ID="saveBtn3" OnClick="saveBtn3_Click" Text="保存" class="C_input"/></td></tr>
        </table>
    </div>
</form>
</body>
