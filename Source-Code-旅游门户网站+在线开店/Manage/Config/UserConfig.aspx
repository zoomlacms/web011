<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Config.UserConfig, App_Web_dpasokpb" validaterequest="false" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <tbody id="Tabs0">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="width: 500px"><asp:CheckBoxList ID="RegRule" runat="server" RepeatDirection="Horizontal">
         ...
         <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft" style="width: 300px"><strong>是否开启用户ID登录：</strong></td>
        <td style="width: 500px"><asp:RadioButtonList ID="radioUserID" runat="server" RepeatDirection="Horizontal">
            <asp:ListItem>是</asp:ListItem>
            <asp:ListItem>否</asp:ListItem>
          </asp:RadioButtonList></td>
      </tr>
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft" style="width: 300px"><strong>开启注册手机验证码校验：</strong></td>
        <td style="width: 500px"><asp:RadioButtonList ID="radioMobile" runat="server" RepeatDirection="Horizontal">
            <asp:ListItem>是</asp:ListItem>
            <asp:ListItem>否</asp:ListItem>
          </asp:RadioButtonList></td>
      </tr>
...
<%--      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="width: 500px"><asp:TextBox ID="txtGetPassword" runat="server" Rows="6" TextMode="MultiLine" Width="300px"
           ...
           <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft" style="width: 300px"><strong>新会员注册时发送的手机验证短信内容：<br />
          </strong>短信内容中可用标签说明如下（内容不超过70个字）：<br />
          <span>{$CheckNum}</span>：会员名称<br />
          <span>{$SiteName}</span>：网站名称<br />
          <span>{$SiteUrl}</span>：网站地址</td>
        <td style="width: 500px"><asp:TextBox ID="txtMobileRegInfo" runat="server" Rows="6" TextMode="MultiLine" Width="300px"
					class="x_input"></asp:TextBox></td>
      </tr>
    </tbody>
