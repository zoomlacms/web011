<%@ page language="C#" autoeventwireup="true" inherits="_Default, App_Web_dpasokpb" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>短信发送</title>
...
<body>
  ...
  <tr class="tdbg">
        <td>发送短信
            ...
            <input id="x_uid" type="hidden" value="" runat="server"/><!--会员登陆账户-->
            <input id="x_pwd_md5" type="hidden"  value="" runat="server"/><!--登陆密码-->
