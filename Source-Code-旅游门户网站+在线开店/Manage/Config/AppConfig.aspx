<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_AppConfig, App_Web_dpasokpb" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div style="height:28px;"></div>
  ...
  <table width="99%" cellspacing="1" cellpadding="0" class="border">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td colspan="1">
          <asp:TextBox ID="TextBox1" runat="server" Width="483px" Height="64px" TextMode="MultiLine" class="x_input"></asp:TextBox>
      </td>
    </tr>
  </table>
  <br />
