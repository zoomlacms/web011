<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_Database_profile, App_Web_dpasokpb" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html>
<head runat="server">
<title>运行库概况</title>
...
<%} %> 
后台管理&gt;&gt;扩展功能&gt;&gt;<a href="DatabaseProfile.aspx">开发中心 </a>&gt;&gt;<a href="DatalistProfile.aspx">系统全库概况</a>&gt;&gt; <a href="DatabaseProfile.aspx">运行库概况</a> 
  </div>
...
<table width="100%" style="margin:auto;" border="0" cellpadding="0" cellspacing="1" class="border" id="crt1" name="crt1">
<tr>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" id="crt2" name="crt2" style="display: none; margin:auto;">
<tr>
