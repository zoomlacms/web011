<%@ page language="C#" autoeventwireup="true" inherits="Manage_Shop_OtherOrder_DomainOrder, App_Web_pwn5zfq0" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <table class="table table-striped table-bordered table-hover">
    <tbody id="Tbody1">
      <tr class="tdbg">
        ...
        <td width="57" align="center" class="title"><span>已开发票</span></td>
      ...
      <tr>
        <td height="24" colspan="11"><asp:Button ID="Button1" Style="width: 110px" class="btn btn-primary" Text="批量删除" runat="server" OnClick="Button1_Click1" OnClientClick="if(!IsSelectByName('Item')){alert('请选择内容');return false;}else{return confirm('不可恢复性删除数据,你确定将该数据删除吗？')}" />
