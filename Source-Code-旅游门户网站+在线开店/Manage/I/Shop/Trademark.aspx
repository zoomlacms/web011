<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Zoomla.Website.manage.Shop.Trademark, App_Web_enu4lwhk" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td width="66%" valign="middle">
                <asp:TextBox ID="Trname" runat="server" class="form-control"></asp:TextBox>
        ...
        <tr>
            ...
            <td valign="middle" style="height: 22px">
                <asp:DropDownList ID="Producer" runat="server" CssClass="form-control">
                </asp:DropDownList></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td valign="middle">
                <asp:TextBox ID="TrPhoto" runat="server" CssClass="form-control"></asp:TextBox><iframe id="proimgs" style="top: 2px" src="../../Shop/fileupload.aspx?menu=TrPhoto" width="100%" height="25px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
            </td>
        </tr>
        <tr class="WebPart">
