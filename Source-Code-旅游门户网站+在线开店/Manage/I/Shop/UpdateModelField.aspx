<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Shop.UpdateModelField, App_Web_enu4lwhk" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        <tr >
            ...
            <td>
                <asp:TextBox ID="Alias" class="l_input" runat="server" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span
        ...
        <tr >
            ...
            <td>
                <asp:TextBox ID="Name" class="l_input" MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font><span
        ...
        <tr >
            ...
            <td>
                <asp:TextBox ID="Description" class="l_input" runat="server" Columns="40" 
                    Rows="6" TextMode="MultiLine" Height="80px" Width="337px"></asp:TextBox>
            </td>
        </tr>
        <tr class="tdbg">
            <td class="tdbgleft">
        ...
        <tbody id="DivOptionType" style="display: none" runat="server">
            <tr class="tdbg">
                ...
                <td>
                    <input id="Button3" class="btn btn-primary"  style="width:150px;" type="button" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('RadioType_Content')" /><input
                    ...
                    <asp:TextBox ID="RadioType_Content" class="l_input" runat="server" 
                        ...
                        Rows="6" Height="82px" Width="306px"></asp:TextBox>
        ...
        <tbody id="DivListBoxType" style="display: none" runat="server">
            <tr class="tdbg">
                ...
                <td>
                    <input id="Button4" type="button" class="btn btn-primary"  style="width:150px;" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('ListBoxType_Content')" /><input
                        id="Button2" type="button"  class="btn btn-primary"  style="width:150px;" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
                    <asp:TextBox ID="ListBoxType_Content" class="l_input" runat="server" 
                        TextMode="MultiLine" Columns="40"
                        Rows="6" Height="81px" Width="303px"></asp:TextBox>
                    <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg">
            ...
            <tr >
                ...
                <td>
                    <asp:TextBox ID="TxtOperatingOption" class="l_input" runat="server" 
                        TextMode="MultiLine" Columns="40"
                        Rows="6" Height="81px"></asp:TextBox>
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" class="btn btn-primary"  style="width:150px;"  runat="server" Text=" 修改字段 "  OnClientClick="return isok()"
                    OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <asp:Button ID="BtnBack" class="btn btn-primary"  style="width:150px;"  runat="server" Text="返回字段列表" OnClick="BtnBack_Click" UseSubmitBehavior="False"
    ...
    <asp:HiddenField runat="server" ID="blModel_Hid" />
</asp:Content>
