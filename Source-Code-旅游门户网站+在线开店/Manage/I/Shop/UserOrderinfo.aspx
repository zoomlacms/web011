<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_UserOrderinfo, App_Web_2afsdgkd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
 ...
 <table class="table table-striped table-bordered table-hover"> <asp:Literal ID="ModelHtml" runat="server"></asp:Literal></table>
<table class="table table-striped table-bordered table-hover">
    <tr>
    ...
    <asp:Repeater ID="procart" runat="server" OnItemDataBound="cartinfo_ItemDataBound">
        <ItemTemplate>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td align="center">
                <a href='../../Store/Shopinfo.aspx?Itemid=<%#Eval("ProID") %>' target='_blank'> 
...
<div id="msgDetail"></div></div><div id="bgDiv" style="display:none;"></div></div>
     <asp:Button ID="Button5" class="C_input"  runat="server" Text="订单无效" OnClick="Button5_Click" Visible="false"  />
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    <script type="text/javascript">
        function aa() {
            window.open('FreeSplit.aspx?id=<%=Request["id"] %>', 'newWin', 'modal=yes,width=900,height=600,resizable=yes,scrollbars=yes');
}
function show() {
