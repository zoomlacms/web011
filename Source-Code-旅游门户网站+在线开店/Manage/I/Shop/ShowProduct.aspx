<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ShowProduct, App_Web_2afsdgkd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%--         <li><a href="#tab4" data-toggle="tab" onclick="ShowTabss(6)">竞拍选项</a></li>--%>
        </ul>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="TABLE1">
        <tr>
            <td align="left" style="height: 59px">
                ...
                <input type="button" class="btn btn-primary"  name="Button2" value="返回列表"
                    onclick="location.href='ProductManage.aspx?NodeID=<%=Request.QueryString["NodeID"]%>    '" id="Button2" />
            </td>
        </tr> 
    </table>
</asp:Content>
