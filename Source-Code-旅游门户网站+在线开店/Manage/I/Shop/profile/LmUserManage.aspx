<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_profile_LmUserManage, App_Web_wbisykum" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:GridView ID="EGV" runat="server" AutoGenerateColumns="False" class="table table-striped table-bordered table-hover"	
    DataKeyNames="UserID" AllowSorting="True" GridLines="None" RowStyle-CssClass="tdbg"
   EnableModelValidation="True" OnRowDataBound="Egv_RowDataBound">
    <Columns>
        <asp:TemplateField>
            <ItemTemplate>
