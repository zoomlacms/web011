<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddOrderModel, App_Web_2afsdgkd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control" ID="Alias" runat="server" MaxLength="20" onkeyup="Getpy('Alias','Name')"></asp:TextBox><font color="#ff0066">*</font><span class="tips"> 如：标题</span>
        ...
        <tr>
            <td>字段名称：</td>
            <td>
                <asp:TextBox class="form-control" ID="Name" MaxLength="50" runat="server"></asp:TextBox>
        ...
        <tbody id="DivMultipleTextType" style="display: none">
            <tr>
                <td>显示的宽度：</td>
                <td>
                    <asp:TextBox class="form-control" ID="MultipleTextType_Width" runat="server" Columns="10"
        ...
        <tbody id="DivOptionType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-control" ID="RadioType_Content" runat="server" TextMode="MultiLine"
        ...
        <tbody id="DivListBoxType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-control" ID="ListBoxType_Content" runat="server" TextMode="MultiLine"
                        Columns="40" Rows="6"></asp:TextBox>
                    <span style="color: red">*</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" class="text-center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox class="form-control" ID="DateSearchRang" runat="server" TextMode="MultiLine"
        ...
        <tbody id="DivOperatingType" style="display: none">
            <tr>
                <td>分行键入&nbsp;&nbsp;<br />
                    每个平台选项：</td>
                <td>
                    <asp:TextBox class="form-control" ID="TxtOperatingOption" runat="server" TextMode="MultiLine"
                        Columns="40" Rows="6"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" class="text-center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox class="form-control" ID="NumSearchRange" runat="server" TextMode="MultiLine"
                                    Columns="40" Rows="6"></asp:TextBox><br />
                            </td>
                            <td>
                                <font color="red">选择了自定范围时请输入此项内容,格式：范围名|范围<br />
