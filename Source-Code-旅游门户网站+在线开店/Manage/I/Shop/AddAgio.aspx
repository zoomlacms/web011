<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddAgio, App_Web_2afsdgkd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                ...
                <input id="Button5" type="button" class="btn btn-primary" value="返回" onclick="javascript: window.history.go(-1);" />
            </td>
        </tr>
    </table>
</asp:Content>
