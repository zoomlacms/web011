<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.Stock, App_Web_p524jx43" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr >
            ...
            <td height="22" valign="middle">
                <asp:TextBox ID="Pronum" runat="server" class="form-control">0</asp:TextBox>
        ...
        <tr >
            ...
            <td valign="middle" style="height: 22px">
                <asp:TextBox ID="calendars" runat="server" class="form-control" Width="178px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
            </td>
        </tr>
        <tr >
            <td width="34%" class="tdbgleft" style="height: 22px">
            ...
            <td valign="middle" style="height: 22px">
                <asp:TextBox ID="adduser" runat="server"  class="form-control" Width="178px"></asp:TextBox>
