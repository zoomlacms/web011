<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Shop.AddModelField, App_Web_enu4lwhk" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        <tr>
            <td class="tdbgleft" style="width:200px;">字段别名：</td>
            <td>
            <asp:TextBox ID="Alias" runat="server" class="l_input" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span class="tips" style="color: #808000"> 如：文章标题</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="Description" runat="server" class="l_input" Columns="40" Rows="6" TextMode="MultiLine" Height="77px" Width="350px"></asp:TextBox></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="Type" runat="server" RepeatColumns="5" RepeatDirection="Horizontal" onclick="SelectModelType()">
                    ...
                    <asp:ListItem Value="MobileSMS">手机短信</asp:ListItem>
                    <asp:ListItem Value="RemoteFile" >远程文件</asp:ListItem>
                </asp:RadioButtonList></td>
        </tr>
        <!--  单行文本   -->
        <tbody id="DivTextType">
            <tr>
                ...
                <td><asp:TextBox ID="TitleSize" runat="server" class="l_input" Columns="10" MaxLength="4">35</asp:TextBox></td>
            </tr>
        ...
        <tbody id="DivOptionType" style="display:none">
            <tr>
                ...
                <td><input id="Button3" type="button" value="从数据字典中选择选项" class="btn btn-primary"  style="width:150px;" onclick="SelectDictionary('RadioType_Content')" /><input 
                    id="Button5" type="button" class="btn btn-primary"  style="width:150px;"  value="添加数据字段" onclick='SubPage("RadioType_Content")' /><br />
                    <asp:TextBox ID="RadioType_Content" class="l_input" runat="server" 
                        TextMode="MultiLine" Columns="40" Rows="6" Height="79px" Width="351px"></asp:TextBox> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">默认值：</td>
        ...
        <tbody id="DivListBoxType" style="display:none">
            <tr>
                <td class="tdbgleft">分行键入每个选项：</td>
                <td><input id="Button4" type="button" value="从数据字典中选择选项" class="btn btn-primary"  style="width:150px;"  onclick="SelectDictionary('ListBoxType_Content')" /><input 
                    id="Button6" class="btn btn-primary"  style="width:150px;"  type="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
                    <asp:TextBox ID="ListBoxType_Content" class="l_input" runat="server" 
                        TextMode="MultiLine" Columns="40" Rows="6" Height="75px" Width="350px"></asp:TextBox> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">显示选项：</td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="DateSearchRang" class="l_input" runat="server" 
                                    TextMode="MultiLine" Columns="40" Rows="6" Height="76px" Width="244px"></asp:TextBox><br />
        ...
        <tbody id="DivPicType" style="display:none">
            ...
            <tr>
                <td class="tdbgleft">
                    允许上传的图片大小：</td>
                <td>
                    <asp:TextBox ID="TxtSPicSize" class="l_input" runat="server" Columns=5>1024</asp:TextBox>KB <span style="color: blue">
        ...
        <tbody id="DivMultiPicType" style="display:none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="TxtThumb" class="l_input" runat="server" Columns="20"></asp:TextBox><span style="color:Red;display:none;">保存缩略图地址字段名不能与主字段名重复！</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">图片是否加水印：</td>
                <td>
            ...
            <tr>
                <td class="tdbgleft">
                    允许上传的图片大小：</td>
                <td>
                    <asp:TextBox ID="TxtPicSize" class="l_input" runat="server" Columns=5>1024</asp:TextBox>KB <span style="color: blue">
                        提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">
                    允许上传的图片类型：</td>
                <td>
                    <asp:TextBox ID="TextImageType" class="l_input" runat="server" Columns="30"></asp:TextBox> <span style="color: red">*</span>
                <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span></td>
            </tr>
        </tbody>            
         <!--  文件类型    -->
    ...
    <tbody id="DivFileType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtOperatingOption" class="l_input" runat="server" 
                        TextMode="MultiLine" Columns="40" Rows="6" Height="79px"></asp:TextBox> <span style="color: red">*</span> <span style="color: blue">注：一行一个默认项</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">文本框长度：</td>
                <td><asp:TextBox ID="OperatingType_TitleSize" class="l_input" runat="server" Columns="10" MaxLength="4">35</asp:TextBox><span style="color: red">*</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">默认值：</td>
                <td><asp:TextBox ID="OperatingType_DefaultValue" class="l_input" runat="server" Columns="30"></asp:TextBox><span style="color: green">例：Win2000|XP|Win2003</span> </td>
            </tr>
        </tbody>
        <!--  超链接    -->
        <tbody id="DivSuperLinkType" style="display:none">
            <tr>
                <td class="tdbgleft">文本框长度：</td>
                <td><asp:TextBox ID="SuperLinkType_TitleSize" runat="server" class="l_input" Columns="10" MaxLength="4">50</asp:TextBox></td>
            </tr>
            <tr>
                <td class="tdbgleft">默认值：</td>
                <td><asp:TextBox ID="SuperLinkType_DefaultValue" class="l_input" runat="server" Columns="30"></asp:TextBox><span style="color: green">例：http://127.0.0.1/</span></td>
            </tr>
        </tbody> 
        <!--  多级选项    -->
        ...
        <tbody id="DivNumType" style="display:none">
            <tr>
                <td class="tdbgleft">文本框长度：</td>
                <td><asp:TextBox ID="NumberType_TitleSize" class="l_input" runat="server" Columns="10" MaxLength="4">35</asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="tdbgleft">默认值：</td>
                <td><asp:TextBox ID="NumberType_DefaultValue" class="l_input" runat="server" Columns="10"></asp:TextBox></td>
            </tr>
            <tr class="tdbg">
                <td class="tdbgleft">
                搜索设置：
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="NumSearchRange" class="l_input" runat="server" 
                                    TextMode="MultiLine" Columns="40" Rows="6" Height="92px"></asp:TextBox><br />                                    
                            </td>
                            <td>
        ...
        <tr class="tdbg">
            ...
            <td>
                ...
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 " class="btn btn-primary"  onclick="javascript:window.location.href='<%="ModelField.aspx?ModelID="+Request.QueryString["ModelID"] %>'" />
