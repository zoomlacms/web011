<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_enu4lwhk" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ul class="nav nav-tabs">
        ...
        <li><a href="#tab4" data-toggle="tab" onclick="ShowTabss(5)">商品属性</a></li>
        <li><a href="#tab5" data-toggle="tab" onclick="ShowTabss(6)">竞拍选项</a></li>
    </ul>
                ...
                <table class="table table-striped table-bordered table-hover">
                    <tbody id="Tabs0">
                        ...
                        <tr>
                            ...
                            <td style="width: 592px;">
                                <asp:TextBox ID="ProCode" runat="server" disabled="disabled" Width="200" class="form-control" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Weight" runat="server" Width="91px" class="form-control" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="ServerPeriod" runat="server" Width="53px" class="form-control" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="ProClass" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="ProClass_SelectedIndexChanged" AutoPostBack="True">
                                    ...
                                    <asp:ListItem Value="5">IDC商品</asp:ListItem>
                                    <asp:ListItem Value="6">代卖</asp:ListItem>
                                </asp:RadioButtonList>
                                <div id="TG">
                                        ...
                                        <asp:View ID="View1" runat="server">
                                            <table>
                                                <tr>
                                                    <td>团购订金：</td>
                                                    <td>
                                                        <asp:TextBox ID="txtColoneDeposit" runat="server" class="form-control"></asp:TextBox>元
                                                ...
                                                <tr>
                                                    <td>最低团购人数：</td>
                                                    <td>
                                                        <asp:TextBox ID="NumberText" runat="server" class="form-control"></asp:TextBox>人&nbsp;
                                                    </td>
                                                    <td>团购价格:</td>
                                                    <td>
                                                        <asp:TextBox ID="TGPrice" runat="server" class="form-control"></asp:TextBox>元
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>开始时间</td>
                                    ...
                                    <table id="cloudTable" runat="server" visible="false">
                                        <tr>
                                            <td>库存数量：</td>
                                            <td>
                                                <asp:TextBox ID="stockT" runat="server" onkeyup="$('#Stock').val($(this).val());" Text="10" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <tr>
                            ...
                            <td style="height: 24px; width: 592px;">
                                <asp:TextBox ID="txtCountHits" runat="server" class="form-control" Text="Label" />
                        ...
                        <tr>
                            ...
                            <td style="height: 24px; width: 592px;">
                                <asp:TextBox ID="UpdateTime" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="form-control" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="ModeTemplate" runat="server" class="form-control" />
                                <input type="button" class="btn btn-primary" style="width: 100px" value="选择模板" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('ModeTemplate')+'&FilesDir=',650,480)" />
                            </td>
                        </tr>
                    </tbody>
                    <tbody id="Tabs1" style="display: none">
                        ...
                        <tr>
                            ...
                            <td style="height: 24px; width: 80%;">
                                <textarea cols="80" id="Procontent" style="width: 715px; height: 300px;" name="Procontent" rows="10" runat="server"></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Clearimg" runat="server" Width="300px" class="form-control" />
                                <iframe id="bigimgs" style="top: 2px" src="../../Shop/fileupload.aspx?menu=Clearimg" width="100%" height="25px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                            </td>
                        </tr>
                        <tr id="addsmallimg">
                            <td width="20%">
                            ...
                            <td>
                                <asp:TextBox ID="Thumbnails" runat="server" Width="300px" class="form-control" />
                    ...
                    <tbody id="Tabs2" style="display: none">
                        ...
                        <tr>
                            ...
                            <td>从<asp:TextBox ID="TextBox13" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" runat="server" class="form-control"></asp:TextBox>
                                &nbsp;到
                            <asp:TextBox ID="TextBox14" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" runat="server" class="form-control"></asp:TextBox>
                                &nbsp;为止
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Rate" runat="server" Text="0" class="form-control" />
                                %
                    ...
                    <tbody id="Tabs3" style="display: none">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="width: 23%; height: 21px;">
                                            <asp:TextBox ID="ShiPrice" runat="server" Width="93px" class="form-control" />元 <font
                                                color="red">*</font>
                                        </td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="width: 23%; height: 20px;">
                                            ...
                                            <asp:TextBox ID="LinPrice" runat="server" Width="93px" class="form-control" />
                                            元 <font color="red">*</font>
                                        </td>
                                        <td width="78%" style="height: 20px">商店销售此商品时的价格。<asp:RegularExpressionValidator ID="RegularExpressionValidator14" runat="server" ControlToValidate="LinPrice" ErrorMessage="零售价格式不对!" ValidationExpression="\d+[.]?\d*" Display="Dynamic" SetFocusOnError="True"></asp:RegularExpressionValidator>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div id="userP" runat="server">
                                            会员价：<asp:TextBox ID="userPrice" runat='server' class="form-control" Width="50px"></asp:TextBox>元
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="userPrice"
                                    ErrorMessage="会员价格格式不正确!" ValidationExpression="\d+[.]?\d*" Display="Dynamic"
                                    SetFocusOnError="True"></asp:RegularExpressionValidator>
                                        </div>
                                        <div id="divGroup" runat="server" visible="false">
                                            <asp:Repeater ID="repGroup" runat="server">
                                                <ItemTemplate>
                                                    ...
                                                    <%#Eval("GroupName")%>：<asp:TextBox ID="GroupPrice" runat='server' class="form-control"
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div id="farediv" runat="server" visible="false">
                                            ...
                                            快递：<asp:TextBox ID="FarePrice1" runat='server' class="form-control" Width="30px"></asp:TextBox>元 
                                                     
                                                <asp:HiddenField ID="FareID2" runat="server" Value='1' />
                                            平邮：<asp:TextBox ID="FarePrice2" runat='server' class="form-control" Width="30px"></asp:TextBox>元 
                                                     
                                                <asp:HiddenField ID="FareID3" runat="server" Value='2' />
                                            EMS：<asp:TextBox ID="FarePrice3" runat='server' class="form-control" Width="30px"></asp:TextBox>元 
                                        </div>
                        ...
                        <tr
                            ...
                            <td>
                                <asp:TextBox ID="txtDayPrice" runat="server" class="form-control"></asp:TextBox>
                        ...
                        <tr
                            ...
                            <td>
                                <div id='hotelDiv'>
                                    <asp:TextBox ID='CheckInDate' runat="server" Text="" class="form-control" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>至
                                <asp:TextBox ID='CheckOutDate' runat="server" Text="" class="form-control" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
                                </div>
                        ...
                        <tr
                            ...
                            <td>
                                <asp:TextBox ID="txtBookPrice" runat="server" class="form-control"></asp:TextBox>
                        ...
                        <tr
                            ...
                            <td>
                                <asp:TextBox ID="txtBookDay" runat="server" class="form-control"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRecommend" runat="server" Text="0" Width="93px" class="form-control" />
                                %
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPoint" runat="server" Text="0" Width="93px" class="form-control" Enabled="false" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="Largesspirx"
                                    ErrorMessage="礼品价格必须是数字!" ValidationExpression="^(-?\d+)(\.\d+)?$" SetFocusOnError="True"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                    </tbody>
                    <tbody id="Tabs4" style="display: none">
                        <tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td height="22">&nbsp;买&nbsp;<asp:TextBox class="form-control" ID="ProjectPronum2" Text="1" runat="server"
                                            Width="26px"></asp:TextBox>件此商品 可以送一件同样商品
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 22px">&nbsp;买&nbsp;<asp:TextBox Text="1" ID="ProjectPronum3" class="form-control" runat="server"
                                            Width="26px"></asp:TextBox>件此商品 可以送一件其他商品 赠品名称：<asp:TextBox ID="Productsname3" class="form-control"
                                    ...
                                    <tr>
                                        <td height="22">&nbsp;送&nbsp;<asp:TextBox ID="ProjectPronum4" class="form-control" runat="server" Text="1"
                                            Width="26px"></asp:TextBox>件同样商品
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 22px">&nbsp;送&nbsp;<asp:TextBox ID="ProjectPronum5" runat="server" class="form-control" Text="1"
                                            Width="26px"></asp:TextBox>件其他商品 送一件赠品名称：<asp:TextBox ID="Productsname5" class="form-control"
                                                runat="server" ReadOnly="true" onclick="ProductsSelect('Productsname2');"></asp:TextBox><asp:Button
                                                    ID="Button7" runat="server" class="btn btn-primary" Text="浏览..." OnClientClick="ProductsSelect('5');return false;" />
                                            <asp:HiddenField ID="HiddenField5" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="22">&nbsp;加&nbsp;<asp:TextBox ID="ProjectMoney6" class="form-control" runat="server" Text="1"
                                            Width="26px"></asp:TextBox>元钱送商品 送一件赠品名称：<asp:TextBox ID="Productsname6" runat="server"
                                                class="form-control" ReadOnly="true" onclick="ProductsSelect('Productsname3');"></asp:TextBox><asp:Button
                                                    ID="Button8" runat="server" class="btn btn-primary" Text="浏览..." OnClientClick="ProductsSelect('6');return false;" />
                                            <asp:HiddenField ID="HiddenField6" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="22">&nbsp;满&nbsp;<asp:TextBox ID="ProjectMoney7" runat="server" Text="1" Width="26px"
                                            class="form-control"></asp:TextBox>元钱送商品 送一件赠品名称：<asp:TextBox ID="Productsname7" class="form-control"
                        ...
                        <tr>
                            ...
                            <td>购买&nbsp;<asp:TextBox ID="IntegralNum" runat="server" Text="1" Width="26px" class="form-control"></asp:TextBox>&nbsp;件此商品可以得到
                    ...
                    <tbody id="Tabs6" style="display: none;">
                        ...
                        <tr>
                            <td colspan="2">
                                <table id="Guess1" style="display: none" class="table table-striped table-bordered table-hover">
                                    <tr>
                                        <td>
                                            <strong>秒杀时间段:(限制购买时间)</strong>
                                        </td>
                                        <td>从<asp:TextBox ID="TextBox3" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" runat="server" class="form-control"></asp:TextBox>
                                            &nbsp;到<asp:TextBox ID="TextBox4" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" runat="server" class="form-control"></asp:TextBox>&nbsp;为止
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBox7" runat="server" Width="86px" class="form-control">1</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBox8" runat="server" Width="64px" class="form-control">1</asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td colspan="2">
                                <table id="Guess2" style="display:none;" class="table table-striped table-bordered table-hover">
                                    <tr>
                                        <td width="20%" style="height: 19px">
                                            <strong>竞拍时间段：</strong>
                                        </td>
                                        <td style="height: 19px">从<asp:TextBox ID="txtStime" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' })" runat="server" class="form-control"></asp:TextBox>
                                            &nbsp;到<asp:TextBox ID="txtEtime" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' })" runat="server" class="form-control"></asp:TextBox>&nbsp;为止
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 19px">
                                            <asp:TextBox ID="TextBox11" runat="server" Width="51px" class="form-control">0</asp:TextBox>(默认为0开始)
                                            ...
                                            <table id="tableInterference" width="100%" cellpadding="0" style="display: none"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 19px">
                                                        <table width="100%" id="Panel1">
                                                            <tr>
                                                                <td>当参与竞拍人数达到<asp:TextBox ID="TextBox5" runat="server" Width="53px" onkeyup="this.value=this.value.replace(/\D/g,'')">0</asp:TextBox>人开始干扰
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" id="Panel2">
                                                            <tr>
                                                                <td>出价额度达到<asp:TextBox ID="TextBox6" runat="server" Width="53px" onkeyup="this.value=this.value.replace(/\D/g,'')">0</asp:TextBox>元开始干扰
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" id="Panel3">
                                                            <tr>
                                                                <td>倒计时达到<asp:TextBox ID="TextBox12" runat="server" Width="53px" onkeyup="this.value=this.value.replace(/\D/g,'')">0</asp:TextBox>秒开始干扰
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 19px">
                                                        ...
                                                        <br />
                                                        <input id="Button11" type="button" value="选择用户" class="btn btn-primary" onclick="window.open('/manage/Common/SelectUser.aspx', '', 'width=600,height=450,resizable=0,scrollbars=yes');" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
