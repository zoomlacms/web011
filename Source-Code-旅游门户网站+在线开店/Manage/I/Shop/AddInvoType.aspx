<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddInvoType, App_Web_2afsdgkd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
    ...
    <tr>
      ...
      <td width="76%" height="24" ><asp:TextBox ID="deliname" runat="server" class="form-control" />
          <asp:HiddenField ID="ID_H" runat="server" />
      </td>
    </tr>        
    <tr >
      <td height="24" class="tdbg"><strong>发票类型简介</strong></td>
      <td height="24" ><asp:TextBox ID="deliinfo" class="form-control" runat="server" Height="177px" TextMode="MultiLine" Width="428px" /></td>
    </tr>

       <tr>
      <td class="tdbg"><strong>税率</strong></td>
      <td ><asp:TextBox ID="shuilv" class="form-control" runat="server" Text='0' Width="50px" /> %
