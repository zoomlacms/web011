<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_Suppliers, App_Web_vm4dsmle" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
    ...
    <tr>
        <td style="width: 17%">
            ...
            <label for="CkSina">
                <img style="cursor: pointer;" src="/App_Themes/AdminDefaultTheme/images/Sina_2.png" /></label></td>
        <td>
    ...
    <tr>
        <td style="width: 17%">
            ...
            <label for="CkQQ">
                <img style="cursor: pointer;" src="/App_Themes/AdminDefaultTheme/images/QQ_2.png" /></label></td>
        <td>
    ...
    <tr>
        <td style="width: 17%">
            ...
            <label for="CkBaidu">
                <img style="cursor: pointer;" src="/App_Themes/AdminDefaultTheme/images/Baidu_2.png" /></label></td>
        <td>
    ...
    <tr>
        <td>
            ...
            <label for="CkKaixin">
                <img style="cursor: pointer;" src="/App_Themes/AdminDefaultTheme/images/Kaixin_2.png" /></label></td>
        <td>
    ...
    <tr>
        <td>
            ...
            <label for="CkRenren">
                <img style="cursor: pointer;" src="/App_Themes/AdminDefaultTheme/images/Renren_2.png" /></label></td>
        <td>
    ...
    <tr>
        <td>
            ...
            <label for="CkNetease">
                <img style="cursor: pointer;" src="/App_Themes/AdminDefaultTheme/images/Netease_2.png" /></label></td>
        <td>
