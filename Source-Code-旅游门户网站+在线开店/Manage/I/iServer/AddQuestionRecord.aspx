<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_AddQuestionRecord, App_Web_2sdpagom" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td  style="width:150px;">会员登录账号<font color="red">*</font>
            </td>
            <td>
                <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control" Text=""></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" cssclass="form-control"
            ...
            <td>
                ...
                输入电话号码、E-mail等：<asp:TextBox ID="txtRootInfo" CssClass="form-control" runat="server" Text=""
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" Text="" Width="348px"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <textarea class="form-control" name="comments" rows="6" cols="80"></textarea>
            </td>
        </tr>
        <tr>
            <td >附件
            ...
            <td>只能上传<span id="filetype" runat="server"></span>类型的附件,单个附件小于 500KB
                <br />
                附件1:
                <asp:FileUpload ID="FileUpload1" CssClass="form-control" runat="server" onkeydown="event.returnValue=false;" onpaste="return false" /><br />
                附件2:
                <asp:FileUpload ID="FileUpload2" CssClass="form-control" runat="server" onkeydown="event.returnValue=false;"
                    onpaste="return false" /><br />
                附件3:
                <asp:FileUpload ID="FileUpload3"  CssClass="form-control" runat="server" onkeydown="event.returnValue=false;" onpaste="return false" /><br />
