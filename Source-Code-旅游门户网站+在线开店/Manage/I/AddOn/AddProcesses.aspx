<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_AdvProcesses, App_Web_uw5yi4gb" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加项目流程</title>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
        <tbody id="Tabs0">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtTime" class="l_input" runat="server" Width="222px" onfocus="WdatePicker({ dateFmt: 'yyyy/MM/dd' });"/>
                    (请选择时间)</td>
            </tr>
        </table>
        <div class="clearbox"></div>
