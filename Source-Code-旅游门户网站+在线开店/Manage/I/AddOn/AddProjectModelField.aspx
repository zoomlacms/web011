<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_AddProjectModelField, App_Web_oxnlb5iw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    <table class="table table-striped table-bordered table-hover">
        <tr>
            <td class="spacingtitle" align="center" colspan="2">添加项目字段
            </td>
        </tr>
        <tr>
            <td style="width: 200px">字段别名：</td>
            <td>
                <asp:TextBox class="form-control" ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font
        ...
        <tr>
            ...
            <td>
                <asp:TextBox CssClass="form-control" ID="Name" MaxLength="50" runat="server"></asp:TextBox><font
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control" ID="Tips" MaxLength="50" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control" ID="Description" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr style="display: none" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td>是否必填：
            </td>
            <td>
        ...
        <tbody id="DivTextType">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>是否为密码：
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="TextType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
        </tbody>
        <!--  多行文本(不支持Html)    -->
        <tbody id="DivMultipleTextType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="MultipleTextType_Height" runat="server" Columns="10"
        ...
        <tbody id="DivMultipleHtmlType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="MultipleHtmlType_Width" runat="server" Columns="10"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="MultipleHtmlType_Height" runat="server" Columns="10"
        ...
        <tbody id="DivPicType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="TxtSPicSize" runat="server" Columns="5">1024</asp:TextBox>KB
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="TxtPicExt" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivMultiPicType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-control" ID="TxtThumb" runat="server" Columns="20"></asp:TextBox><span
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="TxtPicSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
        ...
        <tbody id="DivSmallFileType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="TxtMaxFileSizes" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
        ...
        <tbody id="DivFileType" style="display: none" runat="server">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="TxtMaxFileSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
        ...
        <tbody id="DivOperatingType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="OperatingType_TitleSize" runat="server" Columns="10"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="OperatingType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivSuperLinkType" style="display: none">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="SuperLinkType_TitleSize" runat="server" Columns="10"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="SuperLinkType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivGradeOptionType" style="display: none">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="GradeOptionType_Cate" CssClass="form-control" runat="server"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>选项下拉框排列格式化：
        ...
        <tbody id="DivNumType" style="display: none">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="NumberType_TitleSize" runat="server" Columns="10"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="NumberType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>搜索设置：
        ...
        <tbody id="DivColorType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control" ID="ColorDefault" runat="server" MaxLength="7" Columns="7"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                ...
                <input id="Button2" type="button" value=" 返回字段列表 " class="btn btn-primary" onclick="javascript: window.location.href = 'ProjectsModelField.aspx'" />
