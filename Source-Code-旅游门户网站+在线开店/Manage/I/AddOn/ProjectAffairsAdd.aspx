<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_ProjectAffairsAdd, App_Web_gcztzp3d" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>新建事务</title>
...
<style type="text/css">
<!-- 
.btn{   padding: 1px 1px 1px 1px;    font-size: 12px;    height: 22px;    background: url(/App_Themes/AdminDefaultTheme/Images/btnbg.gif);    border-right: #999999 1px solid;    border-top: #999999 1px solid;    border-left: #999999 1px solid;
border-bottom: #999999 1px solid;}</style>
</head>
<body>
