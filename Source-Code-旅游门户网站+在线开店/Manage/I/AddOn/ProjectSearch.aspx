<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_ProjectSearch, App_Web_oxnlb5iw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>项目检索</title>
...
<span>后台管理</span>&gt;&gt;<span>项目管理</span>&gt;&gt;<span><a href="ProjectManage.aspx"> 项目列表</a></span>&gt;&gt;<span> 项目检索</span>	</div> 
	...
	<ZL:ExGridView ID="Egv" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="border"
