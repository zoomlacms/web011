<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddSource, App_Web_tctqdymj" debug="true" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td rowspan="6" colspan="2">
                <table style="width:180px;border:1px solid #ddd;">
                    <tr>
                        <td style="width: 100%;" align="center">
                            <img id="showphoto" runat="server" src="/App_Themes/AdminDefaultTheme/Images/default.gif" width="150" height="172" alt="来源图片" />
                        </td>
                    </tr>
                </table>
                <asp:TextBox ID="txtpic" runat="server" class="form-control pull-left"></asp:TextBox>*<br />
                <asp:Label ID="LabPicPath" runat="server" Text="请选择上传路径！" Visible="False"></asp:Label><br />
                <asp:FileUpload ID="FileUpload1" CssClass="form-control" style="display:inline;" runat="server"/>
                <asp:Button ID="Button1" runat="server" style="display:inline;" CssClass="btn btn-default" OnClick="Button1_Click" Text="上传" />
            </td>
        </tr>
        <tr>
            <td>
