<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.UserShop.UpdateModelField, App_Web_2pfg00wt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<a href="ModelManage.aspx">模型管理</a>
    &gt;&gt; <a href="ModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">字段列表</a>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
            ...
            <tbody id="DivOptionType" style="display:none" runat="server">
                <tr class="tdbg">
                    ...
                    <td><input id="Button3" type="button" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('RadioType_Content')" /><input 
                        id="Button5" type="button" value="添加数据字段" onclick='SubPage("RadioType_Content")' /><br />
            ...
            <tbody id="DivListBoxType" style="display:none" runat="server">
                <tr class="tdbg">
                    <td class="tdbgleft">分行键入每个选项：</td>
                    <td><input id="Button4" type="button" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('ListBoxType_Content')" /><input 
                        id="Button2" type="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
                ...
                <tr class="tdbg">
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                            ...
                            <tr class="tdbg">
                                <td>
                                    <asp:TextBox ID="DateSearchRang" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox><br />
        ...
        <tbody id="DivSmallFileType" style="display: none"  runat="server">
            <tr class="tdbg">
                ...
                <td>
                    <asp:TextBox ID="TxtMaxFileSizes" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg">
                <td class="tdbgleft">
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileTypes" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivFileType" style="display: none"  runat="server">
            ...
            <tr class="tdbg">
                ...
                <td>
                    <asp:TextBox ID="TxtMaxFileSize" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg">
                <td class="tdbgleft">
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileType" runat="server" Columns="30"></asp:TextBox>
                ...
                <tr class="tdbg">
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                            ...
                            <tr class="tdbg">
                                <td>
                                    <asp:TextBox ID="NumSearchRange" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox><br />                                    
                                </td>
                                <td>
        ...
        <tbody id="DivColorType" style="display: none" runat="server">
            <tr class="tdbg">
                ...
                <td>
                    <asp:TextBox ID="ColorDefault" runat="server" MaxLength="7"  Columns="7" style="font-size: 9pt; height: 15px;"></asp:TextBox>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <tr class="tdbg">
                ...
                <td height="50">
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="BtnBack" runat="server" Text="返回字段列表" OnClick="BtnBack_Click" UseSubmitBehavior="False" CausesValidation="False" />
