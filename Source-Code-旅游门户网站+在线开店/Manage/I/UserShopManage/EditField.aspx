<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_EditField, App_Web_2pfg00wt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt; 企业黄页&gt;&gt; 黄页申请设置 &gt;&gt; 字段列表&gt;&gt; 修改[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段</div>
<table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
		<tr class="tdbg">
			...
			<td>
				<asp:TextBox ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span class="tips"> 如：文章标题</span></td>
		</tr>
		<tr class="tdbg">
			<td class="tdbgleft">
				字段名称：
			...
			<td>
				<asp:TextBox ID="Name" MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font><span class="tips">字段名由字母、数字、下划线组成</span>
			</td>
		</tr>
		<tr class="tdbg">
			<td class="tdbgleft">
