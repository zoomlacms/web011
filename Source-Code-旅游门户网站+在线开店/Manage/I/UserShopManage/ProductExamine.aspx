<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ProductExamine, App_Web_2pfg00wt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
  ...
  <tr>
	<td style="height: 21px">&nbsp;
		<asp:Button ID="Button3" runat="server" Text="批量审核" OnClick="Button3_Click1"  /></td>
  </tr>
</table>
</form>
</body>
