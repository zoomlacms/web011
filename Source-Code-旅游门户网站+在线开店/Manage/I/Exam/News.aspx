<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_News, App_Web_fk1hbgsf" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table table-bordered table-hover">
            <tr>
              <td>报纸名：</td>
              <td><asp:TextBox runat="server" ID="NewsName_T" />
            ...
            <tr>
              <td>分类：</td>
              <td><asp:DropDownList ID="NodeList_D" CssClass="form-control" runat="server">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <table class="table table-bordered table-hover">
        <tr>
          <td>分类名：</td>
          <td><asp:TextBox runat="server" ID="NodeName_T" />
        ...
        <tr>
          <td>报纸分类：</td>
          <td><asp:DropDownList ID="ParentIDS_D" CssClass="form-control" runat="server">
