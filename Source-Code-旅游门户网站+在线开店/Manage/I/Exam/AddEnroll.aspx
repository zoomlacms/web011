<%@ page language="C#" autoeventwireup="true" inherits="manage_Exam_AddEnroll, App_Web_fk1hbgsf" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody id="Tabs0">
            <tr>
                ...
                <td class="bqright">
                    <asp:DropDownList ID="EnrollUser" runat="server"  CssClass="form-control">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td class="bqright">
                    <asp:TextBox ID="txt_infos" runat="server" TextMode="MultiLine" Height="81px"  CssClass="form-control"></asp:TextBox>
                </td>
            </tr>
