<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_AddQuestionType, App_Web_fk1hbgsf" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <asp:Literal ID="liQuestionType" runat="server" Visible="false"></asp:Literal>
        ...
        <tbody id="Tabs0">
            ...
            <tr>
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtRemark" runat="server" class="form-control" TextMode="MultiLine" Height="123px" ></asp:TextBox>
                </td>
            </tr>
        </tbody>
        <tr class="tdbgbottom">
