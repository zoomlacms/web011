<%@ page language="C#" autoeventwireup="true" inherits="manage_Exam_MakeScore, App_Web_fk1hbgsf" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    此卷总分为：<input name="score" id="score" runat="server" style="width:40px;"/>
    <asp:Button id="sub" Text="提交分数" runat="server" onclick="sub_Click"/>&nbsp
