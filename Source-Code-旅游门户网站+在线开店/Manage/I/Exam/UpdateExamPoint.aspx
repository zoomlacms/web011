<%@ page language="C#" autoeventwireup="true" inherits="manage_Exam_UpdateExamPoint, App_Web_fk1hbgsf" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%--            <tr>
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtCoureTime" runat="server" class="form-control"   onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="tdbgleft" style="width: 20%" align="right">
