<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Common.ShowUploadFiles, App_Web_yz0xa5ln" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
	...
	<table width="100%">
		<tr>
			...
			<td align="right">
				<a href="ShowUploadFiles.aspx?Dir=<%= Server.UrlEncode(m_ParentDir) %>">返回上一级</a></td>
		</tr>
	</table>
