<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_AdduserField, App_Web_0fbyacen" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<asp:Content runat="server" ContentPlaceHolderID="head">
    <title>添加模型字段</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <asp:Label ID="lblModel" runat="server" Text="Label" Visible="false"></asp:Label>
    <table class="table table-striped table-bordered table-hover">
        <tr>
            ...
            <td>
                <asp:TextBox ID="Alias" runat="server" class="form-control" MaxLength="20" onkeyup="Getpy('Alias','Name')"></asp:TextBox>
                <span style="color: #ff0066">*</span><span class="tips" style="color: #808000"> 如：文章标题</span>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:TextBox ID="Name" MaxLength="50" class="form-control" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="Tips" MaxLength="50" class="form-control" runat="server"></asp:TextBox><span class="tips" style="color: #808000">显示在字段别名下方作为重要提示的文字</span>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td class="tdgb">
                <asp:TextBox ID="Description" class="form-control" runat="server" Columns="40"
        ...
        <tbody id="DivTextType">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TitleSize" class="form-control" runat="server" Columns="10" MaxLength="4">35</asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextType_DefaultValue" class="form-control" runat="server" Columns="10"></asp:TextBox></td>
            </tr>
        </tbody>
        <!--  多行文本(不支持Html)    -->
        <tbody id="DivMultipleTextType" style="display: none">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="MultipleTextType_Width" class="form-control" runat="server" Columns="10" MaxLength="4">500</asp:TextBox>px</td>
            </tr>
            <tr>
                <td><strong>显示的高度：</strong></td>
                <td>
                    <asp:TextBox ID="MultipleTextType_Height" class="form-control" runat="server" Columns="10" MaxLength="4">200</asp:TextBox>px</td>
            </tr>
        </tbody>
        <!--  多行文本(支持Html)    -->
        <tbody id="DivMultipleHtmlType" style="display: none">
            <tr>
                <td><strong>编辑器类型：</strong></td>
                <td>
            ...
            <tr>
                <td><strong>显示的宽度：</strong></td>
                <td>
                    <asp:TextBox ID="MultipleHtmlType_Width" class="form-control" runat="server" Columns="10" MaxLength="4">715</asp:TextBox>px</td>
            </tr>
            <tr>
                <td><strong>显示的高度：</strong></td>
                <td>
                    <asp:TextBox ID="MultipleHtmlType_Height" class="form-control" runat="server" Columns="10" MaxLength="4">400</asp:TextBox>px</td>
            </tr>
        </tbody>
        <!--  单选项    -->
        <tbody id="DivOptionType" style="display: none">
            <tr>
                <td><strong>分行键入每个选项：</strong></td>
                <td>
                    ...
                    <asp:TextBox ID="RadioType_Content" class="form-control" runat="server"
                        TextMode="MultiLine" Columns="40" Rows="6" Height="60px" Width="345px"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="RadioType_Default" class="form-control" runat="server"></asp:TextBox>
                    <span style="color: #808000">注：没有数据录入的默认值，与前台显示无关.</span></td>
            </tr>
            <tr>
                <td>显示选项：</td>
                <td>
        ...
        <tbody id="DivListBoxType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="ListBoxType_Content" class="form-control" runat="server"
                        TextMode="MultiLine" Columns="40" Rows="6" Height="60px" Width="346px"></asp:TextBox>
                    <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td><strong>显示选项：</strong></td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="DateSearchRang" class="form-control" runat="server"
        ...
        <tbody id="DivPicType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtSPicSize" runat="server" Columns="5" class="form-control">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td>
                    <strong>允许上传的图片类型：</strong></td>
                <td>
                    <asp:TextBox ID="TxtPicExt" Text="jpg|png|gif|bmp|jpeg" runat="server" Columns="30" class="form-control"></asp:TextBox><span style="color: red">*</span>
        ...
        <tbody id="DivMultiPicType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="TxtThumb" runat="server" Columns="20" class="form-control"></asp:TextBox><span style="color: Red; display: none;">保存缩略图地址字段名不能与主字段名重复！</span></td>
            </tr>
            <tr>
                <td><strong>图片是否加水印：</strong></td>
                <td>
            ...
            <tr>
                <td>
                    <strong>允许上传的图片大小：</strong></td>
                <td>
                    <asp:TextBox ID="TxtPicSize" runat="server" Columns="5" class="form-control">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td>
                    <strong>允许上传的图片类型：</strong></td>
                <td>
                    <asp:TextBox ID="TextImageType" Text="jpg|png|gif|bmp|jpeg" runat="server" Columns="30" class="form-control"></asp:TextBox>
        ...
        <tbody id="DivSmallFileType" style="display: none">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtMaxFileSizes" runat="server" Columns="5" class="form-control">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileTypes" Text="rar|zip|docx|pdf" runat="server" Columns="30" class="form-control"></asp:TextBox>
        ...
        <tbody id="DivFileType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    保存文件大小字段名：
                <asp:TextBox ID="TxtFileSizeField" runat="server" Columns="20" class="form-control"></asp:TextBox><br />
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtMaxFileSize" runat="server" Columns="5" class="form-control">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileType" Text="rar|zip|docx|pdf" runat="server" Columns="30" class="form-control"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtOperatingOption" runat="server" TextMode="MultiLine"
                        Columns="40" Rows="6" class="form-control" Height="60px"></asp:TextBox>
                    <span style="color: red">*</span> <span style="color: blue">注：一行一个默认项</span></td>
            </tr>
            <tr>
                <td><strong>文本框长度：</strong></td>
                <td>
                    <asp:TextBox ID="OperatingType_TitleSize" runat="server" Columns="10" MaxLength="4" class="form-control">35</asp:TextBox><span style="color: red">*</span></td>
            </tr>
            <tr>
                <td><strong>默认值：</strong></td>
                <td>
                    <asp:TextBox ID="OperatingType_DefaultValue" runat="server" Columns="30" class="form-control"></asp:TextBox><span style="color: green">例：Win2000|XP|Win2003</span> </td>
            </tr>
        </tbody>
        <!--  超链接    -->
        <tbody id="DivSuperLinkType" style="display: none">
            <tr>
                <td><strong>文本框长度：</strong></td>
                <td>
                    <asp:TextBox ID="SuperLinkType_TitleSize" runat="server" Columns="10" MaxLength="4" class="form-control">50</asp:TextBox></td>
            </tr>
            <tr>
                <td><strong>默认值：</strong></td>
                <td>
                    <asp:TextBox ID="SuperLinkType_DefaultValue" runat="server" Columns="30" class="form-control"></asp:TextBox><span style="color: green">例：http://127.0.0.1/</span></td>
            </tr>
        </tbody>
        <!--  多级选项    -->
        <tbody id="DivGradeOptionType" style="display: none">
            <tr>
                <td><strong>选择分级数据分类：</strong></td>
                <td>
            ...
            <tr>
                <td><strong>选项下拉框排列格式化：</strong></td>
                <td>
        ...
        <tbody id="DivNumType" style="display: none">
            <tr>
                <td><strong>文本框长度：</strong></td>
                <td>
                    <asp:TextBox ID="NumberType_TitleSize" runat="server" Columns="10" MaxLength="4" class="form-control">35</asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><strong>默认值：</strong></td>
                <td>
                    <asp:TextBox ID="NumberType_DefaultValue" runat="server" Columns="10" class="form-control"></asp:TextBox></td>
            </tr>
            <tr>
                <td>
                    <strong>搜索设置：</strong>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="NumSearchRange" runat="server" TextMode="MultiLine"
                                    Columns="40" Rows="6" class="form-control" Height="60px"></asp:TextBox><br />
                            </td>
                            <td>
        ...
        <tbody id="DivColorType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="ColorDefault" runat="server" MaxLength="7" Columns="7" Style="font-size: 9pt; height: 15px;" class="form-control"></asp:TextBox>
        ...
        <tr class="tdbg">
            <td></td>
            <td height="50">
                <asp:Button ID="Button1" runat="server" Text="添加字段" class="btn btn-primary" OnClientClick="return isok()" OnClick="Button1_Click" />
                <input id="Button2" type="button" value="返回字段列表" class="btn btn-primary" onclick="javascript:window.location.href='UserModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>    '" />
