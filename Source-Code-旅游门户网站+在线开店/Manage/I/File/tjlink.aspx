<%@ page language="C#" autoeventwireup="true" inherits="manage_File_tjlink, App_Web_i0cm0h5o" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td lign="left">
                <asp:DropDownList ID="TxtLwindows" CssClass="form-control" Width="150" runat="server">
        ...
        <tr>
            ...
            <td class="style1" align="left">
                <asp:TextBox ID="TxtKeywordText" class="form-control" runat="server">http://</asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="text-right">
            ...
            <td>
                <asp:TextBox ID="Regex_Txt" class="form-control" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="RegexValue_T" class="form-control" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="text-right">
            ...
            <td>
                <asp:TextBox ID="Priority" class="form-control" runat="server"></asp:TextBox>
