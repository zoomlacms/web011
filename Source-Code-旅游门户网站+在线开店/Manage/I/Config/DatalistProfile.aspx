<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_EditDataList, App_Web_gsi5yeuj" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div runat="server" visible="false" id="maindiv">
        ...
        <asp:GridView ID="EGV" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" AllowPaging="True" PageSize="20"
            OnRowCommand="Lnk_Click" CssClass="table table-striped table-bordered table-hover">
            <Columns>
