<%@ page language="C#" autoeventwireup="true" inherits="manage_Boss_AddBoss, App_Web_4msspst3" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <table class="table table-striped table-bordered table-hover">
                    <tbody id="Tabs0">
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="tx_cname" runat="server" CssClass="form-control"></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="CMoney" runat="server"   CssClass="form-control"></asp:TextBox>元
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="tx_adderss" runat="server"  CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="tdbg">
                            <td class="tdbgleft">
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="cx_Agent" runat="server"  CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="tdbg" runat="server" visible="false">
                            ...
                            <td>
                                <asp:TextBox ID="cx_license" runat="server"  CssClass="form-control"></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="tx_CTel" runat="server"  CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="tdbg">
                            <td class="tdbgleft">
                            ...
                            <td>
                                <asp:TextBox ID="tx_CInfo" runat="server"  TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                    </tbody>
                    <%--栏目选项--%>
                    <tbody id="Tabs1" style="display: none">
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="ContractNum" runat="server" Width="200px" CssClass="form-control"></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="AccountPeople" runat="server" CssClass="form-control" ></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="Bank" runat="server" CssClass="form-control" ></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="BankNum" runat="server" CssClass="form-control" ></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="AccountPeople2" runat="server" CssClass="form-control" ></asp:TextBox></td>
                        </tr>
                        <tr class="tdbg">
                            <td class="tdbgleft">
                                <strong>开户银行2：</strong>
                            ...
                            <td>
                                <asp:TextBox ID="Bank2" runat="server" CssClass="form-control" ></asp:TextBox></td>
                        </tr>
                        <tr class="tdbg">
                            <td class="tdbgleft">
                                <strong>银行账号2：</strong></td>
                            <td>
                                <asp:TextBox ID="BankNum2" runat="server" CssClass="form-control" ></asp:TextBox></td>
                        </tr>
                    </tbody>
                    <%--收费设置--%>
                    <tbody id="Tabs2" style="display: none">
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="linkname" runat="server" CssClass="form-control" ></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="tdbg">
                            <td class="tdbgleft">
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="linkPositions" runat="server" CssClass="form-control" ></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="tdbg">
                            <td class="tdbgleft">
                            ...
                            <td>
                                <asp:TextBox ID="linktel" runat="server" CssClass="form-control" ></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="tdbg">
                            <td class="tdbgleft">
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="DocumentsNUm" runat="server" CssClass="form-control" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
