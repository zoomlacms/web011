<%@ page language="C#" autoeventwireup="true" inherits="manage_AddCRM_CustomerManage, App_Web_4tgaf4eo" enableviewstatemac="false" validaterequest="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <td style="height: 100px;" valign="top">
                    <table id="Tabs0"  class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input value=" ... " onclick="ShowUserInfo()" data-toggle="modal" data-target="#userinfo_div"
                    ...
                    <table id="Tabs4" cellpadding="2" cellspacing="1" style="width: 100%; background-color: white;
                        ...
                        <tr>
                            ...
                            <td style="width: 38%">
                                <input name="DpkBirthday" type="text" id="DpkBirthday" value="1986-10-22 0:0:0" style="font-size: 9pt; " runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" />
                            </td>
                            <td style="width: 15%" align="right" class="tdbgleft">
                                证件号码：
                            </td>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        function ShowUserInfo(id) {
            $("#user_ifr").attr("src", "SelectProjectName.aspx");
        }
        function displl(di) {
            if (di != "info") {
