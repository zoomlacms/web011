<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Pay_AlipayBank, App_Web_nzaiysvq" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ContentTemplate>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover">
                ...
                <tr >
                    ...
                    <td>
                        <asp:TextBox ID="TxtRate" runat="server" Text="0" class="form-control pull-left" /><sapn class="tips">%</sapn>
