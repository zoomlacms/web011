<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.I.Pay.Paypalmanage, App_Web_nzaiysvq" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <tr>
        <td>方式名称：</td>
        <td>
            <asp:TextBox ID="payname" runat="server" ReadOnly="True" class="form-control pull-left">Paypal或Visa,Master,Solo等银行卡在线支付</asp:TextBox>
        </td>            
    </tr>
   ...
   <tr>
        ...
        <td>
            <asp:TextBox ID="pay_intf" runat="server" ReadOnly="True" class="form-control pull-left">PayPal外贸必选(标准版)</asp:TextBox>
        </td>            
    </tr>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="clientid" runat="server" class="form-control pull-left"/>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="title_T" runat="server" class="form-control pull-left"/>
        </td>            
    </tr>
    <tr>
    ...
    <tr>
        <td>支付手续费：</td>
        <td>
            <asp:TextBox ID="number" runat="server" Text="p*0.05" class="form-control pull-left"/>
            <span class="tips">
