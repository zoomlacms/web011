<%@ page language="C#" autoeventwireup="true" inherits="manage_ZoneApplyManage_ProductManage, App_Web_uep30c12" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:Repeater ID="Productlist" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="ZoneEdit.aspx?id=<%#Eval("UserID")%>">查看</a>
                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName='<%#Eval("ID")%>' OnClick="Button2_Click" OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');">删除</asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
