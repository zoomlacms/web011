<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.zone.SnsAddModelField, App_Web_uep30c12" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
    <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>SNS空间管理</span> &gt;&gt; <a href="SnsModelManage.aspx">学校会员模型管理</a>    &gt;&gt; <a href="SnsModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">字段列表</a>
    &gt;&gt; 添加[
    <asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段
	</div>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
            ...
            <tr class="tdbg">
                ...
                <td height="50">
                    <asp:Button ID="Button1" runat="server" Text=" 添加字段 " CssClass="btn" OnClientClick="return isok()" OnClick="Button1_Click" />
                    &nbsp;&nbsp;
                    <input id="Button2" type="button" value=" 返回字段列表 " class="btn" onclick="javascript:window.location.href='ModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'" />
