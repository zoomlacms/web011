<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.MailList, App_Web_pwpbtctt" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="MailTemp" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="GetTempCon">
        ...
        <tr>
            ...
            <td style="text-align: left">
                <table>
                    <tr>
                        <td>
                            <asp:RadioButton ID="RadUserType0" runat="server" GroupName="UserType" Text="所有会员" Checked="True" /></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td valign="top">
                        ...
                        <td>
                            <asp:TextBox class="form-control" Style="max-width: 150px; display: inline;" ID="TxtUserName" runat="server" Width="260px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox class="form-control" Style="max-width: 150px; display: inline;" ID="TxtEmails" runat="server" Width="260px">&nbsp;</asp:TextBox>多个Email间请用<span style="color: blue">英文的逗号</span>分隔
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control" Style="max-width: 150px;" ID="TxtSubject" runat="server" Width="390px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="ValrSubject" runat="server" ControlToValidate="TxtSubject" Display="None" ErrorMessage="邮件主题不能为空！"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td><strong>邮件内容：</strong></td>
            <td>
                <asp:TextBox ID="TxtContent" runat="server" TextMode="MultiLine" Width="700px"  Height="300px"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control" Style="max-width: 200px;" ID="TxtSenderName" runat="server" Width="350px"></asp:TextBox></td>
        </tr>
        <tr>
            <td align="right"><strong>回复Email：</strong></td>
            <td>
                <asp:TextBox class="form-control" Style="max-width: 200px;" ID="TxtSenderEmail" runat="server" Width="350px"></asp:TextBox>
        ...
        <tr class="tdbgbottom">
            <td colspan="2" style="text-align: center;">
                ...
                <input id="Reset1" type="reset" value="清除" class="btn btn-primary" />
            </td>
        </tr>
    </table>
