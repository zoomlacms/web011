<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserSearch, App_Web_pwpbtctt" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <tbody id="Search" runat="server" >
      <tr  class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><strong id="strtime" runat="server">
          <asp:TextBox ID="txtSteatTime" runat="server" Height="22px" Width="160px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });" class="l_input"></asp:TextBox>
          到
          <asp:TextBox ID="txtEndTime" runat="server"  Height="22px" Width="160px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });" class="l_input"></asp:TextBox>
          </strong></td>
      </tr>
      <tr class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td> Email:</td>
