<%@ page language="C#" autoeventwireup="true" inherits="User.UserManageLogin, App_Web_pwpbtctt" debug="true" title="会员管理" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <asp:GridView ID="EGV" runat="server" AllowPaging="True" AutoGenerateColumns="False" class="table table-striped table-bordered table-hover" DataKeyNames="UserID" PageSize="20" OnRowCommand="Lnk_Click" OnPageIndexChanging="Egv_PageIndexChanging" Width="100%" AllowSorting="true" OnSorting="Egv_Sorting">
    <Columns>
<%--      <asp:TemplateField>
        <ItemTemplate>
