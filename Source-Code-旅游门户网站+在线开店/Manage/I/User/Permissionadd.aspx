<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_Permissionadd, App_Web_ub3q0ybo" enableviewstate="False" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr>
      ...
      <td width="75%" height="24"><asp:TextBox class="form-control" style="max-width:150px;" ID="txtRoleName" runat="server" />
    ...
    <tr>
      ...
      <td style="height: 24px"><asp:TextBox class="form-control" style="max-width:150px;" ID="txtInfo" runat="server" Width="432px" /></td>
    </tr>
    <tr>
