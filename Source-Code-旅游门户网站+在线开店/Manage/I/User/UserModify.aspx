<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserPassModify, App_Web_ub3q0ybo" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <td colspan="4">
                 ...
                 <select runat="server" id="selprovince" onchange="javascript:area()">
                        ...
                        <table class="table table-striped table-bordered table-hover padding0">
                            <tr>
                                <td style="width:15%;" class="text-right">真实姓名：</td>
                                <td style="width:35%;"><asp:TextBox ID="tbTrueName_T" CssClass="form-control" runat="server"></asp:TextBox>
                                </td>
                                <td style="width:15%;" class="text-right">公司名称：</td>
                                <td style="width:35%;"><asp:DropDownList ID="tbCompName_D" CssClass="form-control" runat="server" DataTextField="CompName" DataValueField="ID"></asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td style="width:15%;" class="text-right">公司部门：</td>
                                <td style="width:35%;"><asp:TextBox ID="tbPost_T" CssClass="form-control" runat="server"></asp:TextBox></td>
                                <td style="width:15%;" class="text-right">手机号码：</td>
                                <td style="width:35%;"><asp:TextBox ID="tbPhone_T" CssClass="form-control" runat="server"></asp:TextBox></td>
                            </tr>
                        </table>
                    </div>
                    </div>
