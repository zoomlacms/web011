<%@ page language="C#" title="发送信息" autoeventwireup="true" inherits="User.MessageSend, App_Web_ub3q0ybo" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
                ...
                <table id="TblAddMessage" width="100%" visible="true" runat="server">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:TextBox class="form-control" Style="max-width: 350px;" ID="TxtInceptUser" runat="server" Width="326px"></asp:TextBox>
                        </td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control" Style="max-width: 350px; float: left;" ID="TxtTitle" runat="server" Width="300px"> </asp:TextBox>
                <font color="red">*</font>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control" ID="EditorContent" runat="server" Rows="10" TextMode="MultiLine" Style="float: left; max-width: 99%;"></asp:TextBox>
                <font color="red">*</font>
