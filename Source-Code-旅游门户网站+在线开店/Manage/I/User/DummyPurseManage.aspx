<%@ page language="C#" autoeventwireup="true" inherits="manage_User_DummyPurseManage, App_Web_2wb0azx5" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="UserPDiv" runat="server">
        <table class="table table-striped table-bordered table-hover">
            <tr class="text-center">
                <td colspan="2"><asp:Label ID="Lbl_t" runat="server" Text="会员虚拟币操作"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 20%" class="text-right">会员虚拟币：</td>
                <td><asp:Label ID="lblExp" runat="server" Text=""></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 20%" class="text-right">虚拟币操作：</td>
                <td>
            ...
            <tr>
                <td style="width: 20%" class="text-right">虚拟币：</td>
                <td>
