<%@ page language="C#" autoeventwireup="true" inherits="manage_User_JobsGuide, App_Web_pwpbtctt" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div id="Guide_box">
          ...
          <div class="guide">
            <ul>
              ...
              <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"> <a href="../User/JobsRecycler.aspx?modeid=qiye" target="main_right"><%=lang.LF("回收站")%></a> </li>
            </ul>
          </div>
        </div>
      </li>
