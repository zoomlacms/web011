<%@ page language="C#" autoeventwireup="true" inherits="manage_User_JobsConfig, App_Web_ub3q0ybo" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <tbody id="Tabss">
      ...
      <tr>
        ...
        <td width="75%" align="left" height="24">&nbsp;
          <asp:DropDownList ID="userlist" runat="server" CssClass="form-control"> </asp:DropDownList></td>
      </tr>
      <tr>
        <td width="25%" align="left" style="height: 24px"> 企业会员组：</td>
        <td width="75%" align="left" style="height: 24px">&nbsp;
          <asp:DropDownList ID="comlist" runat="server" CssClass="form-control"> </asp:DropDownList></td>
      </tr>
      <tr>
        <td height="24" width="25%" align="left"> 个人会员简历模型：</td>
        <td height="24" width="75%" align="left">&nbsp;
          <asp:DropDownList ID="Resume" runat="server" CssClass="form-control"> </asp:DropDownList>
          &nbsp;<font color="red">用于判断用户信息是否是简历</font></td>
      </tr>
      <tr>
        <td height="24" width="25%" align="left"> 企业信息模型：</td>
        <td height="24" width="75%" align="left">&nbsp;
          <asp:DropDownList ID="Company" runat="server" OnSelectedIndexChanged="Company_SelectedIndexChanged" AutoPostBack="True" CssClass="form-control"> </asp:DropDownList>
          &nbsp;<font color="red">用于判断用户信息是否是企业信息</font></td>
      </tr>
      <tr>
        <td height="24" width="25%" align="left"> 企业信息显示字段：</td>
        <td height="24" width="75%" align="left">&nbsp;
          <asp:DropDownList ID="CompanyField" runat="server" CssClass="form-control"> </asp:DropDownList>
          &nbsp;<font color="red">用于显示企业信息的名称</font></td>
      </tr>
      <tr>
        <td height="24" width="25%" align="left"> 招聘信息模型：</td>
        <td height="24" width="75%" align="left">&nbsp;
          <asp:DropDownList ID="CompanyJobs" runat="server" OnSelectedIndexChanged="CompanyJobs_SelectedIndexChanged" AutoPostBack="True" CssClass="form-control"> </asp:DropDownList>
          &nbsp;<font color="red">用于判断用户信息是否是企业信息招聘信息</font></td>
      </tr>
      <tr>
        <td height="24" width="25%" align="left"> 招聘信息职位字段：</td>
        <td height="24" width="75%" align="left">&nbsp;
          <asp:DropDownList ID="JobsField" runat="server" CssClass="form-control"> </asp:DropDownList>
      ...
      <tr>
        ...
        <td height="24" width="75%" align="left"> 每次查看新的简历收费
          <asp:TextBox ID="TxtConsumePoint" runat="server" Columns="5" class="form-control" >0</asp:TextBox>
