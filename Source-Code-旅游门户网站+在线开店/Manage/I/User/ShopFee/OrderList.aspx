<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.OrderList, App_Web_arehvaem" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<asp:Content runat="server" ContentPlaceHolderID="head">
    <title>订单列表</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <asp:HiddenField runat="server" ID="LblLocation_Hid" />
    <table class="table table-striped table-bordered table-hover">
        <tr class="tdbg">
            <td>
                ...
                <div class="input-group nav_searchDiv" style="margin-top: 0;">
        ...
        <tbody id="Tbody1">
            ...
            <asp:Repeater ID="Orderlisttable" runat="server">
                <ItemTemplate>
                    <tr id="<%#Eval("id") %>" ondblclick="getinfo(this.id)">
                        ...
                        <td height="24" align="center">
                            <a href="###" onclick='javascript:window.open("../Common/Extra.aspx?OrderID=<%#Eval("id")%>","","width=600,height=450,resizable=0,scrollbars=yes");'>其他费用</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
            ...
            <tr>
                <td height="24" colspan="13">
                    ...
                    <asp:Button ID="Button1" class="btn btn-primary" Text="删除订单" runat="server" OnClick="Button1_Click1" OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" />*说明：“已结清”与“已付款”的订单不允许删除,当订单号码成“灰色”代表此订单已“作废”
                </td>
            </tr>
        </tbody>
    </table>
