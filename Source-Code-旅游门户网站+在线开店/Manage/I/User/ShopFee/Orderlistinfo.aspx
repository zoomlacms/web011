<%@ page language="C#" autoeventwireup="true" inherits="User_Shopfee_Orderlistinfo, App_Web_arehvaem" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody id="Tbody2">
            ...
            <asp:Repeater ID="procart" runat="server" OnItemDataBound="cartinfo_ItemDataBound">
                <ItemTemplate>
                    <tr class="tdbg" <%#(Eval("Bindpro","{0}")=="")?"":"style=background-color:#E6E6E6"%>>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <tr class="tdbg" style="background-color: #F6F6F6;">
                                <td height="24" align="center">
                                    <%#getproimg(Eval("id","{0}"))%>
                                </td>
                                <td align="center">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="50%" align="left" style="height: 19px">
                                ...
                                +
                                <asp:Label ID="Label30" runat="server" Text=""></asp:Label>＝<asp:Label ID="Label31" runat="server" Text=""></asp:Label>元
                            </td>
            ...
            <tr class="tdbg">
                <td height="24" colspan="10">
                    <font color="red"><asp:Label ID="Label33" runat="server" Text=""></asp:Label></font>
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tr>
            ...
            <asp:Button ID="Button1"  runat="server" Text="成功付款" Enabled="false" OnClientClick="return confirm('确定要修改付款状态吗？');"  onclick="Button1_Click" class="btn btn-primary" />
            </td>
        </tr>
    </table><br />
    <!--endprint-->
        ...
        <tbody id="Tbody4">
            ...
            <tr class="tdbg">
                <td width="25%" rowspan="3">
                    <asp:Button ID="Button4" runat="server" Text="确认订单" Width="100px" OnClick="Button4_Click" class="btn btn-primary" /><br />
                    <asp:Button ID="Button5" runat="server" Text="取消确认" Width="100px" OnClick="Button5_Click" class="btn btn-primary" /><br />
                    <asp:Button ID="Button3" runat="server" Text="发货" Width="100px" OnClick="Button3_Click" class="btn btn-primary" />
                </td>
                <td width="25%" rowspan="3">
                    <asp:Button ID="Button2" runat="server" Text="已经支付" Width="100px" OnClick="Button2_Click" class="btn btn-primary" /><br />
                    <asp:Button ID="Button7" runat="server" Text="客户已签收" Width="100px" OnClick="Button7_Click" class="btn btn-primary" /><br />
                    <asp:Button ID="Button6" runat="server" Text="订单作废" Width="100px" OnClick="Button6_Click" class="btn btn-primary" />
                </td>
                <td width="25%" rowspan="3">
                    <asp:Button ID="Button13" runat="server" Text="暂停处理" Width="100px" OnClick="Button13_Click" class="btn btn-primary" /><br />
                    <asp:Button ID="Button14" runat="server" Text="恢复正常" Width="100px" OnClick="Button14_Click" class="btn btn-primary" /><br />
                    <asp:Button ID="Button12" runat="server" Text="删除订单" Width="100px" OnClick="Button12_Click" class="btn btn-primary" />
                </td>
                <td width="25%" rowspan="3" valign="top">
                    <asp:Button ID="Button9" runat="server" Text="结清订单" Width="100px" OnClick="Button9_Click"  class="btn btn-primary" /><br />
                    <asp:Button ID="Button15" runat="server" Text="打印订单" Width="100px" OnClientClick="preview();return false;" class="btn btn-primary" /><br />
                </td>
            </tr>
            <tr class="tdbg">
            </tr>
