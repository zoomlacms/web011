<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddMailTemp, App_Web_pwpbtctt" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td style="text-align: left">
                <textarea id="TxtContent" class="form-control" rows="10" runat="server"></textarea>
