<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserSitePermission, App_Web_ub3q0ybo" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  <table class="table table-striped table-bordered table-hover">
    <tr >
      <td height="26" colspan="2"><strong>设置<%=Username %>会员权限</strong></td>
    </tr>
    <asp:ScriptManager ID="ScriptManager1" runat="server"> </asp:ScriptManager>
 <%--   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      <ContentTemplate>--%>
        <tr class="tdbg">
          <td height="24" class="tdbgleft" style="width: 237px"><strong>启用权限生效：</strong></td>
          <td height="24"><asp:RadioButtonList ID="rbl" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rbl_SelectedIndexChanged">
        ...
        <tbody id="tdPermission" runat="server">
          <tr>
            <td colspan="2" align="center"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
          ...
          <tr class="tdbg">
            <td height="24" class="tdbgleft" style="width: 137px"><strong>使用时段浏览：</strong></td>
            <td height="24"><asp:RadioButtonList ID="rblTime" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rblTime_SelectedIndexChanged">
                <asp:ListItem Selected="True" Value="1">是</asp:ListItem>
                <asp:ListItem Value="0">否</asp:ListItem>
              </asp:RadioButtonList></td>
          </tr>
          <tr runat="server"  id="trTime">
            <td height="24" class="tdbgleft" style="width: 137px"><strong>浏览时间：</strong></td>
            <td height="24"><table cellspacing="1" cellpadding="0" width="100%" border="0">
                <tr style="height: 1px">
          ...
          <tr class="tdbg">
            <td height="24" class="tdbgleft" style="width: 137px"><strong>允许内容浏览：</strong></td>
            <td  style="height: 24px; width:80%"><asp:RadioButtonList ID="ViewContent" runat="server" RepeatDirection="Horizontal">
                <asp:ListItem Selected="True" Value="1">开放</asp:ListItem>
                <asp:ListItem Value="0">关闭</asp:ListItem>
              </asp:RadioButtonList></td>
          </tr>
          <tr class="tdbg">
            <td class="tdbgleft" style="height: 24px; width: 20%;"><strong>允许列表浏览：</strong></td>
            <td style="height: 24px; width:80%"><asp:RadioButtonList ID="ListContent" runat="server" RepeatDirection="Horizontal">
                <asp:ListItem Selected="True" Value="1">开放</asp:ListItem>
                <asp:ListItem Value="0">关闭</asp:ListItem>
              </asp:RadioButtonList></td>
          </tr>
          <tr class="tdbg">
            <td height="24" class="tdbgleft" style="width: 137px"><strong>允许新增发布：</strong></td>
            <td style="height: 24px; width:80%"><asp:RadioButtonList ID="AddContent" runat="server" RepeatDirection="Horizontal">
                <asp:ListItem Selected="True" Value="1">开放</asp:ListItem>
                <asp:ListItem Value="0">关闭</asp:ListItem>
              </asp:RadioButtonList></td>
          </tr>
          <tr class="tdbg">
            <td height="24" class="tdbgleft" style="width: 137px"><strong>允许编辑修改：</strong></td>
            <td style="height: 24px; width:80%"><asp:RadioButtonList ID="ModefiyContent" runat="server" RepeatDirection="Horizontal">
                <asp:ListItem Selected="True" Value="1">开放</asp:ListItem>
                <asp:ListItem Value="0">关闭</asp:ListItem>
              </asp:RadioButtonList></td>
          </tr>
          <tr class="tdbg">
            <td height="24" class="tdbgleft" style="width: 137px"><strong>允许删除内容：</strong></td>
            <td style="height: 24px; width:80%"><asp:RadioButtonList ID="DeleteContent" runat="server" RepeatDirection="Horizontal">
                <asp:ListItem Selected="True" Value="1">开放</asp:ListItem>
                <asp:ListItem Value="0">关闭</asp:ListItem>
              </asp:RadioButtonList></td>
          </tr>
          <tr class="tdbg">
            <td height="24" class="tdbgleft" style="width: 137px"><strong>允许评论权限：</strong></td>
            <td style="height: 24px; width:80%"><asp:RadioButtonList ID="AddComm" runat="server" RepeatDirection="Horizontal">
                <asp:ListItem Selected="True" Value="1">开放</asp:ListItem>
                <asp:ListItem Value="0">关闭</asp:ListItem>
              </asp:RadioButtonList></td>
          </tr>
...
<%--      </ContentTemplate>
    ...
    <tr class="tdbg">
      <td height="26" colspan="2" class="tdbgleft" align="center"><asp:HiddenField ID="txtID" runat="server" />
        <asp:Button ID="Button1" runat="server" Text="提 交" OnClick="Button1_Click" class="btn btn-primary"/>
        <asp:Button ID="Button2" runat="server" Text="返回列表" OnClientClick="location.href='UserManage.aspx';return false;" class="btn btn-primary"/></td>
    </tr>
  </table>
</asp:Content>
