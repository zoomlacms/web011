<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.ADZone, App_Web_0t1uxiqn" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="TxtZoneName" class="form-control" runat="server" MaxLength="100" TextMode="SingleLine"></asp:TextBox>&nbsp;*
        ...
        <tr>
            ...
            <td align="left" style="color: red; height: 24px;">
                <asp:TextBox ID="TxtZoneJSName" class="form-control" runat="server" EnableViewState="False" MaxLength="100" TextMode="singleLine"></asp:TextBox>
                &nbsp;*
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="TxtZoneIntro" class="form-control" runat="server" EnableViewState="False" Height="63px" MaxLength="255" TextMode="multiline" Width="280px"></asp:TextBox>
            </td>
        </tr>
        <tr>
                            ...
                            <td>
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td>弹出方式： </td>
                                        <td>
                                            <asp:DropDownList ID="DropPopType" CssClass="form-control" Width="150" runat="server">
                                    ...
                                    <tr>
                                        <td>弹出位置： </td>
                                        <td>
                                            <asp:DropDownList ID="DropPopPosition" CssClass="form-control" Width="150" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtPopLeft" CssClass="form-control" runat="server" Text="100" MaxLength="4" TextMode="SingleLine" Width="80" /></td>
                                    </tr>
                                    <tr>
                                        <td><span id="PopTop">上</span>： </td>
                                        <td>
                                            <asp:TextBox ID="TxtPopTop" CssClass="form-control" runat="server" Text="100" MaxLength="4" TextMode="singleLine" Width="80" /></td>
                                    </tr>
                                    <tr>
                                        <td>时间间隔： </td>
                                        <td>
                            ...
                            <td>
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td>广告位置： </td>
                                        <td>
                                            <asp:DropDownList ID="DropMovePosition" CssClass="form-control" Width="150" runat="server">
                                                <asp:ListItem Value="1" Text="左上" Selected="true"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="左下"></asp:ListItem>
                                                <asp:ListItem Value="3" Text="右上"></asp:ListItem>
                                                <asp:ListItem Value="4" Text="右下"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtMoveLeft" CssClass="form-control" MaxLength="4" Width="80" Text="15" TextMode="singleLine" runat="server" /></td>
                                    </tr>
                                    <tr>
                                        <td><span id="MoveTop">上</span>： </td>
                                        <td>
                                            <asp:TextBox ID="TxtMoveTop" CssClass="form-control" MaxLength="4" Width="80" Text="200" TextMode="singleLine" runat="server" /></td>
                                    </tr>
                                    <tr>
                                        <td>移动平滑度： </td>
                                        <td>
                                            <asp:TextBox ID="TxtMoveDelay" CssClass="form-control" MaxLength="7" Text="0.015" TextMode="singleLine" runat="server" Width="80" />
                                            （取值在0.001至1之间） 
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>关闭标签的颜色： </td>
                                        <td>
                                            <asp:TextBox ID="TxtMoveCloseFontColor" class="form-control" runat="server"></asp:TextBox>
                            ...
                            <td>
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td>广告位置： </td>
                                        <td>
                                            <asp:DropDownList ID="DropFixedPosition" CssClass="form-control" Width="150" runat="server">
                                                <asp:ListItem Value="1" Text="左上" Selected="true"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="左下"></asp:ListItem>
                                                <asp:ListItem Value="3" Text="右上"></asp:ListItem>
                                                <asp:ListItem Value="4" Text="右下"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtFixedLeft" CssClass="form-control" MaxLength="4" Text="100" TextMode="singleLine" runat="server" Width="80" /></td>
                                    </tr>
                                    <tr>
                                        <td><span id="FixedTop">上</span>： </td>
                                        <td>
                                            <asp:TextBox ID="TxtFixedTop" CssClass="form-control" MaxLength="4" Text="100" TextMode="singleLine" Width="80" runat="server" /></td>
                                    </tr>
                                    <tr>
                                        <td>是否显示关闭标签： </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>关闭标签的颜色： </td>
                                        <td>
                                            <asp:TextBox ID="TxtFixedCloseFontColor" class="form-control" runat="server"></asp:TextBox>
                                            <img src="/images/<%=string.IsNullOrEmpty(TxtMoveCloseFontColor.Text) ? "rectNoColor.gif" : "rect.gif" %>"
                            ...
                            <td>
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td>漂浮类型： </td>
                                        <td>
                                            <asp:DropDownList ID="DropFloatType" CssClass="form-control" Width="150" runat="server">
                                    ...
                                    <tr>
                                        <td>开始位置： </td>
                                        <td>
                                            <asp:DropDownList ID="DropFloatPosition" CssClass="form-control" Width="150" runat="server">
                                                <asp:ListItem Value="1" Text="左上" Selected="true"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="左下"></asp:ListItem>
                                                <asp:ListItem Value="3" Text="右上"></asp:ListItem>
                                                <asp:ListItem Value="4" Text="右下"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtFloatLeft" CssClass="form-control" MaxLength="4" Text="100" TextMode="singleLine" Width="80" runat="server" /></td>
                                    </tr>
                                    <tr>
                                        <td><span id="FloatTop">上</span>： </td>
                                        <td>
                                            <asp:TextBox ID="TxtFloatTop" CssClass="form-control" MaxLength="4" Text="100" TextMode="singleLine" Width="80" runat="server" /></td>
                                    </tr>
                                    <tr>
                                        <td>是否显示关闭标签： </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>关闭标签的颜色： </td>
                                        <td>
                                            <asp:TextBox ID="TxtFloatCloseFontColor" class="form-control" runat="server"></asp:TextBox>
                                      <img src="/images/<%=string.IsNullOrEmpty(TxtMoveCloseFontColor.Text) ? "rectNoColor.gif" : "rect.gif" %>"
                            ...
                            <td>
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td>左右边距： </td>
                                        <td>
                                            <asp:TextBox ID="TxtCoupletLeft" CssClass="form-control" MaxLength="4" Width="80" Text="15" TextMode="singleLine" runat="server" /></td>
                                    </tr>
                                    <tr>
                                        <td>上边距： </td>
                                        <td>
                                            <asp:TextBox ID="TxtCoupletTop" CssClass="form-control" MaxLength="4" Width="80" Text="200" TextMode="singleLine" runat="server" /></td>
                                    </tr>
                                    <tr>
                                        <td>移动平滑度： </td>
                                        <td>
                                            <asp:TextBox ID="TxtCoupletDelay" CssClass="form-control" MaxLength="7" Text="0.015" TextMode="singleLine" runat="server" Width="80" />
                                            （取值在0.001至1之间） </td>
                                    </tr>
                                    <tr>
                                        <td>是否显示关闭标签： </td>
                                    ...
                                    <tr>
                                        <td>关闭标签的颜色： </td>
                                        <td>
                                            <asp:TextBox ID="TxtCoupletCloseFontColor" CssClass="form-control" runat="server" Width="100"></asp:TextBox>
                                            <img src="/images/<%=string.IsNullOrEmpty(TxtMoveCloseFontColor.Text) ? "rectNoColor.gif" : "rect.gif" %>"
        ...
        <tr>
            ...
            <td align="left">
                <table>
                    <tr>
                        <td>
                            <asp:DropDownList ID="DropAdZoneSize" CssClass="form-control" runat="server" AutoPostBack="false" EnableViewState="False">
                    ...
                    <tr>
                        <td style="width: 226px; height: 22px;">
                            宽度：<asp:TextBox ID="TxtZoneWidth" runat="server" CssClass="form-control" MaxLength="4" Text="468" TextMode="singleLine" Width="80"></asp:TextBox><br />
                            高度：<asp:TextBox ID="TxtZoneHeight" CssClass="form-control" runat="server" MaxLength="4" Text="60" TextMode="singleLine" Width="80"></asp:TextBox></td>
                    </tr>
                </table>
            </td>
        </tr>
