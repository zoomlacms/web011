<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_BkAlter, App_Web_5ay3adzg" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <table class="table table-striped table-bordered table-hover">
            <tr >
                ...
                <td>
                    <asp:TextBox runat="server" CssClass="form-control" TextMode="MultiLine" ID="code" name="message" Width="500"></asp:TextBox>
                </td>
            </tr>
            <tr>
