<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_CommentNodeTree, App_Web_rsvfdmb3" clientidmode="Static" %>
    <div id="nodeNav" style="padding:0 0 0 0;">
        <div class="input-group">
            <asp:TextBox runat="server" ID="keyText" class="form-control" placeholder="请输入需要搜索的内容" />
