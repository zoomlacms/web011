<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_SPwd, App_Web_rsvfdmb3" %>
...
<div class="pop_box panel panel-primary " style="width: 350px;margin:auto;" runat="server" id="nospwd_div" visible="false">
 <div class="panel-heading">二级密码验证</div>
    <div class="panel-body" style="text-align:center;">
        ...
        <a href="http://www.zoomla.cn/search/SearchList.aspx?keyword=%E4%BA%8C%E7%BA%A7%E9%AA%8C%E8%AF%81%E7%A0%81&ButtonSo=%E6%90%9C++%E7%B4%A2" class="btn btn-primary" title="点击前往" target="_blank">点击前往</a>
    </div>
</div>
