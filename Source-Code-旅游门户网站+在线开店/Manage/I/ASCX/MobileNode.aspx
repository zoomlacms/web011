<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_MobileNode, App_Web_rsvfdmb3" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        ...
        <style type="text/css">
            ...
            .glyphicon{margin-left:20px;font-size:2em}
        </style>
