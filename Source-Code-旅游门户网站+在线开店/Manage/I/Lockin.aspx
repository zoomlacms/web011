<%@ page language="C#" autoeventwireup="true" inherits="manage_Lockin, App_Web_hwcrmowh" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>解锁</title>
...
<style type="text/css">
body { font-size: 12px; }
#lock { height: 100%; background: url(/Install/images/bg.jpg) no-repeat; color: #1C6297; text-align: center; padding-top: 170px; padding-bottom: 200px; width: 100%;  z-index: 10001; }
...
<div style="margin-top: 200px;">
	...
	<asp:Button ID="btn" runat="server" Text="提交" OnClick="btn_Click1" Style="display: none;" />
</div>
</form>
</body>
</html>
