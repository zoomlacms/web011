<%@ page language="C#" autoeventwireup="true" inherits="manage_Flex_EditModelxml, App_Web_vpp5mt5c" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tr>
            <td>
                <div style="float: left; width: 100%;">
                    <input type="button" class="btn btn-primary" style="width: 110px;" value='  新建编辑区域  ' id="btnNew" title="新建图片区域" onclick="newMap()">
                    <input type="button" class="btn btn-primary" style="width: 110px;" value='  新建文字区域  ' id="Button1" title="新建文字区域" onclick="newtxtMap()">
                    <input type="button" class="btn btn-primary" style="width: 110px;" value='  新建模板区域  ' id="Button4" title="新建模板区域" onclick="newMBMap()">
                </div>
                <div style="float: left; width: 100%; height: 20px"></div>
                <div style="float: left; width: 100%;">
                    <asp:Button ID="Button5" class="btn btn-primary" runat="server" Text="上一步" OnClick="Button5_Click" />
                    <asp:Button ID="Button2" class="btn btn-primary" runat="server" Text="确 定" OnClientClick="getconent();return false;" />
