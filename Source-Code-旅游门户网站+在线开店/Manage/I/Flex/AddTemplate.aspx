<%@ page language="C#" autoeventwireup="true" inherits="manage_Flex_AddTemplate, App_Web_aljadfmd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
     <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td  style="text-align: left; width: 60%;">
                <asp:TextBox ID="Mu_BackImg2" CssClass="form-control" runat="server" Width="290px"></asp:TextBox>
