<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddJsPic, App_Web_gqexlk3x" clientidmode="Static" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="table table-striped table-bordered table-hover" align="center">
	...
	<tr>
		...
		<td>
			<asp:DropDownList ID="SpecialID" runat="server" CssClass="form-control pull-left" Width="270">
			</asp:DropDownList>
		</td>
	</tr>
	<tr>
...
<center>
<asp:Button ID="Button1" runat="server" Text="修改保存结果" CssClass="btn btn-primary" OnClick="Button1_Click" />
