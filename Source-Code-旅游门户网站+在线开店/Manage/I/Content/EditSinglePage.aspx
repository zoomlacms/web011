<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_EditSinglePage, App_Web_pyrhy5wd" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover" style="margin: 0 auto;">
                <tbody>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td align="left">
                            <asp:DropDownList ID="TxtSinglepageTemplate" runat="server" CssClass="form-control pull-left" Style="max-width: 300px;"></asp:DropDownList>
                            <input type="button" value="选择模板" class="btn btn-primary" style="margin-left: 5px;" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText=' + escape('TxtSinglepageTemplate') + '&FilesDir=', 650, 480)" />
                            <asp:Button ID="BtnEdit" class="btn btn-primary" Text="编辑" OnClick="BtnEdit_Click" runat="server" />
                        </td>
                    </tr>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        <td style="width: 288px" class="tdbgleft">
