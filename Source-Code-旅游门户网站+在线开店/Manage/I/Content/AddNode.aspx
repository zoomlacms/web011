<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_AddNode, App_Web_pyrhy5wd" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
		...
		<table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<asp:DropDownList ID="ClickTimeout" CssClass="form-control" style="max-width:150px;" runat="server">
				...
				<tr>
					...
					<td>
						<asp:TextBox ID="TxtHitsOfHot" class="form-control" style="max-width:150px;" runat="server" Columns="5">0</asp:TextBox>
				...
				<tr>
					...
					<td>
						<asp:DropDownList ID="ddlState" CssClass="form-control" style="max-width:150px;" runat="server"></asp:DropDownList>
					</td>
				</tr>
				<tr>
					<td style="width: 288px"">
					...
					<td>是否开启：<input id="Checkbox1" type="checkbox" onclick="gogo();" />
					</td>
				</tr>
		...
		<table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input name="ConsumeType" runat="server" value="0" type="radio" checked="true" />不重复收费<div class="clearfix"></div>
						<span class="pull-left" style="line-height:32px;margin-right:5px;"><input id="Radio1" name="ConsumeType" runat="server" value="1" type="radio" />距离上次收费时间</span>
						...
						<span class="pull-left" style="line-height:32px;margin-right:5px;"><input id="Radio2" name="ConsumeType" runat="server" value="2" type="radio" />会员重复阅读此文章</span>
						...
						<input id="Radio3" name="ConsumeType" runat="server" value="3" type="radio" />上述两者都满足时重新收费<div class="clearfix"></div>
						<input id="Radio4" name="ConsumeType" runat="server" value="4" type="radio" />上述两者任一个满足时就重新收费<div class="clearfix"></div>
						<input id="Radio5" name="ConsumeType" runat="server" value="5" type="radio" />每阅读一次就重复收费一次（建议不要使用）<div class="clearfix"></div>
					</td>
				</tr>
				<tr>
					<td>
			...
			<tbody>
				<tr>
					...
					<td onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						<asp:DropDownList ID="TxtIndexTemplate" EnableViewState="false" DataTextField="rname" DataValueField="rname" runat="server" CssClass=" form-control pull-left" style="max-width:300px;"></asp:DropDownList>
						<input type="button" value="手工绑定" class="btn btn-primary" style="width: 100px;" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtIndexTemplate')+'&FilesDir=',650,480)" />
						<asp:Button ID="BtnEdit1" Text="编辑" class="btn btn-primary" OnClick="BtnEdit1_Click" runat="server" />
					</td>
				</tr>
				<tr>
					<td style="width: 288px"">
					...
					<td>
						<asp:DropDownList ID="TxtTemplate" EnableViewState="false" DataTextField="rname" DataValueField="rname" runat="server" CssClass=" form-control pull-left" style="max-width:300px;"></asp:DropDownList>
						<input type="button" value="手工绑定" class="btn btn-primary" style="width: 100px;" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtTemplate')+'&FilesDir=',650,480)" />
						<asp:Button ID="BtnEdit2" Text="编辑" class="btn btn-primary" OnClick="BtnEdit2_Click" runat="server" />
					</td>
				</tr>
				<tr>
					<td style="width: 288px"">
					...
					<td>
						<asp:DropDownList ID="LastinfoTemplate" EnableViewState="false" DataTextField="rname" DataValueField="rname" runat="server" CssClass=" form-control pull-left" style="max-width:300px;"></asp:DropDownList>
						<input type="button" value="手工绑定 " class="btn btn-primary" style="width: 100px;" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('LastinfoTemplate')+'&FilesDir=',650,480)" />
						<asp:Button ID="BtnEdit3" Text="编辑" class="btn btn-primary" OnClick="BtnEdit3_Click" runat="server" />
					</td>
				</tr>
				<tr>
					<td style="width: 288px"">
					...
					<td>
						<asp:DropDownList ID="HotinfoTemplate" EnableViewState="false" DataTextField="rname" DataValueField="rname" runat="server" CssClass=" form-control pull-left" style="max-width:300px;"></asp:DropDownList>
						<%# Eval("GroupName")%>
						<input type="button" value="手工绑定" class="btn btn-primary" style="width: 100px;" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('HotinfoTemplate')+'&FilesDir=',650,480)" />
						<asp:Button ID="BtnEdit4" Text="编辑" class="btn btn-primary" OnClick="BtnEdit4_Click" runat="server" />
					</td>
				</tr>
				<tr>
					<td style="width: 288px"">
					...
					<td>
						<asp:DropDownList ID="ProposeTemplate" EnableViewState="false" DataTextField="rname" DataValueField="rname" runat="server" CssClass=" form-control pull-left" style="max-width:300px;"></asp:DropDownList>
						<%# Eval("GroupName")%>
						<input type="button" value="手工绑定" class="btn btn-primary" style="width: 100px;" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('ProposeTemplate')+'&FilesDir=',650,480)" />
						<asp:Button ID="BtnEdit5" Text="编辑" class="btn btn-primary" OnClick="BtnEdit5_Click" runat="server" />
					</td>
				</tr>
				<tr>
					<td style="width: 288px"">
							...
							<asp:Repeater ID="Repeater1" runat="server">
								<ItemTemplate>
									<tr class="tdbg">
										...
										<td>
											<input type="text" class="form-control pull-left" style="max-width:300px;" name="TxtModelTemplate_<%# Eval("ModelID") %>" id="TxtModelTemplate_<%# Eval("ModelID")%>" value="<%# GetTemplate(Eval("ModelID","{0}")) %>" maxlength="255" />
											<input type="button" value="手工绑定" class="btn btn-primary" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtModelTemplate_<%# Eval("ModelID") %>    ')+'&FilesDir=',650,480)" />
											<input type="button" class="btn btn-primary" name="Button31" value="编辑" onclick="javascript:location.href='../Template/TemplateEdit.aspx?filepath=/<%#GetTemplateurl(Eval("ModelID","{0}")) %>    '" id="Button3" />
										</td>
									</tr>
								</ItemTemplate>
							</asp:Repeater>
...
{
	var v=$("#TxtNodeDir").val()+":"+$("#HdnNodeID").val();
