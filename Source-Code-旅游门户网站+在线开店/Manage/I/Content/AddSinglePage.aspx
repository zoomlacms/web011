<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_AddSinglePage, App_Web_pyrhy5wd" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover" style="margin: 0 auto;">
                <tbody>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td align="left">
                            <asp:DropDownList ID="TxtSinglepageTemplate" runat="server" class="form-control pull-left" style="max-width:300px;"></asp:DropDownList>
                            ...
                            <asp:Button ID="BtnEdit" Text="编辑" class="btn btn-primary" OnClick="BtnEdit_Click" runat="server" />
                        </td>
                    </tr>
                    <tr class="tdbg">
                        <td style="width: 288px" class="tdbgleft">
