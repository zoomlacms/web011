<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_EditNode, App_Web_gqexlk3x" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeName" Style="max-width: 200px;" CssClass="form-control pull-left" runat="server"  onblur="CheckNodeName();"/>
            ...
            <table class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtHitsOfHot" class="form-control" Style="max-width: 150px;" runat="server">0</asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownList1" CssClass="form-control pull-left" Style="max-width: 150px;" runat="server"></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="pull-left" style="line-height: 32px; margin-right: 5px;">
                                <input id="Radio2" name="ConsumeType" runat="server" value="1" type="radio" />距离上次收费时间</span>
                            ...
                            <span class="pull-left" style="line-height: 32px; margin-right: 5px;">
                                <input id="Radio3" name="ConsumeType" runat="server" value="2" type="radio" />会员重复阅读此文章</span>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtIndexTemplate')+'&FilesDir=',650,480)" class="btn btn-primary" />
                            <asp:Button ID="Button1" class="btn btn-primary" runat="server" OnClick="Button1_Click" Text="编辑" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtTemplate')+'&FilesDir=',650,480)" class="btn btn-primary" />
                            <asp:Button ID="Button2" runat="server" class="btn btn-primary" Text="编辑" OnClick="Button2_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 288px">
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('LastinfoTemplate')+'&FilesDir=',650,480)" class="btn btn-primary" />
                            <asp:Button ID="Button3" class="btn btn-primary" runat="server" Text="编辑" OnClick="Button3_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 288px">
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('HotinfoTemplate')+'&FilesDir=',650,480)" class="btn btn-primary" />
                            <asp:Button ID="Button4" class="btn btn-primary" runat="server" Text="编辑" OnClick="Button4_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 288px">
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('ProposeTemplate')+'&FilesDir=',650,480)" class="btn btn-primary" />
                            <asp:Button ID="Button5" class="btn btn-primary" runat="server" Text="编辑" OnClick="Button5_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="Egv" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="RoleID" Width="100%">
                                <Columns>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="GroupID">
                                <Columns>
