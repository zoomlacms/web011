<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_InfoLog, App_Web_x2m1jeiy" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <asp:TextBox runat="server" ID="EndTime_T" Style="float: left;" onclick="WdatePicker()" Width="150px" CssClass=" form-control" placeholder="结束时间"></asp:TextBox>
        ...
        <div class="input-group" style="width: 220px; float: left;">
            ...
            <span class="input-group-btn">
                <asp:LinkButton runat="server" CssClass="btn btn-default" OnClick="souchok_Click" ID="souchok_B"><span class="glyphicon glyphicon-search"></span></asp:LinkButton>
            </span>
        </div>
    </div>
