<%@ page language="C#" autoeventwireup="true" inherits="manage_Counter_Os, App_Web_xsr52llx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<div id="divMain" style="height: 100%;">
	<div class="r_navigation">后台管理 &gt;&gt; 扩展功能 &gt;&gt; <a href="Counter.aspx">访问统计</a>&gt;&gt; 操作系统统计报表</div>
        <table class="tables" bordercolor="#6595d6" cellspacing="0" cellpadding="2" width="97%" align="center">
            <tr class="title_link">
