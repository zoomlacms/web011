<%@ page language="C#" autoeventwireup="true" inherits="manage_CallStat_PageLeft, App_Web_xsr52llx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title><%=lang.LF("统计菜单")%></title>
...
<ul>
    <li id="Guide_top">
      <div id="Guide_toptext"><%=lang.LF("访问统计")%></div>
    </li>
    <li id="Guide_main">
        <div id="Guide_box">                
            <div class="guideexpand" onclick="Switch(this)"><%=lang.LF("访问统计")%></div>
            <div class="guide">
            <ul>                        
                ...
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/Counter.aspx" target="main_right"><%=lang.LF("统计导航")%></a></li>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/Ip.aspx" target="main_right"><%=lang.LF("总访问统计")%></a></li>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/Month.aspx" target="main_right"><%=lang.LF("日访问统计")%></a></li>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/Year.aspx" target="main_right"><%=lang.LF("月访问统计")%></a></li>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/Local.aspx" target="main_right"><%=lang.LF("地区访问统计")%></a></li>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/Browser.aspx" target="main_right"><%=lang.LF("浏览器访问统计")%></a></li>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/Os.aspx" target="main_right"><%=lang.LF("操作系统访问统计")%></a></li>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/Site.aspx" target="main_right"><%=lang.LF("访问渠道统计")%></a></li>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../i/Counter/CodeReference.aspx" target="main_right"><%=lang.LF("统计代码调用")%></a></li>
            </ul>
            </div>
        </div>
    </li>
