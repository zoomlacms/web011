<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_DomTempMange, App_Web_5arvbvnz" masterpagefile="~/Manage/Site/OptionMaster.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="pageContent">
    <div id="m_site"><p style="float:left;"> 站群中心 >> 域名管理 >> 模板管理</p></div>
    <div id="site_main" style="margin-top:15px;">
     <div id="tab3">
         <asp:TextBox runat="server" ID="searchText" CssClass="site_input" /><asp:Button runat="server" ID="searchBtn" Text="搜索" CssClass="site_button"/>
