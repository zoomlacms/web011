<%@ page language="C#" autoeventwireup="true" inherits="User_Magazine_AddMagazine, App_Web_0szrwwq1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html >
<head runat="server">
<title>我的电子杂志</title>
...
<asp:TextBox ID="TxtMagName" runat="server" BorderColor="#fff" CssClass="l_inpnon"></asp:TextBox>
<asp:Button ID="BntSearch" runat="server" Text="" OnClick="BntSearch_Click" class="C_sch"/>
        </td></tr></table>
