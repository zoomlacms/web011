<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.ModifyPassword, App_Web_hgre3m2j" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div>
    <table class="table table-bordered table-hover">
      ...
      <tr>
        ...
        <td><asp:TextBox ID="TxtOldPassword" class="form-control" runat="server" TextMode="Password" onkeydown="return GetEnterCode('focus','TxtPassword');"/>
      ...
      <tr>
        ...
        <td><asp:TextBox ID="TxtPassword" class="form-control" runat="server" TextMode="Password" onkeydown="return GetEnterCode('focus','TxtPassword2');"/>
      ...
      <tr>
        ...
        <td><asp:TextBox ID="TxtPassword2" class="form-control" runat="server" TextMode="Password" />
      ...
      <tr>
        <td colspan="2" class="text-center"><asp:Button ID="BtnSubmit" runat="server" class="btn btn-primary" Text="修改" OnClick="BtnSubmit_Click" />
          &nbsp;&nbsp;
