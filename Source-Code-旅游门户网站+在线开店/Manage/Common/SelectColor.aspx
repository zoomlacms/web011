...
<SCRIPT event=onclick for=Ok language=JavaScript>
	...
	if ( !document.all )	{
		...
		opener.document.getElementById(id).value = t.bgColor;	
		//opener.document.getElementById("spanbgcolor").bgColor= "Blue";
		window.close();
	}else{
	    //alert(window.opener.document.getElementById("nodename"));
		//alert(opener.document.getElementById("spanbgcolor").innerText);
        //parent.document.getElementById("spanbgcolor").style.background= "Blue";
  ...
  <TABLE border=0 cellPadding=0 cellSpacing=10>
   <TBODY>
    <TR>
     ...
     <TD>
      <TABLE border=0 cellPadding=0 cellSpacing=0 id="ColorTable" style="CURSOR: pointer">
        <SCRIPT language=JavaScript>
          function wc(r, g, b, n){
     ...
     <TD>
      <TABLE border=0 cellPadding=0 cellSpacing=0 id="GrayTable" style="CURSOR: pointer">
