<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="ZoomLa.WebSite.Manage.Template.TemplateList, App_Web_fx1qjkh2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <table style="width: 100%; height: 100%" border="0" cellpadding="2" cellspacing="0"
            ...
            <tr style="height: 100%; width: 100%">                    
                <td class="tdbg" align="left" valign="top" colspan="3" style="width: 70%;">
                    <iframe id="main_right" name="main_right" scrolling="yes" style="width: 100%;height:420px;" src="SelectTemplate.aspx<%:Request.Url.Query %>" frameborder="0" marginheight="0" marginwidth="1"></iframe>
                </td>
            </tr>
