<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableviewstatemac="false" inherits="ZoomLa.WebSite.Manage.Template.TemplateEdit, App_Web_fx1qjkh2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
.spanfixdiv  {  background-color: #FFFBF5;   border: 1px solid #F6B9D6;  text-align: center; overflow: hidden;  cursor: pointer;   height: 20px; margin: 4px; }
.spanfixdivchechk  { background-color: #FFFBF5;  border: 1px solid #F6B9D6;  text-align: center;  overflow: hidden; cursor: pointer;   height: 20px; margin: 4px 4px 4px 0px;   float: left; width: 75%; overflow: hidden;  }
.editdiv {  text-align: center;  overflow: hidden; cursor: pointer;  height: 20px;  margin: 6px 0px 4px 2px; float: left;  width: 12%; }
#fixdiv {   margin: 7px; }
.nodefixdiv { background-color: #FFFBF5;border: 1px solid #F6B9D6;text-align: center;overflow: hidden;cursor: pointer; padding: 2px;height: 20px;}
.alertspandiv{background-color: #FFEBE5;border: 1px solid #F6B9D6;text-align: center;text-valign: middle;padding: 2px;height: 30px;width: 100px;}
#I1{height: 31px;width: 99%;}
</style>
<script type="text/javascript">
    var start = 0, end = 0;
    var x, y;
        ...
        <tr class="tdbg">
            ...
            <td height="435x" align="left">
                <iframe style="height: 30px; width: 530px; z-index: -1;" frameborder="0" name="I1"
                    id="I1" scrolling="no" src="/manage/Template/label.htm"></iframe>
                <div id="Textarea">
                    <asp:TextBox TextMode="MultiLine" runat="server" ID="textContent" Style="border: solid 1px #8EC1EE;width:100%;height:435px;" ></asp:TextBox>
                </div>
            </td>
        </tr>
        <tr class="tdbg">
            <td align="left" colspan="2">
                <div style="float: left; padding-left: 250px">
                    ...
                    <asp:Button ID="btnReset" Class="C_input" runat="server" Text="恢复模板" OnClick="btnReset_Click" UseSubmitBehavior="false"/>&nbsp;&nbsp;&nbsp;
                </div>
