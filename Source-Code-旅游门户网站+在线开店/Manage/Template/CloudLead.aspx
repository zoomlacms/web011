<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="manage_Template_CloudLead, App_Web_fx1qjkh2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>网站云台</title>
...
<form id="form1" runat="server">
 ...
 <%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <div class="metro_con" > 
      <span class="panel_tui" ><a href="TemplateSetOfficial.aspx" class="btn_tui" target="_self"> </a></span>
      <span class="panel_btn" > <a href="#TB_inline?height=200&amp;width=500&amp;inlineId=hidCont&amp;modal=true" class="btn_demo thickbox"   >使用前必读</a> <a title="获取网站云" href="TemplateSetOfficial.aspx" class="btn_demo">获取网站云</a> </span> <img src="../../App_Themes/AdminDefaultTheme/images/tem_ban.jpg" alt=""/> </div>
