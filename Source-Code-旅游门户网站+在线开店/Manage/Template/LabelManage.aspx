<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Template.LabelManage, App_Web_y2h1z5ds" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
  ...
  <%} %> 后台管理&gt;&gt;系统设置 &gt;&gt;<a href="LabelManage.aspx">标签管理</a>&gt;&gt;<a href="LabelExport.aspx" style="color:#f00;">[从旧版标签升级]</a>
    </div>
    </div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border">
        <tr class="tdbg">
            <td align="left">
                ...
                <div id="toolbar1" style="display:none;margin-left:8px;"> 
