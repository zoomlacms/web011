<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_QuestionManage, App_Web_t5ucd4kq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>系统试题管理</title>
...
<div class="r_navigation"><%if(GetOpenHelp.IsopenHelp()=="1")
    { %>
      <div id="help"> <a onclick="help_show('84')" title="帮助"></a></div>
  <%} %>后台管理 &gt;&gt; 扩展功能 &gt;&gt; <a href="QuestionManage.aspx">系统试题管理</a> <a href="AddQuestion.aspx?Operation=Add" style="color:red;">[添加试题]</a></div>
    <table style="width: 100%; margin: 0 auto; margin-top: 5px;" cellpadding="0" cellspacing="0"
        class="border" id="tb1" runat="server">
        <tr class="tdbg">
