<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_Question_AddQuestion, App_Web_t5ucd4kq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt;<a href="QuestionManage.aspx">试题管理</a>
        ...
        <tr class="tdbgbottom">
            <td colspan="2">
                <asp:Button ID="EBtnSubmit" class="C_input" Text="保存试题" OnClick="EBtnSubmit_Click"
                    runat="server" />
                &nbsp;
                <asp:Button ID="BtnBack" class="C_input" runat="server" Text="返回列表" OnClick="BtnBack_Click"
