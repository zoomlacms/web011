<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_QuestionsView, App_Web_t5ucd4kq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt;&nbsp;<span>扩展功能</span>&nbsp;&gt;&gt; &nbsp;<span><a href="QuestionManage.aspx">试题管理</a></span>&nbsp;&gt;&gt; &nbsp;<span>浏览试题</span>
        </div>
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        ...
        <tbody  id="Tabs0">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                    <asp:Label ID="Label1" runat="server" Text="所属试卷："></asp:Label>
                    &nbsp;
                </td>
                <td class="bqright">
        ...
        <tr class="tdbgbottom">
            <td colspan="2">
               <asp:Button ID="ABtnSubmit" class="C_input" Text="添加试题" runat="server" 
