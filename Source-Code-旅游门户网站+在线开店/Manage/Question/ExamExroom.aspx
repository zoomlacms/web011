<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ExamManage, App_Web_t5ucd4kq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div style="text-align: center">
        <div class="r_navigation">
            ...
            <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span>在线考试系统</span> &gt;&gt; <span>考场管理</span> <a href="AddExamExroom.aspx">[添加考场]</a>
        </div>
    </div>
    <div class="clearbox">
    </div>
