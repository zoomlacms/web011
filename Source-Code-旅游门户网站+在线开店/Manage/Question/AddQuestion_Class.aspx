<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_AddQuestion_Class, App_Web_t5ucd4kq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt;<a href="Question_Class_Manage.aspx">分类管理</a>
        &gt;&gt;<span>
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td class="bqright">
                <asp:TextBox ID="txtC_OrderBy" Width="60" class="l_input" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr class="tdbgbottom">
            <td colspan="2">
