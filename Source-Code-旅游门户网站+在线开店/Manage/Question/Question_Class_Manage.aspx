<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Question_Class_Manage, App_Web_t5ucd4kq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>分类管理</title>
...
<div class="r_navigation">后台管理 &gt;&gt;扩展功能&gt;&gt;分类管理&nbsp;<a href="AddQuestion_Class.aspx?menu=Add&C_id=0" style="color:red;">[添加分类组]</a>
</div>
                ...
                <table border="0" cellpadding="5" cellspacing="1" class="border" width="100%" align="center">
                    <tr class="spacingtitle">
                        ...
                        <td align="right" width="50%">
                            <input id="Button1" type="button" onclick="location.href='Questions_Knowledge_Show.aspx?c_id=<%#Eval("C_id") %>'"
                                value="管理知识点" class="C_input" />
