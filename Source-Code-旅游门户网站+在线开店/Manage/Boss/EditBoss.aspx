<%@ page language="C#" autoeventwireup="true" inherits="manage_Boss_EditBoss, App_Web_j35pxvnd" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<tr>
	<td align="center">                
		...
		<asp:Button ID="EBtnSubmit" Text="修改" runat="server" 
			onclick="EBtnSubmit_Click" CssClass="C_input" />&nbsp; &nbsp;
		<input name="Cancel" type="button"  Class="C_input"id="BtnCancel" value="取消" onclick="window.location.href='Bosstree.aspx'" />                
	</td>
</tr>
</table>
</form>
