<%@ page language="C#" autoeventwireup="true" inherits="manage_Boss_BossInfo, App_Web_j35pxvnd" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
   ...
   后台管理&nbsp;&gt;&gt;&nbsp;系统设置&nbsp;&gt;&gt;加盟商管理 </div>
    ...
    <div style="background:#c7e0f6">
        <div style="display:none" >
        <asp:HiddenField ID="HiddenNode" runat="server" />
         <asp:HiddenField ID="HiddenPnode" runat="server" /></div>
