<%@ page language="C#" autoeventwireup="true" inherits="manage_Flex_UserUpload, App_Web_okru51ob" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html >
<head runat="server">
<title>上传图片</title>
...
<form id="form1" runat="server">
    <div style=" margin-top:-10px; background:#e8f5ff;" >
