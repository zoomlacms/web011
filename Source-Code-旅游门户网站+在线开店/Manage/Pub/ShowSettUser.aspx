<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_ShowSettUser, App_Web_bfm3gvdt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title><%=Call.SiteName%>-查看达标用户</title>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
	...
	<tr>
		<td align="left" colspan="9">
			<asp:Button ID="EBtnSubmit" runat="server" Text="批量删除" class="C_input" OnClick="EBtnSubmit_Click" OnClientClick="return confirm('你确定要将所有选择删除吗？');" />
