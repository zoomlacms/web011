<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_BidConfig, App_Web_bfm3gvdt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="nav_box">
<div class="r_navigation">后台管理 &gt;&gt; 互动管理 &gt;&gt; <a href="BidConfig.aspx">竞标管理</a>&gt;&gt;<a href="BidConfig.aspx">竞标参数设置</a></div>
</div>
<div class="h_27"></div>
...
<table width="100%" cellspacing="1" cellpadding="0" class="border">
	<tr class="tdbg">
        <td align="left" colspan="2" style="height: 30px;">
            ...
            设置为<b>中标者</b>的方法：SetBid.aspx?menu=Succ&Userid=中标者用户ID&ContentID=内容ID<br /><br />
            <b>取消</b>设置为<b>达标者</b>的方法：SetBid.aspx?menu=NoComp&Userid=达标者用户ID&ContentID=内容ID<br />
            <b>取消</b>设置为<b>中标者</b>的方法：SetBid.aspx?menu=NoSucc&Userid=中标者用户ID&ContentID=内容ID<br /><br />
