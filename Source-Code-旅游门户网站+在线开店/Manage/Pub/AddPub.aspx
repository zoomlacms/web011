<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_AddPub, App_Web_bfm3gvdt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt;内容管理&gt;&gt;互动模块管理 &gt;&gt;添加信息</div>
	...
	<table style="width: 100%; margin: 0 auto; margin-top: 5px;" cellpadding="0" cellspacing="0"
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td>
				<asp:TextBox ID="tx_PubContent" runat="server" class="l_input" Height="107px" TextMode="MultiLine"	Width="456px"></asp:TextBox>
			</td>
		</tr>
