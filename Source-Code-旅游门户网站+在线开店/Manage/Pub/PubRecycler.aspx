<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_PubRecycler, App_Web_bfm3gvdt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
		...
		<ItemTemplate>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'  "onmouseout="this.className='tdbg'" id="<%#Eval("Pubid") %>" ondblclick="getinfo(this.id )" >
				...
				<td align="center" height="24" width="25%">
					...
					<a href="pubinfo.aspx?menu=edit&id=<%#Eval("Pubid")%>">修改</a> <a href="pubinfo.aspx?menu=Truedelete&id=<%#Eval("Pubid")%>" onclick="return confirm('确实要彻底删除吗？');">彻底删除</a>
				</td>
			</tr>
		</ItemTemplate>
	</asp:Repeater>
