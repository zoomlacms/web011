<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_PubUpdateModelField, App_Web_bfm3gvdt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt; 内容管理 &gt;&gt; <a href="pubModel.aspx">互动模型管理</a>&gt;&gt; <a href="PubModelField.aspx?ModelId=<%= MID %>">字段列表</a>&gt;&gt; 修改[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段</div>
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="Alias" class="l_input" runat="server" MaxLength="20"></asp:TextBox><font
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="Name" class="l_input" MaxLength="50" runat="server"></asp:TextBox><font
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="Tips" class="l_input" MaxLength="50" runat="server"></asp:TextBox><span class="tips">显示在字段别名下方作为重要提示的文字</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
             ...
             <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">回复时显示：<br />
                    
                    </td>
                    <td>
                    <asp:RadioButtonList ID="RestoreField" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Value="1">是</asp:ListItem>
                        <asp:ListItem Selected="0" Value="False">否</asp:ListItem>
                    </asp:RadioButtonList>
                    &nbsp;<span style="color: #808000">管理员后台回复信息时显示</span>
                    </td>
                </tr>
            </tbody>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <tbody id="DivMultipleHtmlType" style="display:none" runat="server">
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">显示的宽度：</td>
                    <td><asp:TextBox ID="MultipleHtmlType_Width" runat="server" class="l_input" Columns="10" MaxLength="4">715</asp:TextBox>px</td>
                </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">显示的高度：</td>
            ...
            <tbody id="DivOptionType" style="display:none" runat="server">
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
                    ...
                    <td><input id="Button3" type="button" value="从数据字典中选择选项" class="C_input" onclick="SelectDictionary('RadioType_Content')" /><input 
                        id="Button5" type="button" class="C_input" value="添加数据字段" onclick='SubPage("RadioType_Content")' /><br />
                        <asp:TextBox ID="RadioType_Content" runat="server" TextMode="MultiLine" 
                            Columns="40" Rows="6" class="l_input" Height="60px" Width="344px"></asp:TextBox> <span style="color: red">*</span></td>
                </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">默认值：</td>
                    <td><asp:TextBox ID="RadioType_Default" runat="server" class="l_input"></asp:TextBox> 注：没有数据录入的默认值，与前台显示无关.</td>
                </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <tbody id="DivListBoxType" style="display:none" runat="server">
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td><input id="Button4" type="button" value="从数据字典中选择选项" class="C_input" onclick="SelectDictionary('ListBoxType_Content')" /><input 
                       ...
                       <asp:TextBox ID="ListBoxType_Content" 
                            class="l_input" runat="server" TextMode="MultiLine" Columns="40" Rows="6" 
                            Height="59px" Width="339px"></asp:TextBox> <span style="color: red">*</span></td>
                </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">显示选项：</td>
            ...
            <tbody id="DivFileType" style="display:none" runat="server">
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">
                        允许上传的文件大小：</td>
                    <td>
                        <asp:TextBox ID="TxtMaxFileSize" class="l_input" runat="server" Columns=5>1024</asp:TextBox>KB <span style="color: blue">
                            提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
                </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">
                        允许上传的文件类型：</td>
                    <td>
                        <asp:TextBox ID="TxtUploadFileType" class="l_input" runat="server" Columns="30"></asp:TextBox> <span style="color: red">*</span>
                    <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span></td>
                </tr>
            </tbody>
            <!--  运行平台    -->
            <tbody id="DivOperatingType" style="display:none" runat="server">
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">分行键入&nbsp;&nbsp;<br />
                        每个平台选项：</td>
                    <td>
                        <asp:TextBox ID="TxtOperatingOption" runat="server" class="l_input" 
                            TextMode="MultiLine" Columns="40" Rows="6" Height="60px"></asp:TextBox> <span style="color: red">*</span> <span style="color: blue">注：一行一个默认项</span></td>
                </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">文本框长度：</td>
            ...
            <tbody id="DivNumType" style="display:none" runat="server">
                ...
                <td>
                    <asp:TextBox ID="txtdecimal" runat="server" Text="0" class="l_input"></asp:TextBox>
                </td>
            </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft">默认值：</td>
                            ...
                            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                <td>
                                    <asp:TextBox ID="NumSearchRange" class="l_input" runat="server" 
                                        TextMode="MultiLine" Columns="40" Rows="6" Height="78px"></asp:TextBox><br />                                    
                                </td>
                                <td>
        ...
        <tbody id="DivColorType" style="display: none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    ...
                    <asp:TextBox ID="ColorDefault" runat="server" class="l_input"  MaxLength="7"  Columns="7" style="font-size: 9pt; height: 15px;"></asp:TextBox>
            ...
            <tr class="tdbg">
                ...
                <td height="50">
                    <asp:Button ID="Button1" class="C_input" runat="server" Text=" 修改字段 "  OnClientClick="return isok()" OnClick="Button1_Click" />
                    &nbsp;&nbsp;
                    <asp:Button ID="BtnBack" runat="server" class="C_input"  Text="返回字段列表" OnClick="BtnBack_Click" UseSubmitBehavior="False" CausesValidation="False" />
