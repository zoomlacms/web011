<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_Bidmanage, App_Web_bfm3gvdt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="nav_box">
<div class="r_navigation">后台管理 &gt;&gt; 互动管理 &gt;&gt; 竞标管理 &gt;&gt;<a href="Settlement.aspx">竞标结算</a></div>
</div>
<div class="h_30"></div>
    <table width="100%" cellspacing="1" cellpadding="0" class="border" >
        <tr class="tdbg">
            <td align="bottom" colspan="8" >
                ...
                <table  cellpadding="2" border="0" cellspacing="1" style="background:#fff; margin-left:5px;" class="l_input">
                    <tr >
                        <td> 
                            <asp:TextBox ID="keyword" runat="server"  BorderColor="#fff" CssClass="l_inpnon"></asp:TextBox>
                            <asp:Button ID="Button2" runat="server" Text="" class="C_sch" onclick="Button1_Click" />
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr class="tdbg" align="center" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" style="height: 25px;">
                        <td>
                            <input name="Item" <%#(Eval("IsBid","{0}")=="1" || Eval("IsBid","{0}")=="3")?"disabled":"" %> type="checkbox" value="<%#Eval("GeneralID")%>" />
                        </td>
                        <td>
                            <strong><%# Eval("GeneralID")%></strong>
                        </td>
                        <td align="left">
                            <a href="###" onclick="open_title3(<%# Eval("GeneralID")%>,<%# Eval("ModelID")%>)"><%# Eval("title") %></a>
                        </td>
                        <td align="center">
                            <%#Eval("BidMoney","{0:F2}")%>
                        </td>
                        <td>
                            <a href="###" onclick="open_title2(<%#Eval("SuccessfulUserID", "{0}") %>)"><%#GetUsername(Eval("SuccessfulUserID", "{0}"))%></a>
                        </td>
                        <td align="center">
                            <%#Getlist(Eval("ComplianceUserList", "{0}"), Eval("GeneralID", "{0}"))%>
                        </td>
                        <td>
                            <a href="###" onclick="open_title2(<%#GetUserID(Eval("Inputer", "{0}")) %>)"><%#Eval("Inputer")%></a>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <a href="###" onclick="open_title(<%#Eval("GeneralID")%>)">修改</a> <a href="?menu=gonull&id=<%#Eval("GeneralID") %>" onclick="return confirm('确实要取消竞标吗?');">取消竞标</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
