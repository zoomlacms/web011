<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_AddSettlement, App_Web_bfm3gvdt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加结算</title>
    ...
    <table width="100%" cellspacing="1" cellpadding="0" class="border">
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:Button ID="Button1" runat="server" Text="返 回"  OnClientClick="parentDialog.close();return false;" class="C_input"  onclick="Button1_Click" />
            </td>
        </tr>
    </table>
    </form>
