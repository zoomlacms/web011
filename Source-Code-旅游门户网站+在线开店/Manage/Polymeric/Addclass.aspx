<%@ page language="C#" autoeventwireup="true" inherits="manage_Polymeric_Addclass, App_Web_34r4jbde" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; <span>分类管理</span> &gt;&gt; <span>添加分类</span>
    </div>
    <div class="clearbox">
    </div>
