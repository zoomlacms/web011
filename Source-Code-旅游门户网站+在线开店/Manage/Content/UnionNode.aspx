<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.UnionNode, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="border">
	...
	<tr class="tdbg">
		<td valign="top" align="center" class="tdbg">
			<span style="color: Red">提示：源节点</span><br /><br />
			...
			<table>
				<tr>
					<td align="center" class="tdbg">
						<span style="color: Red">提示：目标节点</span><br /><br />
	...
	<tr align="center">
		<td colspan="3" class="tdbgleft">
			<asp:Button ID="EBtnBacthSet" Text="合并节点" class="C_input" Style="width: 110px;" OnClick="EBtnBacthSet_Click" runat="server" OnClientClick="return confirm('此操作不可逆，你确定合并节点吗？')" />&nbsp;&nbsp;
            <asp:Button ID="Button1" Text="迁移节点" class="C_input" Style="width: 110px;" runat="server" OnClick="Button1_Click" OnClientClick="return confirm('此操作不可逆，你确定迁移节点吗？')" />
		</td>
	</tr>
</table>
</form>
