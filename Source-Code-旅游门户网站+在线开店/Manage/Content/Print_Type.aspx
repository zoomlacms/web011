<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.Print_Type, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="r_navigation">
  ...
  <%} %><span><%=lang.LF("后台管理")%></span> &gt;&gt; <span><%=lang.LF("内容管理")%></span> &gt;&gt; <span><%=lang.LF("打印输出")%></span> &gt;&gt;
	<span><%=lang.LF("类型模板设置")%></span>&nbsp; [<a href="addPrintType.aspx" style="color: Red"><%=lang.LF("添加类型模板")%></a>]&nbsp;[<a
		href="PrintMaskList.aspx" style="color: Red"><%=lang.LF("遮罩库")%></a>]
</div>
    <div class="clearbox">
    </div>
    <div>
