<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddAuditingState, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>审核状态</title>
...
<table style="text-align:center; width:100%">
	...
	<tbody class="tdbg">
		<tr>
			...
			<td align="left">
				<asp:DropDownList ID="ddlStateCode" runat="server" DataSourceID="odsStateCode"></asp:DropDownList>
