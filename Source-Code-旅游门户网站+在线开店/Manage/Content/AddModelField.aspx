<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddModelField, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <%} %>后台管理&nbsp;&gt;&gt;&nbsp;系统设置&nbsp;&gt;&gt;&nbsp;<a href="ModelManage.aspx?ModelType=<%=Request.QueryString["ModelType"] %>"><%=bll.GetModelType(Convert.ToInt32(Request.QueryString["ModelType"]))%></a>&nbsp;&gt;&gt;&nbsp;<a href="ModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>&ModelType=<%=Request.QueryString["ModelType"] %>">字段列表</a>&nbsp;&gt;&gt;&nbsp;<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>&nbsp;&nbsp;当前表:<asp:Label ID="Label1" runat="server" Text=""></asp:Label>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:RadioButtonList ID="IsChain" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Value="True">是</asp:ListItem>
                    <asp:ListItem Selected="true" Value="False">否</asp:ListItem>
                </asp:RadioButtonList>
            </td>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" style="">
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            <td>
                                <asp:TextBox ID="DateSearchRang" CssClass="l_input" runat="server" TextMode="MultiLine" Columns="40" Rows="6" Height="78px" Width="248px" Visible="false"></asp:TextBox>
        ...
        <tbody runat="server" id="DivPicType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtSPicSize" CssClass="l_input" runat="server" Columns="5" Text="1024"></asp:TextBox>KB
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtPicExt" CssClass="l_input" Text="jpg|png|gif|bmp|jpeg" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody runat="server" id="DivMultiPicType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtPicSize" CssClass="l_input" runat="server" Columns="5" Text="1024"></asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span>
                    <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TextImageType" CssClass="l_input" Text="jpg|png|gif|bmp|jpeg" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
...
<!--  图片入库    -->
        <tbody runat="server"  id="DivSqlType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtMaxPicSize" CssClass="l_input" runat="server" Columns="5" Text="1024"></asp:TextBox>KB
                    <span style="color: blue">提示：仅支持2005及更高SQL Server版本
</span>
                    <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtPicSqlType" CssClass="l_input" Text="jpg|png|gif|bmp|jpeg" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody> 
        ...
        <tbody runat="server"  id="DivSqlFile" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtMSqlFileSize" CssClass="l_input" runat="server" Columns="5" Text="1024"></asp:TextBox>KB
                    <span style="color: blue">提示：仅支持2005及更高SQL Server版本
</span>
                    <span style="color: red">*</span>
                </td>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtSqlFiletext" CssClass="l_input" Text="rar|zip|docx|pdf" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：rar|zip|doc|docx等等</span>
                </td>
            </tr>
        </tbody>
        <!--  文件类型    -->
        <tbody runat="server" id="DivSmallFileType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtMaxFileSizes" CssClass="l_input" runat="server" Columns="5" Text="1024"></asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span>
                    <span style="color: red">*</span>
                </td>
            </tr>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileTypes" CssClass="l_input" Text="rar|zip|docx|pdf" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody runat="server" id="DivPullFileType" style="display:none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="PullFileText" CssClass="l_input" runat="server"></asp:TextBox><span style="color: Blue">填写图片存储的路径如：UploadFiles/demo</span>
                </td>
            </tr>
         </tbody>
        <!--  多文件类型    -->
        <tbody runat="server" id="DivFileType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:CheckBox ID="ChkFileSize" runat="server" Text="是否保存文件大小" Checked="false" /><br />
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtMaxFileSize" CssClass="l_input" runat="server" Columns="5" Text="1024"></asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span>
                    <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileType" CssClass="l_input" Text="rar|zip|docx|pdf" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span>
        ...
        <tbody runat="server" id="DivOperatingType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="OperatingType_DefaultValue" Text="Win2000|XP|Win2003" CssClass="l_input" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody runat="server" id="DivUpload" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TextBox3" CssClass="l_input" Text="doc|docx|txt|pdf|xls|xlsx" runat="server" Columns="30"></asp:TextBox>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileType1" CssClass="l_input" Text="rar|jpg|gif|bmp" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span>
                    <span style="color: Blue">注：允许多个类型请用"|"号分割，如：rar|jpg|gif|bmp 等等</span>
                </td>
            </tr>
        ...
        <tbody runat="server" id="DivRemoteFile" style="display: none">
           <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileType2" CssClass="l_input" Text="rar|jpg|gif|bmp" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span>
                    <span style="color: Blue">注：允许多个类型请用"|"号分割，如：rar|jpg|gif|bmp 等等</span>
                </td>
            </tr>
        ...
        <tbody id="DivTableField" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    <strong>指定表字段(Text)：</strong>
                </td>
                <td>
                    <asp:TextBox ID="TableField_Text" runat="server" /><span style="line-height: 30px;">*示例:ZL_User.UserName</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    <strong>指定表字段(Value)：</strong>
                </td>
                <td>
                    <asp:TextBox ID="TableField_Value" class="form-control pull-left" runat="server" /><span style="line-height: 30px;">提示:可为空</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                ...
                <td>
                    <asp:TextBox ID="Where_Text" class="form-control pull-left" runat="server" /><span style="line-height: 30px;">提示:可为空,Sql语法,示例:UserID<10</span>
                </td>
            </tr>
        </tbody>
        <!--------------------->
