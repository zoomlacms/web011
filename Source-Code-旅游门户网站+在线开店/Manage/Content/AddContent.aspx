<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.AddContent, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
.r_navigation #browse { float:left; margin-top:4px; margin-right:5px; display:block; width:18px;height:18px;}
...
<div class="r_navigation" style="margin-bottom:0;">
<span style="float: right;padding-right: 10px;">
    <a href="SchedTask.aspx" id="viewtask" title="查看计划任务"><img src="../../../Images/ModelIcon/taskview.gif" alt="" /></a>
    <%=GetOper()%>
    <a onclick="opentitle('EditNode.aspx?NodeID=<%=this.NodeID %>','配置本节点')" href="javascript:void(0);" title="配置本节点"><%=lang.LF("配置本节点")%></a>
</span> 
后台管理&nbsp;&gt;&gt;&nbsp;<a href="ContentManage.aspx">内容管理</a>&nbsp;&gt;&gt;&nbsp;<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>&nbsp;&gt;&gt;&nbsp;添加内容</div>
    <asp:Label ID="Label1" CssClass="spacingtitle" Width="100%" runat="server" Text="Label"></asp:Label>
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        <tbody id="Tabs0">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="tdbg">
                    <asp:TextBox ID="txtTitle" CssClass="l_input"  onblur="getstrKeys()" onkeyup="isgoEmpty('txtTitle','span_txtTitle');Getpy('txtTitle','PYtitle')" runat="server" Text='' MaxLength="255" Style="width: 41%; background-image: url(/Images/bg.gif); font-family: 宋体"></asp:TextBox>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="Subtitle" runat="server"  Width="41%" Height="22px" CssClass="l_input" MaxLength="255"></asp:TextBox>
                </td>
            </tr>
            <asp:Literal ID="ModelHtml" runat="server"></asp:Literal>
            <tr class="tdbg" id="attPic" runat="server">
        ...
        <tbody id="Tabs1" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtdate" runat="server" Text="" onClick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" CssClass="l_input"></asp:TextBox>
					<!-- onclick="calendar('txtdate');parent.document.getElementById('main_right').height = document.body.offsetHeight+400;"
        ...
        <tbody id="Tabs2" style="display: none">
            ...
            <tr class="tdbg" id="contentsk" runat="server" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:RadioButtonList ID="ddlFlow" runat="server" RepeatDirection="Horizontal" RepeatColumns="5"></asp:RadioButtonList>
                </td>
            </tr>
        </tbody>
        ...
        <tr class="">
            <td colspan="2">
               ...
               <input type="button" class="C_input" id="Editdown" name="Editdown" value="编辑下一项" onclick="ShowTable()" />--%>
                ...
                <asp:Button ID="EBtnSubmit" CssClass="C_input cinput" Text="添加项目" OnClick="EBtnSubmit_Click" runat="server" />
          &nbsp;<asp:Button ID="Button6" CssClass="C_input cinput" runat="server" OnClick="Button6_Click" Text="存为草稿" />
          &nbsp;<asp:Button ID="BtnDoc" CssClass="C_input cinput" runat="server" OnClientClick="return generate2('docTitle','docParamValue');" OnClick="BtnDoc_Click" Text="生成文档" Visible="false"/>
          &nbsp;<asp:Button ID="BtnBack" CssClass="C_input cinput" runat="server" Text="返　回" OnClick="BtnBack_Click" UseSubmitBehavior="False" CausesValidation="False" />
    ...
    <br />
    <b style="display:block;margin-bottom:40px;">注：分页符：[PageCode/]</b>
    <script language="javascript" type="text/javascript">
...
<script type="text/javascript">
    ...
    function change(id) {
        ...
        var srcva;
        if (vas[1] == "饼状图") {
            srcva = "../Charts/pie-basic.aspx?Cid=" + cid;
        } else if (vas[1] == "线状图") {
            srcva = "../Charts/line.aspx?Cid=" + cid;
        } else {
            srcva = "../Charts/colum.aspx?Cid=" + cid;
        }
