<%@ page language="C#" autoeventwireup="true" inherits="ZommLa.WebSite.Manage.Content.EditNode, App_Web_i3fxcuwj" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
  ...
  <%} %>后台管理&gt;&gt;系统设置&gt;&gt;<a href="NodeManage.aspx">节点管理</a>&gt;&gt;编辑栏目节点
</div>
</div>
        ...
        <td valign="top" style="margin-top: 0px; margin-left: 0px;">
            ...
            <input id="EDHid" type="hidden"  value="" runat="server" />
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeName" OnTextChanged="TxtNodeName_TextChanged" class="l_input" AutoPostBack="true" runat="server" Columns="30" ></asp:TextBox>
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeDir" class="l_input" OnTextChanged="TxtNodeDir_TextChanged" MaxLength="20" runat="server" Columns="20" AutoPostBack="true" Enabled="false" ></asp:TextBox>
                            <asp:Button ID="Button6" CssClass="C_input" runat="server" Text="修改" OnClick="Button6_Click" />
                ...
                <tbody id="Tabs3" style="display: none">
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtIndexTemplate')+'&FilesDir=',650,480)" class="C_input" />
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtTemplate')+'&FilesDir=',650,480)" class="C_input" />
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('LastinfoTemplate')+'&FilesDir=',650,480)" class="C_input" />
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('HotinfoTemplate')+'&FilesDir=',650,480)" class="C_input" />
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('ProposeTemplate')+'&FilesDir=',650,480)" class="C_input" />
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td align="center">
            &nbsp; &nbsp;
            <asp:Button ID="EBtnSubmit" class="C_input" OnClientClick="EBtnS()" Text="保存" OnClick="EBtnSubmit_Click" Width="65px" runat="server" UseSubmitBehavior="false"/>&nbsp; &nbsp;
            <input name="Cancel" type="button" class="C_input" id="BtnCancel" value="取消" onclick="window.close();" />
        </td>
    </tr>
</table>
</form>
