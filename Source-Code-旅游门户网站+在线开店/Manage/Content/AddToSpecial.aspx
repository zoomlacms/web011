<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddToSpecial, App_Web_i3fxcuwj" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
	...
	<tr class="tdbg">
		<td class="bqright" align="left" colspan="2">
			...
			<input name="Cancel" type="button"  id="BtnCancel" class="C_input"  style="width:100px;"  value="取消" onclick="javascript:history.back()" />
		</td>
	</tr>
</table>
</form>
