<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.CollectionManage, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="r_navigation">
  ...
  <%} %><span><%=lang.LF("后台管理")%> </span>&gt;&gt;<span> <%=lang.LF("系统设置")%> </span>&gt;&gt; <span><a href="ContentManage.aspx"><%=lang.LF("内容管理")%> 
 </a></span>&gt;&gt; <%=lang.LF("采集项目管理")%>
</div>
<div class="clearbox">
</div>
<asp:GridView ID="Egv" runat="server" AllowPaging="True" AutoGenerateColumns="False" height="26px" DataKeyNames="CItem_ID" PageSize="20" Width="100%" OnPageIndexChanging="Egv_PageIndexChanging" OnRowDataBound="Egv_RowDataBound" CssClass="border" GridLines="None" CellPadding="2" CellSpacing="1" >
	<Columns>
