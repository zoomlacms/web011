<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddPrintType, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="r_navigation">后台管理 &gt;&gt; 内容管理 &gt;&gt; 打印输出 &gt;&gt;	<a href="Print_Type.aspx">类型设置</a> &gt;&gt; <%=type%>类型模板</div>
