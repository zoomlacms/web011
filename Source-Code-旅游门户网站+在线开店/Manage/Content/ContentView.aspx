<%@ page language="C#" autoeventwireup="true" inherits="manage_Content_ContenView, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html >
<head runat="server">
<title>查看评论</title>
...
<div style="text-align:center;"> <input id="Button1" type="button" value="返回"  class="C_input"  onclick="javascript:history.back()" /></div>
</form>
</body>
</html>