<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.FlowProcessManager, App_Web_i3fxcuwj" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>流程管理</title>
...
<div class="r_navigation">后台管理&gt;&gt;系统设置 &gt;&gt;<a href="FlowManager.aspx">流程管理</a>&gt;&gt;<span id="sp1" runat="server"></span>
</div>
