<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.CollectionInfoPage, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
					...
					<tbody id="Tabs0">
						<tr class="tdbg">
							<td class="tdbgleft">
								...
								<asp:RequiredFieldValidator ValidationGroup="aa" ID="rv1" runat="server" ErrorMessage="字段设置开始不能为空！" ControlToValidate="txtListStart"></asp:RequiredFieldValidator>
							</td>
						</tr>
						<tr class="tdbg">
							<td class="tdbgleft">
								&nbsp;<asp:TextBox ID="txtListStart" class="l_input" runat="server" TextMode="MultiLine" Width="230px" Rows="5" Height="60px"></asp:TextBox></td>
						</tr>
						<tr class="tdbg">
							<td class="tdbgleft">
								&nbsp;字段设置结束：                
								<asp:RequiredFieldValidator ValidationGroup="aa" ID="rv2" runat="server" ErrorMessage="字段设置结束不能为空！" ControlToValidate="txtListEnd"></asp:RequiredFieldValidator>
							
							</td>
						</tr>
						<tr class="tdbg">
							<td class="tdbgleft">
&nbsp;<asp:TextBox ID="txtListEnd" class="l_input" runat="server" TextMode="MultiLine" Width="230px" Rows="5" Height="60px"></asp:TextBox></td>
						</tr>
				<br />
					<tbody id="Tbody1">
						<tr class="tdbg">
						...
						<tr class="tdbg">
							<td class="style1" align="center">
								<asp:Button ValidationGroup="aa" ID="Button5" class="C_input"  style="width:110px;"  runat="server" Text="测试字段" OnClick="Button5_Click" OnClientClick="return checkList('txtListStart','txtListEnd')" />
							</td>
						</tr>
				</table>
			</td>
