<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddNodecs, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="nav_box">
<div class="r_navigation">后台管理 &gt;&gt; 系统设置 &gt;&gt; <a href="NodeManage.aspx">节点管理</a>&gt;&gt; 添加子节点
</div>
</div>
 ...
 function EBtnS() {
		...
		<tbody id="Tabs0">
			...
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				...
				<td>
					<asp:TextBox ID="TxtTips" class="l_input" runat="server" Columns="60" Height="66px" Width="500px" Rows="2" TextMode="MultiLine"></asp:TextBox>
				</td>
			</tr>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td style="width: 288px" class="tdbgleft">
				...
				<td>
					<asp:TextBox ID="TxtDescription" class="l_input" runat="server" Columns="60" Height="63px" Width="500px" Rows="2" TextMode="MultiLine"></asp:TextBox>
				</td>
			</tr>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td style="width: 288px" class="tdbgleft">
				...
				<td>
					<asp:TextBox ID="TxtMetaKeywords" class="l_input" runat="server" Height="65" Width="500" Columns="60" Rows="4" TextMode="MultiLine"></asp:TextBox>
				</td>
			</tr>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td style="width: 288px" class="tdbgleft">
				...
				<td>
					<asp:TextBox ID="TxtMetaDescription"  class="l_input" runat="server" Height="65" Width="500" Columns="60" Rows="4" TextMode="MultiLine"></asp:TextBox>
				</td>
			</tr>
		</tbody>
        <%--栏目选项--%>
		...
		<tbody id="Tabs2" style="display: none">
			...
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				...
				<td>
					...
					<input id="Radio1" name="ConsumeType" runat="server" value="1" type="radio" />距离上次收费时间
                    <asp:TextBox ID="TxtConsumeTime" class="l_input" runat="server" Columns="5">0</asp:TextBox>小时后重新收费<br />
					<input id="Radio2" name="ConsumeType" runat="server" value="2" type="radio" />会员重复阅读此文章
		...
		<tbody id="Tabs3" style="display: none">
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				...
				<td onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
					...
					<input type="button" value="手工绑定" class="C_input"  style="width:100px;" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtIndexTemplate')+'&FilesDir=',650,480)" />
                    <asp:Button ID="BtnEdit1" Text="编辑" class="C_input" OnClick="BtnEdit1_Click" runat="server" />
				</td>
			</tr>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td style="width: 288px" class="tdbgleft">
				...
				<td>
					...
					<input type="button" value="手工绑定"  class="C_input"  style="width:100px;"  onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtTemplate')+'&FilesDir=',650,480)" />
                    <asp:Button ID="BtnEdit2" Text="编辑" class="C_input" OnClick="BtnEdit2_Click" runat="server" />
				</td>
			</tr>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td style="width: 288px" class="tdbgleft">
				...
				<td>
					...
					<input type="button" value="手工绑定 " class="C_input"  style="width:100px;"  onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('LastinfoTemplate')+'&FilesDir=',650,480)" />
                    <asp:Button ID="BtnEdit3" Text="编辑" class="C_input" OnClick="BtnEdit3_Click" runat="server" />
				</td>
			</tr>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td style="width: 288px" class="tdbgleft">
				...
				<td>
					...
					<%# Eval("GroupName")%>
					<input type="button" value="手工绑定" class="C_input"  style="width:100px;"  onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('HotinfoTemplate')+'&FilesDir=',650,480)" />
                    <asp:Button ID="BtnEdit4" Text="编辑" class="C_input" OnClick="BtnEdit4_Click" runat="server" />
				</td>
			</tr>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td style="width: 288px" class="tdbgleft">
				...
				<td>
					...
					<%# Eval("GroupName")%>
					<input type="button" value="手工绑定" class="C_input"  style="width:100px;"  onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('ProposeTemplate')+'&FilesDir=',650,480)" />
                    <asp:Button ID="BtnEdit5" Text="编辑" class="C_input" OnClick="BtnEdit5_Click" runat="server" />
				</td>
			</tr>
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td style="width: 288px" class="tdbgleft">
						...
						<asp:Repeater ID="Repeater1" runat="server">
							<ItemTemplate>
								<tr class="tdbg">
									...
									<td>
										<input type="text" style="width:195px;" class="l_input" name="TxtModelTemplate_<%# Eval("ModelID") %>" id="TxtModelTemplate_<%# Eval("ModelID")%>" value="<%# GetTemplate(Eval("ModelID","{0}")) %>" maxlength="255" />
								<input type="button" value="手工绑定" class="C_input" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtModelTemplate_<%# Eval("ModelID") %>')+'&FilesDir=',650,480)" />
		...
		<tbody id="Tabs5" style="display: none">
			...
			<tr class="tdbg" id="Custom1" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				...
				<td>
					<asp:TextBox ID="TextBox1" class="l_input" runat="server" TextMode="MultiLine" Rows="5" Width="99%" Height="65px"></asp:TextBox>
				</td>
			</tr>
			<tr class="tdbg" id="Custom2" style="display: none" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				...
				<td>
					<asp:TextBox ID="TextBox2" class="l_input" runat="server" TextMode="MultiLine" Rows="5" Width="99%" Height="65px"></asp:TextBox>
				</td>
			</tr>
...
<td align="center">
	&nbsp; &nbsp;
	<asp:Button ID="EBtnSubmit" Text="保存" OnClientClick="disableBtn(this);EBtnS();" OnClick="EBtnSubmit_Click" runat="server" class="C_input" Width="65px" UseSubmitBehavior="false"/>&nbsp;
	&nbsp;
