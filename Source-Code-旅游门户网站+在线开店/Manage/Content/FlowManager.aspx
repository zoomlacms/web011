<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.FlowManager, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>流程管理</title>
...
<div class="r_navigation">
  ...
  <%} %>后台管理&gt;&gt;系统设置 &gt;&gt;<a href="FlowManager.aspx">流程管理</a></div>
