<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.SetNodeOrder, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>节点排序</title>
...
<div id="nav_box">
    <div class="r_navigation">后台管理&gt;&gt;系统设置&gt;&gt;<a href="NodeManage.aspx">节点管理</a>&gt;&gt;<asp:Literal ID="Literal1" runat="server"></asp:Literal>&gt;&gt;子节点排序
    </div>
</div>
