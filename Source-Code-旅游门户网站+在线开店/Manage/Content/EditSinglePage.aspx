<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.EditSinglePage, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt;系统设置&gt;&gt;<a href="NodeManage.aspx">节点管理</a>&gt;&gt;修改单页节点</div>
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
		...
		<td>
		  <table border="0" cellpadding="0" cellspacing="0">
			<tr align="center">
				...
				<td id="TabTitle1" class="tabtitle" onclick="ShowTabs(1)">栏目选项</td>
				<td id="TabTitle2" class="tabtitle" onclick="ShowTabs(2)">生成选项</td>
			</tr>
		</table>
</td>
	</tr>
	...
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
			<asp:TextBox ID="TxtNodeName" class="l_input" AutoPostBack="true"  runat="server" Columns="30"  ontextchanged="TxtNodeName_TextChanged" ></asp:TextBox>
			 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="标识符不能为空！" ControlToValidate="TxtNodeDir" Display="Dynamic" SetFocusOnError="True" />
		</td>
	</tr>
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		<td class="tdbgleft">
		...
		<td>
			<asp:TextBox ID="TxtNodeDir" OnTextChanged="TxtNodeDir_TextChanged" class="l_input" MaxLength="20" runat="server" Columns="20" Enabled="false" AutoPostBack="true" ></asp:TextBox>
            <asp:Button ID="Button1" runat="server" Text="修改" CssClass="C_input" OnClick="Button1_Click" />
	...
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
			<asp:TextBox ID="TxtTips" class="l_input" runat="server" Columns="60" 
				Height="60px" Width="360px" Rows="2" TextMode="MultiLine"></asp:TextBox>
		</td>
	</tr>
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		<td class="tdbgleft">
  ...
  <tbody id="Tabs1" style="display:none;">
   ...
   <tbody id="Tabs2" style="display:none;">
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td align="left">
                <asp:DropDownList ID="TxtSinglepageTemplate" runat="server" CssClass="x_input">
				</asp:DropDownList>
                <%--			<asp:TextBox ID="TxtTemplate" class="l_input" MaxLength="255" runat="server" Columns="50"></asp:TextBox>
			<input type="button" value="选择模板" class="C_input" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtTemplate')+'&FilesDir=',650,480)" class="button" />
            <input type="button" value="编辑模板" class="C_input" onclick="location.href='../Template/TemplateEdit.aspx?OpenerText='+escape('TxtTemplate')+'&filepath=<%=Server.UrlEncode(this.TxtTemplate.Text) %>    '" class="button" />--%>
			<input type="button" value="选择模板" class="C_input"  style="width:100px;"  onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtSinglepageTemplate')+ '&FilesDir=',650, 480)"/>
            <asp:Button ID="BtnEdit" class="C_input" Text="编辑" OnClick="BtnEdit_Click" runat="server" />
		</td>
	</tr>
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		<td style="width: 288px" class="tdbgleft">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td align="center">
			&nbsp; &nbsp;
			<asp:Button ID="EBtnSubmit" class="C_input" Text="保存" OnClientClick="return EBtnS()" OnClick="EBtnSubmit_Click" runat="server" />&nbsp; &nbsp;
