<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddSinglePage, App_Web_i3fxcuwj" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理 &gt;&gt; 系统设置 &gt;&gt; <a href="NodeManage.aspx">节点管理</a> &gt;&gt; 添加单页节点
    </div>
  ...
  <table border="0" cellpadding="0" cellspacing="0">
   ...
   <tbody id="Tabs0">
	 ...
	 <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
			<asp:TextBox ID="TxtNodeName" class="l_input" runat="server"  
				ontextchanged="TxtNodeName_TextChanged" onkeyup="Getpy('TxtNodeName','TxtNodeDir')" AutoPostBack="True" Columns="30" />
	...
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
            <asp:TextBox ID="TxtNodeDir" class="l_input" runat="server" AutoPostBack="True" Columns="20" MaxLength="20" OnTextChanged="TxtNodeDir_TextChanged" />
	...
	<tbody id="Tabs2" style="display:none">
     <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td align="left">
			...
			<asp:Button ID="BtnEdit" Text="编辑" class="C_input" OnClick="BtnEdit_Click" runat="server" />
		</td>
	</tr>
	 <tr class="tdbg">
		<td style="width: 288px" class="tdbgleft">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td align="center">
			&nbsp; &nbsp;
			<asp:Button ID="EBtnSubmit" Text="保存" class="C_input" OnClientClick="return ABtnS()" OnClick="EBtnSubmit_Click" runat="server" />&nbsp; &nbsp;
