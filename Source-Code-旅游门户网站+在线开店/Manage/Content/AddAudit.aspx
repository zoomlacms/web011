<%@ page language="C#" autoeventwireup="true" inherits="manage_Content_AddAudit, App_Web_zxhe1krl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>编辑预审核内容</title>
			...
			<table width="100%" cellpadding="2" cellspacing="1" style="background-color: white;">
				<tbody id="Tabs0">
					<tr class="tdbg">
						...
						<input id="Button3" type="button" value="选择节点" onclick="AddNode('link')" class="C_input" style="width: 110px;" />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="节点内容不能为空！" ControlToValidate="txtNode"></asp:RequiredFieldValidator>
					...
					<tr class="tdbg">
						<td class="tdbgleft" style="height: 26px">
						 ...
						 <td style="height: 26px;">
						   <asp:TextBox ID="txtBeginTime" runat="server" Text="" onclick="WdatePicker();" Width="20%" class="l_input"></asp:TextBox>
					...
					<tr class="tdbg">
						...
						<td style="height: 26px;">
						<asp:TextBox ID="txtEndTime" runat="server" Text=""  Width="20%" class="l_input" onclick="WdatePicker();"></asp:TextBox>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="TABLE1">
	<tr>
		<td align="left" style="height: 59px">
            ...
            <input type="button" class="C_input" name="Button2" value="返回列表" onclick="location.href='AuditManage.aspx'"	id="Button2" />
		</td>
	</tr>
</table>
</form>
