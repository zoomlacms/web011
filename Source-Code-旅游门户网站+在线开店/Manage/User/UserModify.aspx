<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserPassModify, App_Web_evybsxrg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <tbody id="Tabs0">
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td style="height: 25px;" colspan="3" align="left">
                        <asp:TextBox ID="txtHoneyName" runat="server" class="l_input"></asp:TextBox></td>
                </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft" style="width: 15%; height: 25px;" align="right">新密码： </td>
                    <td style=" height: 25px;" align="left">
                        <asp:TextBox ID="tbNewPwd" runat="server" TextMode="Password" class="l_input"></asp:TextBox>
                        如果不修改密码，请不要输入新密码和确认密码
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="密码不能少于6位" ControlToValidate="tbNewPwd" ValidationExpression="[\s\S]{6,}" ForeColor="Red"></asp:RegularExpressionValidator>
                    </td>
                    <td class="tdbgleft" style="width: 15%; height: 25px;" align="right">工号： </td>
                    <td>
                        <asp:TextBox ID="WorkNum_T" runat="server" class="l_input"></asp:TextBox>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td align="left">
                        <asp:TextBox ID="tbConPwd" runat="server" TextMode="Password" class="l_input"></asp:TextBox>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td align="left">
                        <asp:TextBox ID="tbEmail" runat="server" class="l_input"></asp:TextBox>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td align="left">
                        <asp:TextBox ID="tbQuestion" runat="server" class="l_input"></asp:TextBox></td>
                    <td class="tdbgleft" style="width: 15%; height: 22px" align="right">提示问题答案： </td>
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="tbAnswer" runat="server" class="l_input"></asp:TextBox>
                        <span style="color: red">*</span>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft" align="right">邮箱容量： </td>
                    <td align="left">
                        <asp:TextBox runat="server" ID="MailSize_T" CssClass="l_input" Width="60" />MB(提示:-1为无限制,0为读取默认配置)
                    </td>
                    <td class="tdbgleft" style="height: 22px" align="right"></td>
            ...
            <tr>
                ...
                <td colspan="4">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                            <td>
                                <tbody id="Tabs2" style="display: none" border="0" cellpadding="5" cellspacing="1">
                                    <tr class="tdbg">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">剩余资金： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtMoney" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">用户信誉值</td>
                                        <td>
                                            <asp:TextBox ID="txtUserCrite" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">点券： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtUserPoint" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">用户积分： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtPoint" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">虚拟币： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtPurm" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">用户银币：</td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtSilverCoin" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">商铺认证有效期截止： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtCerificateDeadLine" runat="server" class="l_input" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' })"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">有效期截止时间： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtDeadLine" runat="server" class="l_input" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' })"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">卖家积分： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtboffExp" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">消费积分： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="txtConsumeExp" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>

                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">签名档： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbSign" runat="server" class="l_input" TextMode="MultiLine" Width="253px"
                                ...
                                <tbody id="Tabs1" style="display: none">
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbTrueName" runat="server" class="l_input"></asp:TextBox></td>
                                    ...
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbOfficePhone" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">省市县：  </td>
                                        <td style="height: 22px" align="left">
                                            <asp:TextBox ID="tbProvince" runat="server" class="l_input" Style="width: 80px;"></asp:TextBox>
                                            -
                                            <asp:TextBox ID="tbCity" runat="server" class="l_input" Style="width: 80px;"></asp:TextBox>
                                            -
                                            <asp:TextBox ID="tbCoutry" runat="server" class="l_input" Style="width: 80px;"></asp:TextBox>
                                            地区字典：
                                        ...
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">推荐人： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbParentUserID" runat="server" class="l_input"></asp:TextBox></td>

                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">家庭电话： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbHomePhone" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">传真： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbFax" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">手机号码： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbMobile" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">小灵通： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbPHS" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">联系地址： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbAddress" runat="server" Columns="40" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">邮政编码： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbZipCode" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">身份证号码： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbIDCard" runat="server" Columns="40" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">个人主页： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbHomepage" runat="server" Columns="40" class="l_input">http://</asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">QQ号码： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbQQ" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">ICQ号码： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbICQ" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">MSN账号： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbMSN" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">雅虎通账号： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbYahoo" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">UC账号： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbUC" runat="server" class="l_input"></asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 26px;" align="right">头像地址： </td>
                                        <td style="width: 35%; height: 26px;" align="left">
                                            <asp:TextBox ID="tbUserFace" runat="server" class="l_input"></asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">头像宽度： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbFaceWidth" runat="server" class="l_input">16</asp:TextBox></td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">头像高度： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="tbFaceHeight" runat="server" class="l_input">16</asp:TextBox></td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">公司名称： </td>
                                        <td style="width: 35%; height: 22px" align="left">
                                            <asp:TextBox ID="CompanyNameT" runat="server" class="l_input" Columns="40"></asp:TextBox>
                                        </td>
                                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">公司简介： </td>
                                        <td style="width: 35%;" align="left">
                                            <asp:TextBox ID="CompanyDescribeT" runat="server" TextMode="MultiLine" Rows="4" Columns="28"></asp:TextBox>
                                        </td>
                                    </tr>
                                </tbody>
                            </td>
