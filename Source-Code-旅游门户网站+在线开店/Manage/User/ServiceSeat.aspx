<%@ page language="C#" autoeventwireup="true" inherits="manage_User_ServiceSeat, App_Web_aunhunhk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>客服信息</title>
...
<div class="r_navigation"><%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %>后台管理&gt;&gt;客服管理&gt;&gt;客服席位&nbsp;&nbsp;<a href='AddSeat.aspx'><font color="red">[添加席位]</font></a></div>
  <div>
