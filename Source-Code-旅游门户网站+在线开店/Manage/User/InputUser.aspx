<%@ page language="C#" autoeventwireup="true" inherits="manage_User_InputUser, App_Web_aunhunhk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head >
<title>导入用户</title>
...
<div class="r_navigation">后台管理&gt;&gt;用户管理&gt;&gt;会员管理&gt;&gt;<a href="InputUser.aspx">导入用户</a></div>
  ...
  状态： <asp:Label ID="Label1" runat="server" Text="导入用户"></asp:Label>
</form>
</body>
</html>