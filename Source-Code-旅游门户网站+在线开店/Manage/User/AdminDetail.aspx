<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AdminDetail, App_Web_evybsxrg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>管理员预览</title>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center">
    ...
    <tr class="tdbg">
      <td class="tdbgleft" colspan="2" style="height: 23px" align="center"><asp:Button ID="btnSubmit" class="C_input" runat="server" OnClick="btnSubmit_Click" Text="重新修改" />
        <asp:Button ID="btnAdd" runat="server" class="C_input" Text="继续添加管理员" onclick="btnAdd_Click" />
        &nbsp;
