<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserDayManage, App_Web_aunhunhk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    <tr class="tdbgleft">
      <td> 选择日期：
        ...
        <asp:TextBox ID="txtdate" runat="server" Width="150px" CssClass="l_input" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd' });"></asp:TextBox>
