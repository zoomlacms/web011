<%@ page language="C#" autoeventwireup="true" inherits="manage_Qmail_AddMail, App_Web_aunhunhk" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <div>
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
              ...
              <td><table>
                  <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td align="left"><asp:Panel ID="Panel1" Visible="false" runat="server" Width="300px" Height="20px">
                        <asp:TextBox ID="txtStartTime" onfocus="setday(this)" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });" class="l_input"></asp:TextBox>
                        ~
                        <asp:TextBox ID="txtEndTime" onfocus="setday(this)" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });" class="l_input"></asp:TextBox>
                        &nbsp;<br />
                        &nbsp;
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><textarea runat="server" id="HiddenField1" style="width:100%;height:300px;visibility:visible;" ></textarea>
            <script type="text/javascript">
                UE.getEditor('HiddenField1');
            </script>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
