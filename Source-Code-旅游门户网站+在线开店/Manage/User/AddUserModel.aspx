<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddUserModel, App_Web_aunhunhk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
        后台管理&gt;&gt;<a href="UserManage.aspx">会员管理</a> &gt;&gt;会员模型管理 &gt;&gt; <a href="SystemUserModel.aspx">
            系统会员模型字段列表</a> &gt;&gt; 添加系统会员字段
    </div>
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" style="margin: auto;">
        <tr class="tdbg">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox CssClass="l_input" ID="Alias" runat="server" MaxLength="20" onkeyup="Getpy('Alias','Name')"></asp:TextBox>
                <span style="color:#ff0066">*</span><span class="tips"> 如：标题</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
            ...
            <td>
                <asp:TextBox CssClass="l_input" ID="Name" MaxLength="50" runat="server"></asp:TextBox>
                <span style="color:#ff0066">*</span><span class="tips">字段名由字母、数字、下划线组成</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
            ...
            <td>
                <asp:TextBox CssClass="l_input" ID="Tips" MaxLength="50" runat="server"></asp:TextBox>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox CssClass="x_input" ID="Description" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox CssClass="l_input" ID="TextBox1" runat="server" Columns="10" MaxLength="4">10</asp:TextBox>
                %
            </td>
        </tr>
        ...
        <tbody id="DivTextType">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox CssClass="l_input" ID="TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox CssClass="l_input" ID="TextType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
        ...
        <tbody id="DivMultipleTextType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox CssClass="x_input" ID="MultipleTextType_Width" runat="server" Columns="10" MaxLength="4">500</asp:TextBox>
                    px
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <tbody id="DivNumType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox CssClass="l_input" ID="NumberType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
        ...
        <tr class="tdbg">
            ...
            <td style="height:50px">
                <asp:Button ID="Button1" CssClass="C_input" runat="server" Text=" 添加字段 " OnClientClick="return isok()" OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 " class="C_input" onclick="javascript:window.location.href='SystemUserModel.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'" />
