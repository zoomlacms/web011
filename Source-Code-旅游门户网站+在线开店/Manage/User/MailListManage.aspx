<%@ page language="C#" autoeventwireup="true" inherits="manage_User_MailListManage, App_Web_evybsxrg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
      ...
      <tr class="tdbg">
        ...
        <asp:Panel ID="Panel1" Visible="false" runat="server">
          <asp:TextBox class="l_input" ID="txtStartTime" onfocus="setday(this)" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" runat="server"></asp:TextBox>
          ~
          <asp:TextBox class="l_input" ID="txtEndTime" onfocus="setday(this)" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" runat="server"></asp:TextBox>
