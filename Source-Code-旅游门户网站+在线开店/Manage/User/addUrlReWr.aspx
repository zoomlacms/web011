<%@ page language="C#" autoeventwireup="true" inherits="manage_User_addUrlReWr, App_Web_aunhunhk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
.style4 { background: #e0f7e5; line-height: 120%; width: 241px; }
.style5 { background: #e0f7e5; line-height: 120%; width: 241px; height: 49px; }
.style6 { height: 49px; }
</style>
  ...
  <div>
    <table width="100%" cellpadding="2" cellspacing="1" border="0" class="r_navigation">
      ...
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="KeyName" class="l_input" runat="server" Width="240px"></asp:TextBox>
      ...
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="UrlLook" class="l_input" runat="server" Width="311px"></asp:TextBox>
          <br />
          &nbsp;&nbsp;
      ...
      <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="UrlSend" class="l_input" runat="server" Width="311px"></asp:TextBox>
          <br />
          &nbsp;&nbsp;
      ...
      <tr class="WebPart">
        ...
        <td><asp:Button ID="Button1" runat="server"  Text="　添　加　" onclick="Button1_Click" class="C_input"/>
