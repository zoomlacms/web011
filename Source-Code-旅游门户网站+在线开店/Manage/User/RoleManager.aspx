<%@ page language="C#" title="管理员角色分配" autoeventwireup="true" inherits="User.RoleManager, App_Web_aunhunhk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<style type="text/css">
    .tdbgleft {text-align:right;width:100px;}
</style>
</head>
<body>
...
<div id="nav_box">
    <div class="r_navigation">
        后台管理&gt;&gt;<a href="AdminManage.aspx">管理员管理</a>&gt;&gt;<a href="RoleManage.aspx">角色管理</a>&gt;&gt;<a href="RoleManager.aspx?ID=<%= Request.QueryString["ID"] %>">权限管理</a>
        <%if(GetOpenHelp.IsopenHelp()=="1")
        { %>
          <div id="help"> <a onclick="help_show('104')" title="帮助"></a></div>
      <%} %><div class="clear"></div>
    </div>
    ...
    <table width="100%" cellspacing="1" cellpadding="0" class="border" align="center">
        ...
        <tr class="tdbg">
            <td class="tdbgleft" colspan="2" style="height: 79px;text-align:center;">&nbsp;
                ...
                <asp:Button ID="btnBack" runat="server" Text="返回" OnClick="btnBack_Click" class="C_input"/>
            </td>
        </tr>
    </table>
