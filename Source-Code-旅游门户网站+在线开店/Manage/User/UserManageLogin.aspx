<%@ page language="C#" autoeventwireup="true" inherits="User.UserManageLogin, App_Web_aunhunhk" title="会员管理" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <table cellpadding="2" cellspacing="1" class="border" style="background-color: white;" width="100%">
    ...
    <tr class="tdbgleft">
      <td><asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
        ...
        <asp:TextBox ID="txtSteatTime" runat="server" Width="102px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });"></asp:TextBox>
        到
        <asp:TextBox ID="txtEndTime" runat="server"  Width="102px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });"></asp:TextBox>
