<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_Permissionadd, App_Web_aunhunhk" enableviewstate="False" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt;用户管理&gt;&gt;<a href="PermissionInfo.aspx">角色管理</a>&gt;&gt;<%=type %></div>
  <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
    ...
    <tr class="gridtitle" style="display:none;">
      <td height="26" colspan="2" align="center"><strong>权限设置</strong><strong></strong></td>
    </tr>
    <tr class="tdbgleft" style="display:none;">
    ...
    <tr class="tdbg" style="display:none;" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" id="trTime" runat="server">
