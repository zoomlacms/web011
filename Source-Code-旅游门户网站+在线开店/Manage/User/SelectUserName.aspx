<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SelectUserName, App_Web_evybsxrg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <asp:Repeater ID="Repeater1" runat="server">
      <ItemTemplate>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          ...
          <td align="center" style="height: 24px;"><%#Eval("UserName")%></td>c
