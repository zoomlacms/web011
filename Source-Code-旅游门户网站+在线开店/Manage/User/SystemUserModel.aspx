<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SystemUserModel, App_Web_aunhunhk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
  ...
  <%} %>后台管理&gt;&gt;用户管理&gt;&gt;会员模型&gt;&gt;注册信息&nbsp;&nbsp;<span class="red"><a id="ShowLink" href="javascript:ShowList()">[显示所有字段]</a></span>&nbsp;&nbsp;[<a href="AddUserModel.aspx" style="color: Red">添加字段</a>]</div>
    </div>
