<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserSitePermission, App_Web_evybsxrg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt;用户管理&gt;&gt;会员管理&gt;&gt;<a href="UserManage.aspx">会员列表</a>&gt;&gt;设置<%=Username %>会员权限</div>
  <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
    ...
    <tr class="tdbg">
      <td height="26" colspan="2" class="tdbgleft" align="center"><asp:HiddenField ID="txtID" runat="server" />
        ...
        <asp:Button ID="Button2" runat="server" Text="返回列表" OnClientClick="location.href='UserManage.aspx';return false;" class="C_input"/></td>
    </tr>
  </table>
</form>
</body>
