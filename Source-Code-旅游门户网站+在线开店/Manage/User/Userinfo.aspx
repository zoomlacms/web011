<%@ page language="C#" autoeventwireup="true" inherits="manage_User_Userinfo, App_Web_evybsxrg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
                ...
                <ItemTemplate>
                    <tr class="tdbg">
                      ...
                      <asp:LinkButton ID="btnlogin" runat="server" Text=">>作为此会员登录" CommandName="useLogin" CommandArgument='<%#Eval("UserId") %>' />
                        ...
                        <td style="width: 35%; height: 22px" align="left"><%# GetGroupName(Eval("GroupID","{0}")) %>
                    ...
                    <tr class="tdbg">
                        ...
                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">昵称： </td>
                        <td style="width: 35%; height: 22px" align="left"><%#GetHoneyName() %></td>
                    </tr>
                    <tr>
                        <td colspan="4">
                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                ...
                                <tr class="tdbg">
                                 ...
                                 <tr class="tdbg">
                                    <td class="tdbgleft" style="width: 15%; height: 22px" align="right">OA邮箱容量： </td>
              ...
              <asp:Repeater ID="Repeater2" runat="server">
                <ItemTemplate>
                  ...
                  <tr class="tdbg">
                    ...
                    <td style="width: 35%; height: 22px" align="left"><%#Eval("Province") %> - <%#Eval("City") %> - <%#Eval("County") %></td>
                  ...
                  <tr class="tdbg">
                    ...
                    <td style="height: 22px" align="left"   > <%#GetParentUser()%></td>
                    <td class="tdbgleft" style="width: 15%; height: 22px" align="right">签名档： </td>
                    <td style="height: 22px" align="left"   > <%#Eval("Sign") %></td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">公司名称： </td>
                        <td style="height: 22px" align="left"   ><%# GetCompanyName(Eval("UserID","{0}")) %></td>
                        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">公司简介： </td>
                        <td align="left"><%#GetCompanyDesc(Eval("UserID","{0}")) %></td>
                    </tr>
                </ItemTemplate>
              </asp:Repeater>
            </tbody>

            <tbody id="Tabs2" width="100%" style="display: none;" border="0" cellpadding="5" cellspacing="1" >
         <tr class="tdbg">
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 剩余资金： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtMoney" runat="server"></asp:Label></td>
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right">用户信誉值： </td>
          <td><asp:Label ID="txtUserCrite" runat="server" ></asp:Label></td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 点券： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtUserPoint" runat="server" ></asp:Label></td>
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right" > 用户积分： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtPoint" runat="server" ></asp:Label></td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 虚拟币： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtPurm" runat="server" ></asp:Label></td>
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right">用户银币：</td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtSilverCoin" runat="server"></asp:Label></td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 商铺认证有效期截止： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtCerificateDeadLine" runat="server" ></asp:Label></td>
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 有效期截止时间： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtDeadLine" runat="server"></asp:Label></td>
        </tr>
        <tr>

        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
<td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 卖家积分： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtboffExp" runat="server" ></asp:Label></td>
<td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 消费积分： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="txtConsumeExp" runat="server" ></asp:Label></td>
        </tr>

        
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 签名档： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:Label ID="tbSign" runat="server"  TextMode="MultiLine" Width="253px" 
          ...
          <tr><td colspan="4" style="padding-left:0;"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
