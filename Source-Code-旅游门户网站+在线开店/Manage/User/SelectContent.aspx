<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SelectContent, App_Web_aunhunhk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>查询所有内容</title>
...
<script type="text/javascript">
    function parentOpen(url)
    {
        ...
        mainright.location = "AddSubscriptionCount.aspx"+url;
        closdlg();
    }
</script>
</form>
