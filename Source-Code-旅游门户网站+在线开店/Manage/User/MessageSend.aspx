<%@ page language="C#" title="发送信息" autoeventwireup="true" inherits="User.MessageSend, App_Web_evybsxrg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <td><table id="TblAddMessage" width="100%" visible="true" runat="server">
            ...
            <tr>
              <td><asp:RadioButton ID="RadIncept3" runat="server" Text="指定用户名" GroupName="InceptGroup" />
                <asp:TextBox class="l_input" ID="TxtInceptUser" runat="server" Width="326px"></asp:TextBox>
              </td>
