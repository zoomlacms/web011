<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AdminManage, App_Web_evybsxrg" title="管理员管理" tracemode="SortByCategory" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt; 用户管理 &gt;&gt; <a href="AdminManage.aspx">管理员管理</a><asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;<a href="AddManage.aspx<%=Getroleid() %>" style="color:#f00;">[添加管理员]</a></div>
  <asp:GridView ID="Egv" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="border" DataKeyNames="AdminID"  OnRowEditing="Egv_RowEditing" OnPageIndexChanging="Egv_PageIndexChanging" OnRowCommand="Lnk_Click" OnRowDataBound="Egv_RowDataBound" Width="100%" GridLines="None" CellPadding="2" CellSpacing="1">
    <Columns>
            ...
            <td class="tdbg">
                <div style="text-align:center;">
                    <span style="text-align: center"> 共
                        ...
                        <asp:TextBox ID="txtPage" runat="server" AutoPostBack="true" class="l_input" Width="30px" Height="18px" OnTextChanged="txtPage_TextChanged"></asp:TextBox>
                        条数据/页 转到第
