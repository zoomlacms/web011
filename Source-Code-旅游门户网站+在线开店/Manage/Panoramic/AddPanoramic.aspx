<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" validaterequest="false" inherits="manage_Panoramic_AddPanoramic, App_Web_lipplc5n" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation"> 后台管理 &gt;&gt;扩展功能 &gt;&gt; <a href="PanoramicManage.aspx">全景管理</a> </div>
    <table width="100%" border="0" cellpadding="0" cellspacing="1">
      <tr>
        <td colspan="2" class="spacingtitle" align="center"><asp:Label ID="title_T" runat="server" Text="添加全景"></asp:Label></td>
      </tr>
