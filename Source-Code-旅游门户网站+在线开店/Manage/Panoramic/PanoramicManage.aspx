<%@ page language="C#" autoeventwireup="true" inherits="manage_Panoramic_PanoramicManage, App_Web_lipplc5n" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <div>
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border">
        ...
        <asp:Repeater ID="Repeater1" runat="server">
          <ItemTemplate>
            <tr class="tdbg" height="25px" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" ondblclick="Open_Select(<%#Eval("ID") %>)" title="双击预览" style=" cursor:pointer;">
