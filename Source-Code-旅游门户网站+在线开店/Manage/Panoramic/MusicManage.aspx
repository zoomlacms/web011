<%@ page language="C#" autoeventwireup="true" inherits="manage_Panoramic_MusicManage, App_Web_lipplc5n" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %> 后台管理&gt;&gt; 扩展功能&gt;&gt;全景管理&gt;&gt;音乐库管理&nbsp;<a href="AddMusic.aspx" style="color:red;">[添加音乐]</a></div>
    <div>
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border">
        ...
        <asp:Repeater ID="Repeater1" runat="server">
          <ItemTemplate>
            <tr class="tdbg" height="25px" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" ondblclick='View(<%#Eval("ID") %>)' title="双击修改" style=" cursor:pointer;">
