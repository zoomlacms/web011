<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_BiServerInfo, App_Web_1npjerrz" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
		...
		<table width="100%" class="border" cellspacing="0" cellpadding="0" style="margin-top:10px;text-align:left;"">
			...
			<tr  class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			 ...
			 <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" class="tdbg">
                ...
                <td>
                <textarea runat="server" id="textarea1" style="width:100%;height:300px;" class="ckeditor" cols="20" rows="2"></textarea>
