<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_iServer_AddQuestionRecord, App_Web_1npjerrz" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>添加问题</title>
  ...
  <%} %><span>后台管理</span> &gt;&gt; <span>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <textarea rows="20" runat="server" id="textarea1" style="width: 100%; height: 300px;" clientidmode="AutoID" class="ckeditor"></textarea>
               <script type="text/javascript">
