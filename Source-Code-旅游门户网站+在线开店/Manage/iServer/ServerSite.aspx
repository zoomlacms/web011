<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_ServerSite, App_Web_1npjerrz" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<body>
    <div id="Div1">
        <ul>
            <li id="Guide_top">
                <div id="Guide_toptext"><%=lang.LF("有问必答")%> </div>
            </li>
            <li id="Guide_main1">
                <div id="Guide_box1">
                    <div class="guidecollapse" onclick="Switch(this)"><%=lang.LF("有问必答")%></div>
