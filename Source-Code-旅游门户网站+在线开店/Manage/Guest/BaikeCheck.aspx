<%@ page language="C#" autoeventwireup="true" inherits="manage_Guest_BaikeCheck, App_Web_jwvfgwdw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html>
<head>
...
<%=lang.LF("后台管理")%> &gt;&gt;<a href="BkCheck.aspx"><%=lang.LF("百科管理")%></a> &gt;&gt;<a href="BkCheck.aspx"><%=lang.LF("百科词条管理")%></a>&gt;&gt;词条审核
</div>
