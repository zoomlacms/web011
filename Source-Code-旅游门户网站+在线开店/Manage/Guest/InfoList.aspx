<%@ page language="C#" autoeventwireup="true" inherits="manage_Guest_InfoList, App_Web_jwvfgwdw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
<div class="clearbox">
  ...
  <table border="0" cellpadding="0" cellspacing="0">
            <tr align="center">
                ...
                <td id="TabTitle1" class="tabtitle" onclick="ShowTabss(1)"><a href="?tittle=<%=Request.QueryString["tittle"] %>&type=1&id=1"><%=lang.LF("待审核")%></a></td>
                
                <td id="TabTitle2" class="tabtitle" onclick="ShowTabss(2)"><a href="?tittle=<%=Request.QueryString["tittle"] %>&type=2&id=2"><%=lang.LF("已审核")%></a></td>
