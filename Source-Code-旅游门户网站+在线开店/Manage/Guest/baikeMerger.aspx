<%@ page language="C#" autoeventwireup="true" inherits="manage_Guest_baikeMerger, App_Web_jwvfgwdw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html >
<head runat="server">
<title>合并词条</title>
...
<div class="r_navigation">后台管理&gt;&gt;百科管理&gt;&gt; <a href="BkCheck.aspx">百科词条管理</a>&gt;&gt;合并词条nbsp;
</div>
<div>
...
<tr class="tdbg">
			...
			<td align="left"><asp:Label runat="server" ID="L_Name" Width="144px"></asp:Label>&nbsp;&nbsp;
				<asp:RadioButton runat="server" ID="changeke" GroupName="baike1" Text="设为标准词条" /></td>
		  </tr>
<tr class="tdbg">
