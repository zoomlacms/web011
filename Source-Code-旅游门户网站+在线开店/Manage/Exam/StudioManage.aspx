<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_StudioManage, App_Web_lmkt1j3a" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div style="text-align: center">
        <div class="r_navigation">
            ...
            <span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a>&gt;&gt; <span>学员管理</span> [<a href="AddStudio.aspx">添加学员</a>]
        </div>
    </div>
    <div class="clearbox">
    </div>
