<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_CoureseManage, App_Web_lmkt1j3a" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>课程管理</title>
...
<div class="r_navigation">
   <%if(GetOpenHelp.IsopenHelp()=="1")
    { %>
      <div id="help"> <a onclick="help_show('74')" title="帮助"></a></div>
  <%} %><span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">考试管理</a>&gt;&gt; <span>课程管理</span> <a href="AddCoures.aspx" style="color:red;">[添加课程]</a>
</div>
<div class="clearbox">
</div>
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td height="22" align="center">
                      <a href="AddCourseware.aspx?CourseID=<%#Eval("ID")%>">课件列表</a> 
