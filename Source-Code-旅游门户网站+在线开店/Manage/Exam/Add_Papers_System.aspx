<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Add_Papers_System, App_Web_lmkt1j3a" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>编辑试卷信息</title>
...
<body>
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtBegionTime" runat="server" class="l_input" Width="200px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm' });" ></asp:TextBox>
                    至
                    <asp:TextBox ID="txtEndTime" runat="server" class="l_input" Width="200px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm' });" ></asp:TextBox>
                </td>
            </tr>
             <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
