<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ApplicationManage, App_Web_lmkt1j3a" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>培训资料库</span> <a href="AddEnroll.aspx" style="color:red;">[添加招生信息]</a> <a href="javascript:void(0)" onclick="open_window()" style="color:red;">[导入招生资料]</a>
    </div>
    <div class="clearbox">
    </div>
