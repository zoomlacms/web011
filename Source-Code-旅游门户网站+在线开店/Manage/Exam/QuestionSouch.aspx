<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_QuestionSouch, App_Web_lmkt1j3a" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a>&gt;&gt; <span><a href="QuestionSouch.aspx">高级搜索</a></span> 
    </div>
    <div class="clearbox">
    </div>
        ...
        <tr class="tdbg">
            <td style="height: 24px">
                ...
                难度：<asp:DropDownList ID="Difficulty" runat="server">
                    ...
                    ID="Button3" runat="server" Text="搜索" CssClass="C_input" />
            </td>
        </tr>
    </table>
    <div class="clearbox">
