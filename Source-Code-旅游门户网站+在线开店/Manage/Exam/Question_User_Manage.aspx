<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Question_User_Manage, App_Web_lmkt1j3a" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>用户试题管理</title>
...
<div class="r_navigation">后台管理 &gt;&gt;教育模块 &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a>&gt;&gt; <a href="Question_User_Manage.aspx">用户试题管理</a></div>
