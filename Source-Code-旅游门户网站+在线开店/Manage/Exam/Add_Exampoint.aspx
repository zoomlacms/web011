<%@ page language="C#" autoeventwireup="true" inherits="manage_Exam_Add_Exampoint, App_Web_lmkt1j3a" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<span>后台管理</span> &gt;&gt; <span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a>
        &gt;&gt;<a href="Add_ExamPoint.aspx?AdminId=<%=AdminID%>">添加考点</a></div>
    <div class="clearbox">
    </div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr align="center">
            <td class="spacingtitle">
                <asp:Label ID="Label1" runat="server" Text="添加考点"></asp:Label>
            </td>
        </tr>
    </table>
...
<%--                <td class="tdbgleft" style="width: 20%" align="right">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtCoureTime" runat="server" class="l_input" Width="200px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm' });" ></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
        ...
        <tr class="tdbgbottom">
            <td colspan="2">
                <asp:Button ID="EBtnSubmit" class="C_input" Text="添加考点" runat="server" onclick="EBtnSubmit_Click" />
                &nbsp;
