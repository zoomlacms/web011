<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ExTeacherManage, App_Web_lmkt1j3a" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>教师管理</title>
...
<div class="r_navigation">
  ...
  <%} %> <span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a>&gt;&gt; <span>教师管理</span> <a href="AddExTeacher.aspx" style="color:red;">[添加教师]</a>
</div>
<div class="clearbox">
</div>
