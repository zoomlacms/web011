<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ClassManage, App_Web_lmkt1j3a" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
  ...
  <%} %><span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a>&gt;&gt; <span>班级管理</span> <a href="AddClass.aspx" style="color:red;">[添加班级]</a>
        </div>
    <div class="clearbox">
    </div>
