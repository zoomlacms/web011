<%@ page language="C#" autoeventwireup="true" inherits="InputIp, App_Web_waw0ye5y" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
        <div class="r_navigation">
            ...
            <span>后台管理</span>&gt;&gt;<span>扩展功能</span> &gt;&gt;<span><a href="InputIp.aspx"></a></span><span>添加IP信息</span>
        </div>
        ...
        <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="style1" align="center">
                    <strong>
                        <asp:Label ID="Label1" runat="server" Text="起始IP："></asp:Label></strong>
                </td>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="style1" align="center">
                    <strong>
                        <asp:Label ID="Label2" runat="server" Text="终止IP："></asp:Label></strong></td>
                <td class="tdbg" align="left">
