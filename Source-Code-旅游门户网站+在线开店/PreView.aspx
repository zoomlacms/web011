<%@ page language="C#" autoeventwireup="true" inherits="Plat_PreView, App_Web_f0bcuwxw" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
        <div runat="server" id="pdfDiv" visible="false">
              <embed id="pdfEmbed" src="<%=pdfUrl %>" <%=string.Format("style='width:{0}px;height:{1}px;'",viewWidth,viewHeight)%> type="application/pdf" />
        </div>
        ...
        <asp:TextBox runat="server" ID="ViewTxt" TextMode="MultiLine" style="border:none;" Visible="false"></asp:TextBox>
