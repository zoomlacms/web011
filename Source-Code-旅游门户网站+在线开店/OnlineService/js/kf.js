...
var urlroot = "/OnlineService/images/";
var tOut = -1;
var drag = false;
var g_safeNode = null;
lastScrollY = 0;
...
var welcomeword = welcomemsg, type

if (companyname) {
    rightDivHtml = '<div id="rightDiv" style="position:absolute; top:60px; right:1px;">';
...
function kf_getPopupDivHtml(companyname, welcomeword) {
    var temp = '';
    ...
    temp += '<a onclick="kf_hidekfpopup();return false;" href="javascript:void(0)" style="float:right;background-image: url(' + urlroot + 'btn_1.gif);margin: 0 0 0 5px;padding: 0px;border:0px;height: 21px;width: 69px;"></a>';
    temp += '<a onclick="kf_openChatWindow(1)" href="javascript:void(0)" style="float:right;background-image: url(' + urlroot + 'btn_2.gif);margin: 0px;padding: 0px;border:0px;height: 21px;width: 69px;"></a></div>';
...
function kf_getPopupRightDivHtml() {
    ...
    temp += '<div style="clear:both;"><a href="javascript:void(0)" onclick="kf_openChatWindow(0)" style="width:69px; height:21px; background:url(' + urlroot + 'btn_2.gif); margin:0 0 0 2px; display:block;"></a></div></div>';
...
function kf_openChatWindow(flag) {
    ...
    openwindow('OnlineService/ShowForm.aspx?type=1', '在线客服', '644', '489');

    //window.open('OnlineService/ShowForm.aspx?type=1', '_blank', 'height=489, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
...
function kf_sleepShow() {
    kf_setCookie('hasshown', 0,1, '/', 'bizapp.qq.com');
    ...
    popupDivHtml += kf_getPopupDivHtml(companyname, welcomeword);
    popupDivHtml += '</div>';
