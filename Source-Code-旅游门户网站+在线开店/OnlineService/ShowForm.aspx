<%@ page language="C#" autoeventwireup="true" inherits="OnlineService_ShowForm, App_Web_csr5ok4k" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>在线客服</title>
...
<script type="text/javascript" src="Beditor/global.js"></script>
              ...
              <td width="438" height="169" valign="bottom"><table width="100%" border="0" cellpadding="0" cellspacing="0"  style="height: 162px">
                  ...
                  <tr>
                    <td align="left" valign="top"><input type="radio" name="send" id="enter" value="1" title="按 Enter 键发送" />
                      ...
                      <input style="display:none;" type="image" name="imageField" id="imageField" src="images/online_r9_c3.gif" title="发送信息" onfocus="this.blur()" onclick="e_PostContentf();return false;" width="91" height="29" />
                        <input type="button" name="imageField" id="imageField" onclick="e_PostContentf();" value="发送信息" />
                    </td>
                  </tr>
                </table></td>
            </tr>
