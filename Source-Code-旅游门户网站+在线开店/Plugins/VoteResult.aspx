<%@ page language="C#" autoeventwireup="true" inherits="Common_VoteResult, App_Web_tfch1s4r" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                           ...
                           <span>[<%# GetQuesType(Eval("TypeID")) %>]</span>
                                ...
                                <dd>
                                    <div id="divTable" runat="server">
                                        <asp:GridView ID="gviewOption" runat="server" AutoGenerateColumns="false" ShowFooter="true">
