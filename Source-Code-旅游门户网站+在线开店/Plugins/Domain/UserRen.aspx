<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Domain_UserRen, App_Web_cpqz3j25" clientidmode="Static" masterpagefile="~/Manage/Site/OptionMaster.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="pageContent">
    <div id="m_site"><p style="float:left;"> 站群中心 >> 用户中心 >> 服务续费</p></div>
    ...
    <div id="tab3">
        <table style="text-align:center;width:100%;">
            ...
            <asp:Repeater runat="server" ID="OrderRP" EnableViewState="false">
                <ItemTemplate>
                     <tr><td><%#Eval("ID") %></td><td><%#Eval("ProName") %></td><td><%#Eval("AllMoney") %></td><td>
        ...
        <asp:Button runat="server" ID="sureBtn" Text="确定续费" OnClick="sureBtn_Click" ValidationGroup="add" class="site_button"/> 
       </div>
    </div>
    </div>
