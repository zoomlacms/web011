<%@ page language="C#" autoeventwireup="true" inherits="ColonePay, App_Web_1s3tbu0c" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>团购预订支付</title>
...
<a href="User/coloneShop.htm">返回</a></div>
        ...
        <table width="500px" cellspacing="1" cellpadding="2" style="background-color: #CCCCCC;">
            ...
            <tr class="tdbg">
                ...
                <asp:HiddenField ID="hfGID" runat="server" />
                    ...
                    <input id="btnBack" type="button" runat="server" value="返回" style="width:90px" onclick="javascript:location.href='User/coloneShop.htm'" />
                </td>
            </tr>
        </table>
        <br />
