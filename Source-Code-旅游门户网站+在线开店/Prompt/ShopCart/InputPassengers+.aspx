<%@ page language="C#" autoeventwireup="true" inherits="ShopCart_InputPassengers, App_Web_mjpwyrpk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<link rel="stylesheet" type="text/css" href="/Template/Travel/style/global.css"/>
...
<div class="container">
  ...
  <%-- <div style="width:100%">
    ...
    <td><asp:Label ID="lblNo1" runat="server"></asp:Label></td>
    ...
    <td><asp:Label ID="lblJiJian" runat="server" Text="Label"></asp:Label></td>
    <td><asp:Label ID="lblStock" runat="server" Text=""></asp:Label></td>    
    </tr>    
    </table>
    </div>
  ...
  <%--   </div>
    ...
    <!-- 确认乘客信息 -->
        ...
        <!-- end  -->
        <!-- 常用联系人 -->
       <div id="isConsts" runat="server" style="width:100%; height:50px; border: 1px solid #ccc; overflow-x:hidden; text-align:center;" align="center">
    ...
    <div id='<%# GetId(Eval("value"))%>' style="margin-top:10px; padding-left:10px; background-color:#ddd;" name="ConstId">
    <table width="70%">
        <tr>
        <td>购买类型: </td>
        <td>
    ...
    <div id="Contact" runat="server">
        ...
        <tr>
           ...
           <tr>
            <td style="padding-left:10px;">配送地址:</td>
        ...
        <tr>
         ...
         <tr>
          <td colspan="2" align="center">
            <asp:Button ID="btnCommit" Text="预订" runat="server" Width="80px" onclick="btnCommit_Click" OnClientClick="if(check())return true;else return false;" CssClass="btn btn-sm btn-danger" />
            &nbsp;&nbsp;<asp:Button ID="btnCan" Text="取消" runat="server" Width="80px" onclick="btnCan_Click" CausesValidation="False" CssClass="btn btn-sm btn-danger" />
            </td>
        </tr>
        </table>
    </div>
