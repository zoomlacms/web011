<%@ page language="C#" autoeventwireup="true" inherits="StockOrderOver, App_Web_pyalzer0" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>完成订单提交</title>
...
<h1>第三步:完成订单提交<span>[<asp:Label ID="Label1" runat="server" BorderWidth="0px" ForeColor="Red"></asp:Label>]</span><img src="/user/images/regl3.gif" width="242" height="14" /></h1>
	...
	<ul style="margin-top:50px;">
       <li style="text-align:center">
	     ...
	     <asp:Button ID="Button2"  CssClass="i_bottom" runat="server" Text="返回首页" />
	   </li>
	</ul>
</div>
    ...
    <td class="tdbg">
      <div class="p_center" >
        <table width="500" cellspacing="1" cellpadding="2" >
            ...
            <tr class="tdbg">
              <td colspan="2"><input id="bt2" type="button" value="返回商城" onclick="window.location.href='/User/Develop/AppStore.aspx'" /></td>
            </tr>
        </table>
      </div>
    </td>
