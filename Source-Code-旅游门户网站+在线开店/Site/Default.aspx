<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Domain_InquiryDomName, App_Web_g4l10yeo" masterpagefile="~/Manage/Site/SiteMaster2.master" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
    ...
    <style type="text/css">
        ...
        .smart_input{ margin-top:3px; height:48px;width:294px; border:none; padding-left:10px;font-size:16px; font-family:'Microsoft YaHei';color:#737384;}
        .smart_span{margin-top:3px; display:block;width:177px;height:48px; background:#DADADA;border:1px solid #DADADA;border-radius:3px;color:#666666; font-size:40px;font-family:'Microsoft YaHei';line-height:46px;}
        .smart_button{ width:95px; height:48px; margin-left:8px;margin-top:3px; font-family:'Microsoft YaHei';font-size:18px;}
        .smart_nav{ margin-top:10px;margin-left:2%;margin-right:2%;}
        .smart_nav li a{ color:#428bca;}
...
<asp:Content runat="server" ContentPlaceHolderID="pageContent">
    ...
    <div id="previewss">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="domNameT" ForeColor="Red" ErrorMessage="请输入子域名!!" Display="Dynamic" SetFocusOnError="true"/>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="domNameT" Display="Dynamic" ForeColor="Red" ErrorMessage="格式错误,最少五位,最多十六位" ValidationExpression="^([a-zA-Z]([a-zA-Z0-9]){4,15}$)" />
        </div>
