...
function InitNewFrameTab() {
    jQuery("#newFrameTab").click(function() {
        ...
        jQuery('<li id="iFrameTab' + (++lastFrameTabId) + '" ><a href="javascript:"><span id="frameTabTitle">新选项卡</span><a class="closeTab" title="关闭"><span class="glyphicon glyphicon-remove"></span></a></a></li>').insertBefore(this).iFrameTab();
        frameTabCount++;
...
function resizeFrame()
{
    ...
    //var width = document.documentElement.clientWidth - 205; //左边框
    //document.getElementById("main_right").style.width = width-100;
    //document.getElementById("FrameTabs").style.width = width-100;
