<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Common.FileUpload, App_Web_thcgjfeg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<style type="text/css">
.style1 { width: 340px; height: 11px; }
.style2 { width: 82px; height: 11px; }
.style3 { height: 11px;}
</style> 
</head>
<body class="tdbg">
<form id="form1" runat="server" enctype="multipart/form-data">
	...
	<asp:Button ID="BtnUpload" runat="server" Text="上传" OnClick="BtnUpload_Click" style="height: 21px" />  
	  ...
	  <td class="style2" id="show1" runat="server" visible="false"> 是否上传水印 </td>
