<%@ page language="C#" autoeventwireup="true" inherits="Guestbook_BkSearch, App_Web_txhf3cqq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head> 
<meta charset="utf-8">
...
<link type="text/css" href="/App_Themes/Guest/bar.css" rel="stylesheet"/>
</head> 
<body>
...
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("自然") %>">自然</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("文化") %>">文化</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("物理") %>">地理</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("历史") %>">历史</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("生活") %>">生活</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("社会") %>">社会</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("艺术") %>">艺术</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("人物") %>">人物</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("经济") %>">经济</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("科技") %>">科技</a></li>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("体育") %>">体育</a></li>
</ul>
</div>
</div>
...
<div class="baike_class_t"><a href="Class.aspx" target="_blank">更多>></a>词条分类</div>
<div class="baike_class_c">
<div class="row">
<ul class="list-unstyled">
<asp:Repeater ID="Repeater1" runat="server"  OnItemDataBound="Repeater1_ItemDataBound">
	<ItemTemplate>
		<li class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a href="Search.aspx?Gtype=<%#Eval("GradeID") %>" title="<%#Eval("GradeName") %>"><%#Eval("GradeName") %></a>
        <ul class="list-inline">
		<asp:Repeater ID="Repeater2" runat="server">
			<ItemTemplate>
				<li><a href="/Guest/Baike/Search.aspx?Gtype=<%#Eval("GradeID") %>" class="label label-info" title="<%#Eval("GradeName") %>"  onclick="clickTag(this); return false;"><%#Eval("GradeName") %></a></li>
			</ItemTemplate>
		</asp:Repeater> 
        </ul>
        </li>
...
<div class="baike_class_r"><a href="#" target="_blank"><i class="fa fa-refresh"></i>换一批</a></div>
</div>
<div class="baike_hot">
...
<ul class="list-unstyled">
<%Call.Label("{ZL.Label id=\"输出百科词条标题内容1\" ShowNum=\"2\" TitleNum=\"30\" SynNum=\"30\" /}"); %>
</ul>
</li>
</ul>
</div>
...
<ul class="list-unstyled">
<%Call.Label("{ZL.Label id=\"输出百科词条标题内容2\" ShowNum=\"2\" TitleNum=\"30\" SynNum=\"30\" /}"); %>
</ul>
</li>
...
<ul class="list-unstyled">
<%Call.Label("{ZL.Label id=\"输出百科词条标题内容3\" ShowNum=\"2\" TitleNum=\"30\" SynNum=\"30\" /}"); %>
</ul>
</li>
<li><div class="baike_hot_clt1">外遇</div></li>
<li><div class="baike_hot_clt1">外遇</div></li>
...
<div class="row">
<div class="padding5">
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding2"><a href="#" target="_blank"><img src="/Template/Defend/style/images/baike_img.jpg" onerror="javascript:this.src='/Images/nopic.gif';" alt="" /></a></div>
...
<div class="baike_class_t">百科新动态</div>
<ul class="list-unstyled">
...
<a href="/ShowList.aspx?id=<%#Eval("UserID") %>" target="_blank"><img src="<%#Eval("UserFace") %>" onerror="javascript:this.src='/Images/userface/noface.gif';" alt="<%#Eval("UserName") %>" /></a>
</div>
...
<img src="http://pic.baike.zoomla.cn/p/20120810/bki-20120810123653-802421712.jpg" border="0" /></a>
<div class="r">
...
<ItemTemplate>
<div class="entry_con3">
<a href="Details.aspx?soure=manager&tittle=<%#Server.UrlEncode(Eval("Tittle").ToString()) %>" target="_blank">
<img src="http://pic.baike.zoomla.cn/p/20120810/bki-20120810125323-1670790846.jpg" border="0" /></a>
<div class="r">
<h4><a href="Details.aspx?soure=manager&tittle=<%#Server.UrlEncode(Eval("Tittle").ToString()) %>" target="_blank"><%#Eval("Tittle")%></a> </h4>
<br />
<p class="wordbreak">
<%#NoHTML(Eval("contents","{0}").ToString())%>...
</p>
...
<h3 class="entry_tit8"><span class="ft_l">优质词条</span>
...
<div class="entry_tit9">
<ul>
<li><a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("人物") %>" target="_blank">人物百科</a></li>
</ul>
<a href="/Guest/Baike/Classification.aspx?ClassTitle=<%=Server.UrlEncode("人物") %>" class="more" target="_blank">更多&gt;&gt;</a>
</div>
<ul class="entry_con9" ch="bk6">
...
<ItemTemplate>
<li><span class="l"><span class="strong"><%#Container.ItemIndex+1 %></span><a href='Details.aspx?soure=manager&tittle=<%#Server.UrlEncode(Eval("Tittle").ToString()) %>' target="_blank"><%#Eval("Tittle")%></a></span><div class="icon18_1"></div>
</li>
</ItemTemplate>
</asp:Repeater>
</ul>
