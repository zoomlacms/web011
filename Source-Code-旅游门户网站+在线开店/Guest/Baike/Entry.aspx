<%@ page language="C#" autoeventwireup="true" inherits="Guest_Entry, App_Web_5yxxkshy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<meta charset="utf-8">
...
<ItemTemplate>
<tr><td><h4><a href="Details.aspx?soure=manager&tittle=<%#Server.UrlEncode(Eval("Tittle").ToString()) %>" target="_blank"><%#Eval("Tittle")%></a> <%#Eval("AddTime","{0:yyyy-MM-dd}") %></h4></td></tr>
</ItemTemplate>
</asp:Repeater>
</table>
