<%@ page language="C#" autoeventwireup="true" inherits="Guest_AskSuccess, App_Web_3jie2zxp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %> 
<!DOCTYPE> 
<html>
<head runat="server">
<meta charset="utf-8">
...
<div class="container">
    ...
    <div class="rg_inout msg" id="main">
        ...
        <div class="submit-fallback">
            ...
            <a href="MyAskList.aspx?ID=<%=Request["ID"]%>&QueType=" title="查看问题">好，一定</a>
        </div>
    </div>
</div>
