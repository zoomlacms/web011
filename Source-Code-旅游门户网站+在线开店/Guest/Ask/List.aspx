<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Guest_AnswerList, App_Web_3jie2zxp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<li class="active"><a href="list.aspx">全部问答</a></li>
<li><a href="SearchList.aspx?strWhere=<%=Server.HtmlEncode(Request["strWhere"]) %>">待完善问题</a></li>
</ul>
<div class="asklist">
<asp:GridView ID="Gdv" DataKeyNames="ID" CssClass="table table-bordered" border="none" runat="server" AutoGenerateColumns="False" PageSize="20" ShowHeader="False">
<Columns>
<asp:TemplateField >
<ItemTemplate>
...
<table Width="100%">
<tr >
<td height="22" colspan="9" class="text-center"> 共
