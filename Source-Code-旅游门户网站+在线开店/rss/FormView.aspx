<%@ page language="C#" autoeventwireup="true" inherits="test_FormView, App_Web_3bcir4x2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
            ...
            <div class="row">
                <div id="formDesign_Div">
                    ...
                    <div style="text-align:center;">
                        <asp:Button runat="server" CssClass="btn btn-primary" Text="提交" ID="SaveDataBtn" OnClick="SaveDataBtn_Click" />
                    </div>
                </div>
            </div>
        </div></div>
