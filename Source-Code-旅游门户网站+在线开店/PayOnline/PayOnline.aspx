<%@ page language="C#" responseencoding="utf-8" autoeventwireup="true" inherits="ZoomLa.WebSite.Shop.PayOnline, App_Web_2qre32wo" enableviewstatemac="false" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<meta charset="utf-8">
...
<asp:Label Text="手续费：" ID="Fee" runat="server"></asp:Label><asp:Label ID="LblRate" runat="server"></asp:Label><div id="RateTips" runat="server"></div>
  ...
  <div style=" position:absolute; top:310px; left:0px;">
    <form id="Form2" runat="server">
     <div id="SecPwd" runat="server" style=" position:absolute; top:-115px; left:78px; width:300px; " Visible="false" >
             请输入二级密码:<asp:TextBox ID="Second" runat="server" TextMode="Password" ></asp:TextBox></div>
