<%@ page language="C#" autoeventwireup="true" inherits="PayOnline_PostJBack, App_Web_r0a4p3dq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html> 
<head runat="server">
  ...
  <div style=" width:500px; height:500px; margin:0 auto;"> <br />
    <table width="100%" style="background-color: #CCCCCC;">
      ...
      <tr>
        ...
        <tr>
        <td style=" width:250px; text-align:right; padding-right:10px; height:25px;">手续费总额：</td>
        <td><asp:Label ID="fee" runat="server"></asp:Label></td>
      </tr>
