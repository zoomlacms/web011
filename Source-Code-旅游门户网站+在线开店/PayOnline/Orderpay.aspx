<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.PayOnline.Orderpay, App_Web_r0a4p3dq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
      ...
      <td style="text-align: center;"><table width="100%" cellspacing="1" cellpadding="2">
          <tr>
            <td colspan="2" style="text-align: center; vertical-align: top;">
              ...
              <div class="PayPlat_s">
               <asp:RadioButtonList runat="server"  ID="DDLPayPlat" Style="text-align: center; vertical-align: middle; text-align:left;" RepeatDirection="Horizontal" 
                   OnDataBinding="DDLPayPlat_DataBinding" RepeatColumns="4"></asp:RadioButtonList>
